...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>FCurve.UndoEdit</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/FCurve.html\">FCurve</a>.UndoEdit</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Undoes the bulk edits made to the fcurve and closes the current\n\
bulk edit.<br /><br />\n\
Note: If you call UndoEdit when there is no bulk edit in progress, \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>FCurve.UndoEdit();</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/FCurve.BeginEdit.html\">FCurve.BeginEdit</a> <a href=\"#!/url=./si_om/FCurve.EndEdit.html\">FCurve.EndEdit</a> <a href=\"#!/url=./si_om/FCurve.IsEditing.html\">FCurve.IsEditing</a></p></div>\n\
\n\
