...
\n\
<h2 class=\"pagehead\">RenderChannel</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_RenderChannel\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1RenderChannel.html\">RenderChannel</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
<p class=\"level1\"><a href=\"#!/url=./si_om/SIObject.html\">SIObject</a></p>\n\
<p class=\"level2\">RenderChannel</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> A render channel is a container for rendered image data output.\n\
The channel describes what kind of data can be recorded into it.\n\
<br /><br />\n\
There are two types of channels: renderer-provided and user-defined.\n\
The renderer-provided type consists of channels that are implicitly \n\
provided by the rendering engine (such as the main render output \n\
and a depth output). \n\
<br /><br />\n\
...
<a href=\"#!/url=./si_om/SceneRenderProperty.html\">SceneRenderProperty</a>.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">// Create a new render channel to use to pipe a texture\n\
...
RenderRegionSetRenderChannel( siViewportB, oChannel.Name );</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/RenderChannelCollection.html\">RenderChannelCollection</a> <a href=\"#!/url=./si_om/Framebuffer.html\">Framebuffer</a> <a href=\"#!/url=./si_om/SceneRenderProperty.html\">SceneRenderProperty</a> <a href=\"#!/url=./si_om/Pass.html\">Pass</a></p></div>\n\
\n\
