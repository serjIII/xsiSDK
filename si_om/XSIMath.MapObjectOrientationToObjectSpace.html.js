...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>XSIMath.MapObjectOrientationToObjectSpace</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>XSIMath.MapObjectOrientationToObjectSpace</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/XSIMath.html\">XSIMath</a>.MapObjectOrientationToObjectSpace</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>Converts an orientation described in an ObjectSpace to an orientation in a different ObjectSpace.</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SIVector3 XSIMath.MapObjectOrientationToObjectSpace( SITransformation in_pObjectSpace, SITransformation in_pSpace, SIVector3 in_pOrientation );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = XSIMath.MapObjectOrientationToObjectSpace( ObjectSpace, Space, Orientation );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p><a href=\"#!/url=./si_om/SIVector3.html\">SIVector3</a> (orientation)</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
 ObjectSpace in which the orientation is described.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Space		</td>\n\
		<td><a href=\"#!/url=./si_om/SITransformation.html\">SITransformation</a>		</td>\n\
		<td>\n\
 Space in which we want to convert the orientation.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Orientation		</td>\n\
		<td><a href=\"#!/url=./si_om/SIVector3.html\">SIVector3</a>		</td>\n\
		<td>\n\
 Orientation to convert.		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
//			0,-57.29577951308232,0 in the cube object space</pre></td></tr>\n\
</table>\n\
...
Application.LogMessage  \"The second face of the cube normal vector represented in the cone referential(\" &amp; _\n\
				...
				XSIMath.RadiansToDegrees(oObjectOri.Z) &amp; \") in the cube object space\"</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
