...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>NurbsSurfaceMesh.GetClosestSurfacePosition</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>NurbsSurfaceMesh.GetClosestSurfacePosition</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/NurbsSurfaceMesh.html\">NurbsSurfaceMesh</a>.GetClosestSurfacePosition <img src=\"images/operator.gif\" alt=\"operator\" /></h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns the surface index, position of the point on it, UV \n\
values and squared distance from the given position.<br /><br />\n\
...
<a href=\"#!/url=./si_om/NurbsSurfaceMesh.GetClosestSurfacePosition2.html\">NurbsSurfaceMesh.GetClosestSurfacePosition2</a>.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>NurbsSurfaceMesh.GetClosestSurfacePosition( Object in_vPosition, Object& out_pvSurfaceIndex, Object& out_pvSquaredDistance, Object& out_pvUValue, Object& out_pvVValue, Object& out_pvPosition );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>NurbsSurfaceMesh.GetClosestSurfacePosition( Position, [Index], [SquaredDistance], [UValue], [VValue], [Position] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
A position expressed in the NurbsSurfaceMesh object frame of reference.		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
The surface index to which the position is the closest.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">SquaredDistance		</td>\n\
		<td><a href=\"#!/url=./files/Double.htm\">Double</a>		</td>\n\
		<td>\n\
The squared distance of the inputed position to the surface point.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">UValue		</td>\n\
		<td><a href=\"#!/url=./files/Double.htm\">Double</a>		</td>\n\
		<td>\n\
The corresponding UValue on the NurbsSurface		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">VValue		</td>\n\
		<td><a href=\"#!/url=./files/Double.htm\">Double</a>		</td>\n\
		<td>\n\
The corresponding VValue on the NurbsSurface		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Position		</td>\n\
		<td><a href=\"#!/url=./si_om/SIVector3.html\">SIVector3</a> (contains the position)		</td>\n\
		<td>\n\
The actual surface position at UV values.		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
\' INFO : The corresponding position is X : -1.51252820283502 Y :-0.583451828096254 Z :-3.65156587231083</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
