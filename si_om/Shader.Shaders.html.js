...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Shader.Shaders</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Shader.html\">Shader</a>.Shaders</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a <a href=\"#!/url=./si_om/ShaderCollection.html\">ShaderCollection</a> containing each <a href=\"#!/url=./si_om/Shader.html\">Shader</a> object \n\
...
ShaderCollection rtn = Shader.Shaders;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">dim oRoot, oMat, oGrid, oPhong, oShader\n\
NewScene ,false\n\
\' Create a grid\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Material.Shaders.html\">Material.Shaders</a></p></div>\n\
\n\
