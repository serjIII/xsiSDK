...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>XSIApplication.OpenUndo</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>XSIApplication.OpenUndo</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/XSIApplication.html\">XSIApplication</a>.OpenUndo</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v10.0 (2012)</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Opens an undo complex. An undo complex can be used to undo/redo multiple undoable commands in one single\n\
operation. Once an undo complex is opened, all subsequent undoable command calls will be added to this complex.\n\
The <a href=\"#!/url=./si_om/XSIApplication.CloseUndo.html\">XSIApplication.CloseUndo</a> method should be called to close an opened complex. \n\
<br /><br />\n\
...
<br /><br /><span class=\"b\">Note:</span>Undo complexes left opened due to a missing CloseUndo call may lead to undo/redo \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>XSIApplication.OpenUndo( String in_sComplexName );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>XSIApplication.OpenUndo( ComplexName );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		<td class=\"name\">ComplexName		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
Name of this complex displayed in the Softimage undo menu.		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
Application.Redo(\"\")    # my undo complex</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
