...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>Model.ExternalFiles</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Model.ExternalFiles</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Model.html\">Model</a>.ExternalFiles</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v5.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a <a href=\"#!/url=./si_om/FileReferenceCollection.html\">FileReferenceCollection</a> containing all \n\
external files related to this model. Only input files are added to \n\
this list (for example graphics files, audio files, referenced model \n\
files, etc.).\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
...
FileReferenceCollection rtn = Model.ExternalFiles;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Scene.ExternalFiles.html\">Scene.ExternalFiles</a> <a href=\"#!/url=./si_om/FileReference.html\">FileReference</a></p></div>\n\
\n\
