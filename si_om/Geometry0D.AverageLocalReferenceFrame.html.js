...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>Geometry0D.AverageLocalReferenceFrame</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Geometry0D.AverageLocalReferenceFrame</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Geometry0D.html\">Geometry0D</a>.AverageLocalReferenceFrame</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>Get the average normal of given 0D Component</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Geometry0D.AverageLocalReferenceFrame( compIdxArray, XAxis, XAxisValid, YAxis, YAxisValid, ZAxis, ZAxisValid );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
 An array of indices of 0D Component 			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				<tr>\n\
					<td>						<p class=\"cell\"><span class=\"hilite\">Possible Values: </span>						</p>					</td>\n\
					<td>						<p class=\"cell\"><span class=\"hilite\">Description: </span>						</p>					</td>\n\
				</tr>\n\
				<tr>\n\
					<td class=\"name\">0 <= compidxarray(i)=\"\"></=>< number=\"\" of=\"\" 0d=\"\" component=\"\" /></td>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Upon return, contains the X axis of the average local reference frame of the given 0D Component 		</td>\n\
	</tr>\n\
	<tr>\n\
 ...
 Upon return, contains TRUE if the X axis of the reference frame is valid, else FALSE 		</td>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./si_om/SIVector3.html\">SIVector3</a>		</td>\n\
		<td>\n\
 Upon return, contains the Y axis of the average local reference frame of the given 0D Component 		</td>\n\
	</tr>\n\
	<tr>\n\
 ...
 Upon return, contains TRUE if the Y axis of the reference frame is valid, else FALSE 		</td>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./si_om/SIVector3.html\">SIVector3</a>		</td>\n\
		<td>\n\
 Upon return, contains the Z axis of the average local reference frame of the given 0D Component 		</td>\n\
	</tr>\n\
	<tr>\n\
...
o0DGeometry.AverageLocalReferenceFrame oIndicesArray, oXAxis, oXAxisValid, oYAxis, oYAxisValid, oZAxis, oZAxisValid\n\
if oXAxisValid then\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Geometry0D.LocalReferenceFrame.html\">Geometry0D.LocalReferenceFrame</a> <a href=\"#!/url=./si_om/Geometry0D.html\">Geometry0D</a> <a href=\"#!/url=./si_om/SIVector3.html\">SIVector3</a></p></div>\n\
\n\
