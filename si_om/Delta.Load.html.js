...
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Delta.html\">Delta</a>.Load</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>Loads a Delta (all modifications on the reference model) from the specified file.</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Delta.Load( String in_bstrFile );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Delta.Load();</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/ImportDelta.html\">ImportDelta</a></p></div>\n\
\n\
