...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Command.SetFlag</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Command.html\">Command</a>.SetFlag</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Sets the state of one of the various flags that affects\n\
command behavior.  You can get the value of a flag with \n\
<a href=\"#!/url=./si_om/Command.GetFlag.html\">Command.GetFlag</a>.<br /><br />\n\
You must call <a href=\"#!/url=./si_om/Command.Update.html\">Command.Update</a> if you want to update \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Command.SetFlag( Int32, Boolean );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Command.SetFlag( Flag, [Enabled] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Flag to set.		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
True enables the flag (default), false disables it.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
true			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
...
//INFO : Finished calling custom cmd\n\
*/\n\
Application.RemoveCommand(\"CustomCmd\")</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
