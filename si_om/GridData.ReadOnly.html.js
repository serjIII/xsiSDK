...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>GridData.ReadOnly</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/GridData.html\">GridData</a>.ReadOnly</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v12.0 (2014)</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> 	Sets the read only mode for the whole grid data.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
...
// set accessor\n\
GridData.ReadOnly = Boolean;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\">propName = \"TheProperty\"\n\
...
Application.LogMessage( gridData.ReadOnly )</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
