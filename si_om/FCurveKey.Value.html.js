...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>FCurveKey.Value</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/FCurveKey.html\">FCurveKey</a>.Value</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Sets or returns the value of the fcurve key as a <a href=\"#!/url=./files/Variant.htm\">Variant</a>. The fcurve key value \n\
is returned as follows:<br /><br />\n\
- Standard fcurves: double (VT_R8)<br /><br />\n\
- Raw fcurves: double (VT_R8)<br /><br />\n\
- Integer fcurves: LONG (VT_I4)<br /><br />\n\
- Boolean fcurves: variant bool (VT_BOOL,VARANT_TRUE,VARIANT_FALSE)<br /><br />\n\
Note: If you are setting the key value the value will be clamped \n\
within the range defined by the <a href=\"#!/url=./si_om/FCurve.LowClamp.html\">FCurve.LowClamp</a> \n\
and the <a href=\"#!/url=./si_om/FCurve.HighClamp.html\">FCurve.HighClamp</a> values.<br /><br />\n\
...
// set accessor\n\
FCurveKey.Value = Object;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
//INFO : After modification: 6</pre></td></tr>\n\
</table>\n\
...
#INFO : After modification: 6.0</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
