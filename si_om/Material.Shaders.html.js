...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Material.Shaders</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Material.html\">Material</a>.Shaders</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a <a href=\"#!/url=./si_om/ShaderCollection.html\">ShaderCollection</a> containing all shaders directly attached to the material. \n\
<br /><br />\n\
Note: This property returns only those shaders which are directly attached \n\
to the material, not all shaders attached to the entire render tree.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
...
ShaderCollection rtn = Material.Shaders;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
