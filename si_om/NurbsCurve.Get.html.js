...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>NurbsCurve.Get</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/NurbsCurve.html\">NurbsCurve</a>.Get <img src=\"images/operator.gif\" alt=\"operator\" /></h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a complete data description of the Nurbs Curve.\n\
<br /><br />\n\
...
<a href=\"#!/url=./si_om/NurbsCurve.Get2.html\">NurbsCurve.Get2</a>.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>NurbsCurve.Get( siNurbsFormat in_eNurbsFormat, Object& out_vsaControlPoints, Object& out_vdKnots, Object& out_vbClosed, Object& out_vlDegree, Object& out_veParam );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>NurbsCurve.Get( [NurbsFormat], ControlPoints, [Knots], [Closed], [Degree], Parameterization );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
siSINurbs			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
The control points are stored in a 2 dimensional array. The array is a 4 * Number of U ControlPoints		</td>\n\
	</tr>\n\
	<tr>\n\
...
An array of knot values. 		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Specifies whether the nurbs curve is closed .		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Degree		</td>\n\
		<td><a href=\"#!/url=./files/Long.htm\">Long</a>		</td>\n\
		<td>\n\
 Degree of the nurbs curves.		</td>\n\
	</tr>\n\
	<tr>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">Dim lDegree, bClosed, eParameterization, aControlVertex, aKnots\n\
...
set oNurbsCurveList = oRoot.AddNurbsCurve( aControlVertex, aKnots, bClosed, _\n\
	lDegree, eParameterization, siSINurbs )</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
