...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>FCurve.IsEditing</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/FCurve.html\">FCurve</a>.IsEditing</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns true if a bulk edit of the fcurve is in progress.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Boolean FCurve.IsEditing();</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oBoolean = FCurve.IsEditing();</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
//INFO : total number of keys = 44\n\
//INFO : fcurve has finished recording changes</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/FCurve.BeginEdit.html\">FCurve.BeginEdit</a> <a href=\"#!/url=./si_om/FCurve.EndEdit.html\">FCurve.EndEdit</a> <a href=\"#!/url=./si_om/FCurve.UndoEdit.html\">FCurve.UndoEdit</a></p></div>\n\
\n\
