...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>FileReference.NumberOfFilesInSequence</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>FileReference.NumberOfFilesInSequence</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/FileReference.html\">FileReference</a>.NumberOfFilesInSequence</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns the number of files that this sequence of file contains as a <a href=\"#!/url=./files/Long.htm\">Long</a>. If the sequence \n\
consists of only one file, this property will return 1. <br /><br />\n\
...
UInt32 rtn = FileReference.NumberOfFilesInSequence;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
// Expected results:\n\
//INFO : The number of files is: 3</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/FileReference.GetFileInSequence.html\">FileReference.GetFileInSequence</a></p></div>\n\
\n\
