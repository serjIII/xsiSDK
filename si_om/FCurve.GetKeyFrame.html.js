...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>FCurve.GetKeyFrame</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>FCurve.GetKeyFrame</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/FCurve.html\">FCurve</a>.GetKeyFrame</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns the key time in frames of the key at the specified index.<br /><br />\n\
Note: If the index is out of range then the method raises an \n\
\'Invalid argument\' (E_INVALIDARG) error.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Double FCurve.GetKeyFrame( Int32 in_Index );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oDouble = FCurve.GetKeyFrame( Index );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
//INFO : key50 frame = 100 value = 66.7755833336558</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/FCurveKey.Time.html\">FCurveKey.Time</a> <a href=\"#!/url=./si_om/FCurve.KeyExists.html\">FCurve.KeyExists</a> <a href=\"#!/url=./si_om/FCurve.GetKeyValue.html\">FCurve.GetKeyValue</a> <a href=\"#!/url=./si_om/FCurve.GetKeyIndex.html\">FCurve.GetKeyIndex</a></p></div>\n\
\n\
