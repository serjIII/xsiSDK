...
\n\
<h2 class=\"pagehead\">Delta</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_Delta\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1Delta.html\">Delta</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
<p class=\"level1\"><a href=\"#!/url=./si_om/SIObject.html\">SIObject</a></p>\n\
<p class=\"level2\"><a href=\"#!/url=./si_om/ProjectItem.html\">ProjectItem</a></p>\n\
<p class=\"level3\">Delta</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> The Delta object represents a \'diff\' or list of modifications to a reference model. These are grouped into \n\
types of changes called <a href=\"#!/url=./si_om/ActionDelta.html\">ActionDelta</a>s, which have a unique type similar to the \n\
<a href=\"#!/url=./si_om/Parameter.Source.html\">Parameter.Source</a> type (see <a href=\"#!/url=./si_om/siModificationDeltaType.html\">siModificationDeltaType</a>) and changes to \n\
...
<br /><br />\n\
Modifications stored in an ActionDelta are related to animation, such as <a href=\"#!/url=./si_om/FCurve.html\">FCurve</a>s, \n\
<a href=\"#!/url=./si_om/Constraint.html\">Constraint</a>s, etc. \n\
<br /><br />\n\
Delta properties are stored under the model and each model can only have one delta associated to it, so to \n\
access a delta, use the <a href=\"#!/url=./si_om/Dictionary.GetObject.html\">Dictionary.GetObject</a> method (for example, \n\
\'var myDelta = Dictionary.GetObject(\"MyRefModel.Delta\");\'.\n\
<br /><br />\n\
There are three ways to create deltas on a reference model:<br /><br />\n\
...
<br /><br />\n\
(2) Add an empty Delta using the <a href=\"#!/url=./si_cmds/AddDelta.html\">AddDelta</a> command. \n\
<br /><br />\n\
(3) Import a delta using the <a href=\"#!/url=./si_cmds/ImportDelta.html\">ImportDelta</a> or <a href=\"#!/url=./si_cmds/ImportReferencedDelta.html\">ImportReferencedDelta</a> commands.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
