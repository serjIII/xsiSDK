...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>TextureLayer.AddTextureLayerPort</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>TextureLayer.AddTextureLayerPort</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/TextureLayer.html\">TextureLayer</a>.AddTextureLayerPort</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Adds a <a href=\"#!/url=./si_om/TextureLayerPort.html\">TextureLayerPort</a> object (shader connection) to a texture\n\
...
shared with Lambert.  If we call <a href=\"#!/url=./si_om/TextureLayer.AddTextureLayerPort.html\">TextureLayer.AddTextureLayerPort</a>\n\
...
<a href=\"#!/url=./si_om/Shader.AddSharedTextureLayer.html\">Shader.AddSharedTextureLayer</a> on that shader.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>TextureLayerPort TextureLayer.AddTextureLayerPort( Object in_varParam );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = TextureLayer.AddTextureLayerPort( Target );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p><a href=\"#!/url=./si_om/TextureLayerPort.html\">TextureLayerPort</a></p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./si_om/Parameter.html\">Parameter</a> or <a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
\n\
		Parameter on the target (must be a port on a shader or material) to which to\n\
		add a texture layer port connection (that is, to be driven by this layer).  Note that\n\
		if a target is specified on a (valid) container which currently does not nest the\n\
		layer, the layer will be added to that container.\n\
			</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">// This example shows creation of texture layer\n\
...
//INFO : \"3: sphere.Material.Phong.DirtLayer.color1\"</pre></td></tr>\n\
</table>\n\
</div><h4>2. VBScript Example</h4><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\' This example shows creation of texture layer\n\
\' ports, plus enumerating them.\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/AddTextureLayerPorts.html\">AddTextureLayerPorts</a> <a href=\"#!/url=./si_om/TextureLayer.TextureLayerPorts.html\">TextureLayer.TextureLayerPorts</a> <a href=\"#!/url=./si_om/TextureLayer.RemoveTextureLayerPort.html\">TextureLayer.RemoveTextureLayerPort</a></p></div>\n\
\n\
