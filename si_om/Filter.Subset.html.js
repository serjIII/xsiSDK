...
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Filter.html\">Filter</a>.Subset</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a collection of objects built from the input array. All objects \n\
matching the filter requirements are returned through an output collection.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>CXSICollection Filter.Subset( Object in_pObjects );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = Filter.Subset( Objects );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
A collection of objects. By default the selection list is\n\
used, if this argument is omitted by the caller. \n\
		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
