...
\n\
<h2 class=\"pagehead\">XSIDialog</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_XSIDialog\">Object Hierarchy</a></p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v2.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> This object allows you to launch a simple modal dialog contained a drop down list of strings.\n\
It is particularly useful when asking the user to select from a dynamically generated list of\n\
items.\n\
<br /><br />\n\
An alternative approach is to use a Combo control on a <a href=\"#!/url=./si_om/CustomProperty.html\">CustomProperty</a> \n\
(see <a href=\"#!/url=./si_om/PPGLayout.AddEnumControl.html\">PPGLayout.AddEnumControl</a>).\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
	<tr>\n\
\n\
		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/XSIDialog.Combo.html\">Combo</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/XSIDialog.ComboEx.html\">ComboEx</a>		</td>		<td class=\"members\">&nbsp;		</td>		<td class=\"members\">&nbsp;		</td>	</tr>\n\
\n\
	<tr>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">dim XSIDial, aItems\n\
