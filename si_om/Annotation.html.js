...
\n\
<h2 class=\"pagehead\">Annotation</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_Annotation\">Object Hierarchy</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
...
<p class=\"level5\">Annotation</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v10.5 (2012)</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> The Annotation object is a specialized <a href=\"#!/url=./si_om/X3DObject.html\">X3DObject</a> used for inserting text annotation in a scene.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
...
log( \'%s is annotated with %s: \"%s\"\' % (mymodel.Name, annotation.Name, annotation.Parameters(\'Message\').Value), C.siComment )</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/X3DObject.AddAnnotation.html\">X3DObject.AddAnnotation</a></p></div>\n\
\n\
