...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>FileReference.Owners</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>FileReference.Owners</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/FileReference.html\">FileReference</a>.Owners</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns the owners of this file as an <a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a>. Usually \n\
there is only one owner: the parameter containing the source (the audio or image \n\
file, etc).\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
...
CXSICollection rtn = FileReference.Owners;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
// Expected result:\n\
// INFO : The owner is: Sources.back_bmp.Path</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/FileReference.Path.html\">FileReference.Path</a></p></div>\n\
\n\
