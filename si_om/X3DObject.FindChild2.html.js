...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>X3DObject.FindChild2</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>X3DObject.FindChild2</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/X3DObject.html\">X3DObject</a>.FindChild2</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v9.0 (2011)</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Finds the first X3DObject child object of an <a href=\"#!/url=./si_om/X3DObject.html\">X3DObject</a> that \n\
matches a set of search criteria. The search is done recursively by default,\n\
the function returns the object that meet all supplied criteria i.e. name, \n\
type and family(ies). This function is typically used for retrieving an \n\
object if you know its type or name for instance.\n\
<br /><br />\n\
This method differs from <a href=\"#!/url=./si_om/X3DObject.FindChild.html\">X3DObject.FindChild</a> because this \n\
method will not return itself if its family matches the specified family. \n\
For example, calling \'cube.FindChild(\"\", siMeshFamily)\' will return the cube \n\
itself but this method will return null.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>X3DObject X3DObject.FindChild2( Object in_varName, String in_pbstrType, Object in_famArray, Boolean in_bRecursive );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = X3DObject.FindChild2( [Name], [Type], [Family], [Recursive] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
\n\
		A name expression or a <a href=\"#!/url=./si_om/CollectionItem.html\">CollectionItem</a>, the \n\
		expression can also contain wildcard characters. The name can be empty if \n\
...
# Expected results:\n\
# INFO : FindChild : cube\n\
# INFO : FindChild2: &amp;lt;none&amp;gt;</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
