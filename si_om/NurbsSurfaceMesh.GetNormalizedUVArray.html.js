...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>NurbsSurfaceMesh.GetNormalizedUVArray</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>NurbsSurfaceMesh.GetNormalizedUVArray</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/NurbsSurfaceMesh.html\">NurbsSurfaceMesh</a>.GetNormalizedUVArray <img src=\"images/operator.gif\" alt=\"operator\" /></h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v5.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns the normalized UV surface parameters defining point locators.\n\
<br /><br />\n\
Notice that this information is part of the NurbsSurfaceMesh point locator\'s \n\
definition, and depends on the topology only (won\'t change if the geometry \n\
is deformed).\n\
<br /><br />\n\
The subsurface index on which the normalized UVs apply can be queried with \n\
<a href=\"#!/url=./si_om/NurbsSurfaceMesh.GetSubSurfaceIndexArray.html\">NurbsSurfaceMesh.GetSubSurfaceIndexArray</a>.\n\
<br /><br />\n\
An example using this method can be found on the page for the \n\
<a href=\"#!/url=./si_om/NurbsSurfaceMesh.GetSubSurfaceIndexArray.html\">NurbsSurfaceMesh.GetSubSurfaceIndexArray</a> method.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Object NurbsSurfaceMesh.GetNormalizedUVArray( PointLocatorData in_pPtLocators, Object in_pPointLocatorsIndices );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oArray = NurbsSurfaceMesh.GetNormalizedUVArray( PtLocators, [PointLocatorsIndices] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>2-dimensional <a href=\"#!/url=./files/Array.htm\">Array</a> of UV pairs</p></div>\n\
\n\
<h3>Parameters</h3>\n\
