...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>Material.GetShaderInputType</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Material.GetShaderInputType</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Material.html\">Material</a>.GetShaderInputType</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v5.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns the shader input type for the specified parameter. If the parameter cannot be connected\n\
to another shader GetShaderInputType returns siUnknownInputType.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>siShaderParameterType Material.GetShaderInputType( String Parametername );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = Material.GetShaderInputType( ParameterScriptName );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
Script name of the parameter		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Shader.OutputType.html\">Shader.OutputType</a> <a href=\"#!/url=./si_om/Parameter.ScriptName.html\">Parameter.ScriptName</a></p></div>\n\
\n\
