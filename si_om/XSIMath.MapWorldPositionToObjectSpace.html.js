...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>XSIMath.MapWorldPositionToObjectSpace</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>XSIMath.MapWorldPositionToObjectSpace</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/XSIMath.html\">XSIMath</a>.MapWorldPositionToObjectSpace</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>Converts a position described in WorldSpace to a position in a different ObjectSpace.</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SIVector3 XSIMath.MapWorldPositionToObjectSpace( SITransformation in_pObjectSpace, SIVector3 in_pPosition );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = XSIMath.MapWorldPositionToObjectSpace( ObjectSpace, Position );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>The new <a href=\"#!/url=./si_om/SIVector3.html\">SIVector3</a> position.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
 ObjectSpace in which we want to convert the position.		</td>\n\
	</tr>\n\
	<tr>\n\
...
mynull.Kinematics.local.Parameters(\"posz\").value = oObjectPos.z</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
