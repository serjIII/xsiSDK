...
\n\
<h2 class=\"pagehead\">Source</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_Source\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1Source.html\">Source</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
<p class=\"level1\"><a href=\"#!/url=./si_om/SIObject.html\">SIObject</a></p>\n\
<p class=\"level2\"><a href=\"#!/url=./si_om/ProjectItem.html\">ProjectItem</a></p>\n\
<p class=\"level3\">Source</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Sources are references to data which are instantiated. For example, a shape source \n\
becomes a <a href=\"#!/url=./si_om/ShapeClip.html\">ShapeClip</a> in the animation mixer when it is instantiated \n\
there. There are several types of sources: <br /><br />\n\
(1) Action animation: stores animation data with a <a href=\"#!/url=./files/RelativeName.htm\">RelativeName</a> to a parameter. \n\
	...
	Source object called an ActionSource object--see the <a href=\"#!/url=./si_om/ActionSource.html\">ActionSource</a> \n\
...
(2) Shape animation: stores shape data on point clusters relative to the reference shape\n\
	in <a href=\"#!/url=./si_om/ShapeKey.html\">ShapeKey</a>s. Shape animation is a specialized kind of Source object \n\
	called an ActionSource object--see the <a href=\"#!/url=./si_om/ActionSource.html\">ActionSource</a> documentation \n\
...
(4) Image files: image sources add to the scene content when instantiated (rather than \n\
	...
	to image files (see the <a href=\"#!/url=./si_om/Image.html\">Image</a> object for more details). <br /><br />\n\
This object represents all sources (for action and shape animation sources, see \n\
<a href=\"#!/url=./si_om/ActionSource.html\">ActionSource</a>), including audio and image sources. To access the existing \n\
underlying sources used to instantiate a clip, use the <a href=\"#!/url=./si_om/Clip.Source.html\">Clip.Source</a> property.<br /><br />\n\
To create audio and image sources, you can use the <a href=\"#!/url=./si_cmds/ImportAudio.html\">ImportAudio</a> and \n\
<a href=\"#!/url=./si_cmds/AddImageSource.html\">AddImageSource</a> commands which import or add references to the external source \n\
files, and then return the Source object. For creating action and shape sources via scripting, \n\
see <a href=\"#!/url=./si_om/ActionSource.html\">ActionSource</a>.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Clip.Source.html\">Clip.Source</a> <a href=\"#!/url=./si_cmds/AddImageSource.html\">AddImageSource</a> <a href=\"#!/url=./si_cmds/ImportAudio.html\">ImportAudio</a></p></div>\n\
\n\
