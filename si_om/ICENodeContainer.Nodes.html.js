...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>ICENodeContainer.Nodes</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ICENodeContainer.Nodes</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/ICENodeContainer.html\">ICENodeContainer</a>.Nodes</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns an <a href=\"#!/url=./si_om/ICENodeCollection.html\">ICENodeCollection</a> containing all nodes in this container, \n\
including both <a href=\"#!/url=./si_om/ICENode.html\">ICENode</a> and the immediate <a href=\"#!/url=./si_om/ICECompoundNode.html\">ICECompoundNode</a> \n\
objects. To access the inner nodes of ICECompoundNode objects you need to call this\n\
property on their respective ICECompoundNode parents (via <a href=\"#!/url=./si_om/ICENodeContainer.CompoundNodes.html\">ICENodeContainer.CompoundNodes</a>). \n\
<br /><br />\n\
This property is typically used for iterating over an entire node graph. For example, \n\
start by calling this property on the <a href=\"#!/url=./si_om/ICETree.html\">ICETree</a>. While iterating \n\
over the returned collection, when you find a compound node, call \n\
<a href=\"#!/url=./si_om/ICENodeContainer.CompoundNodes.html\">ICENodeContainer.CompoundNodes</a> on it to get any inner compound nodes\n\
and so on recursively down through the graph.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
...
ICENodeCollection rtn = ICENodeContainer.Nodes;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\"># Sample code to show how to traverse a node graph with ICENodeContainer\n\
...
# INFO : ....Multiply\n\
# INFO : ....ScalarToRotation</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/ICENodeContainer.CompoundNodes.html\">ICENodeContainer.CompoundNodes</a> <a href=\"#!/url=./si_om/ICENodeContainer.DataModifierNodes.html\">ICENodeContainer.DataModifierNodes</a> <a href=\"#!/url=./si_om/ICENodeContainer.DataProviderNodes.html\">ICENodeContainer.DataProviderNodes</a></p></div>\n\
\n\
