...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Clip.AddProperty</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Clip.html\">Clip</a>.AddProperty</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
...
to a Clip object.\n\
<br /><br />Note: This method could return an invalid object in python, use <a href=\"#!/url=./si_om/Clip.AddProperty2.html\">Clip.AddProperty2</a> instead.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Property Clip.AddProperty( Object in_Preset, Boolean in_Branch, String in_name );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = Clip.AddProperty( Preset, [BranchFlag], [Name] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
\n\
		...
		<a href=\"#!/url=./si_cmds/UserDataMapPresets.html\">UserDataMap Presets</a> are valid for clips.\n\
		<br /><br />\n\
...
//of the PPG\n\
InspectObj( oClip ) ;</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/SceneItem.AddProperty.html\">SceneItem.AddProperty</a> <a href=\"#!/url=./si_om/Clip.Properties.html\">Clip.Properties</a></p></div>\n\
\n\
