...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>SIMatrix4.Invert</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/SIMatrix4.html\">SIMatrix4</a>.Invert</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>Inverts the matrix m and stores the result in this matrix: this = m^-1 </p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Int32 SIMatrix4.Invert( SIMatrix4 in_pMatrix );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oBoolean = SIMatrix4.Invert( m );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p><a href=\"#!/url=./files/Boolean.htm\">Boolean</a> True if the matrix m has been inverted (m is not singular); otherwise False.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
