...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>ActionDelta.RemoveItem</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ActionDelta.RemoveItem</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/ActionDelta.html\">ActionDelta</a>.RemoveItem</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Removes an <a href=\"#!/url=./si_om/ActionDeltaItem.html\">ActionDeltaItem</a> from the ActionDelta.\n\
<br /><br />\n\
Note: After a removal, the ActionDeltaItem object may not target \n\
the same item (see example).\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ActionDelta.RemoveItem( Object in_vTarget );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ActionDelta.RemoveItem( Target );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
//INFO : Second item name after removing oActionDeltaItem1: cube.kine.local.posz</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/ActionDelta.RemoveAllItems.html\">ActionDelta.RemoveAllItems</a> <a href=\"#!/url=./si_om/Delta.RemoveAction.html\">Delta.RemoveAction</a></p></div>\n\
\n\
