...
\n\
<h2 class=\"pagehead\">ValueMap</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_ValueMap\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1ValueMap.html\">ValueMap</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
<p class=\"level1\"><a href=\"#!/url=./si_om/SIObject.html\">SIObject</a></p>\n\
<p class=\"level2\">ValueMap</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v9.0 (2011)</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> A Value Map is set of name-value pairs defined for a <a href=\"#!/url=./si_om/ShaderDef.html\">ShaderDef</a>, a <a href=\"#!/url=./si_om/ShaderParamDef.html\">ShaderParamDef</a>, \n\
a <a href=\"#!/url=./si_om/ShaderArrayParamDef.html\">ShaderArrayParamDef</a>, or a <a href=\"#!/url=./si_om/MetaShaderRendererDef.html\">MetaShaderRendererDef</a>. This is the equivalent of\n\
a dictionary or associative array.\n\
<br /><br />\n\
Tip: There is no Count property implemented on this object, so if you want to access the number of entries \n\
(for example, if you wanted to iterate over the entire set), you should use the <a href=\"#!/url=./si_om/ValueMap.Names.html\">ValueMap.Names</a> \n\
property to get the list of names defined in this ValueMap and then get the length of that safe<a href=\"#!/url=./files/Array.htm\">Array</a>.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
	<tr>\n\
\n\
		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/ValueMap.Get.html\">Get</a> <img src=\"images/operator.gif\" alt=\"operator\" />		</td>		<td class=\"members\"><a href=\"#!/url=./si_om/SIObject.IsClassOf.html\">IsClassOf</a> <img src=\"images/operator.gif\" alt=\"operator\" />		</td>		<td class=\"members\"><a href=\"#!/url=./si_om/SIObject.IsEqualTo.html\">IsEqualTo</a> <img src=\"images/operator.gif\" alt=\"operator\" />		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/ValueMap.Remove.html\">Remove</a> <img src=\"images/operator.gif\" alt=\"operator\" />		</td>	</tr>\n\
\n\
	<tr>\n\
\n\
		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/ValueMap.Set.html\">Set</a> <img src=\"images/operator.gif\" alt=\"operator\" />		</td>		<td class=\"members\">&nbsp;		</td>		<td class=\"members\">&nbsp;		</td>		<td class=\"members\">&nbsp;		</td>	</tr>\n\
\n\
	<tr>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\"># See the example under the ValueMap.Remove method</pre></td></tr>\n\
</table>\n\
