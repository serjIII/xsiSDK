...
\n\
<h2 class=\"pagehead\">EventInfo</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_EventInfo\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1EventInfo.html\">EventInfo</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
<p class=\"level1\"><a href=\"#!/url=./si_om/SIObject.html\">SIObject</a></p>\n\
<p class=\"level2\">EventInfo</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v2.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> EventInfo holds read-only information on a particular event such the name,\n\
type, event handler name, etc., this information can be accessed through the\n\
EventInfo properties. EventInfo objects are created with\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">on error resume next\n\
