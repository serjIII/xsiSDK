...
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Shader.html\">Shader</a>.ProgID</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v2.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a <a href=\"#!/url=./files/String.htm\">String</a> id that can be used to recreate the shader using\n\
the <a href=\"#!/url=./si_om/Parameter.ConnectFromProgID.html\">Parameter.ConnectFromProgID</a> method.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
...
String rtn = Shader.ProgID;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
color8mix2.color1.Connect tex3d</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
