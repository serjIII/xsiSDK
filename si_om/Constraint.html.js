...
\n\
<h2 class=\"pagehead\">Constraint</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_Constraint\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1Constraint.html\">Constraint</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
...
<p class=\"level4\">Constraint</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> The Constraint object represents a constraint in the scene graph. Constraints allow you to \n\
constrain objects to other object\'s animation. For example,  you can constrain an object to \n\
always point in the direction of another object using the direction constraint. You apply \n\
constraints on objects using the <a href=\"#!/url=./si_om/Kinematics.AddConstraint.html\">Kinematics.AddConstraint</a> method. You can \n\
find the constraints that are being applied to an object using the \n\
<a href=\"#!/url=./si_om/Kinematics.Constraints.html\">Kinematics.Constraints</a> property or find which constraint is driving a \n\
particular parameter using the <a href=\"#!/url=./si_om/Parameter.Source.html\">Parameter.Source</a> property. You can get the \n\
Constraint\'s type with <a href=\"#!/url=./si_om/SIObject.Type.html\">SIObject.Type</a> property.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/ConstraintCollection.html\">ConstraintCollection</a> <a href=\"#!/url=./si_om/Kinematics.html\">Kinematics</a> <a href=\"#!/url=./si_om/Kinematics.AddConstraint.html\">Kinematics.AddConstraint</a> <a href=\"#!/url=./si_om/Parameter.Source.html\">Parameter.Source</a> <a href=\"#!/url=./si_cmds/ApplyCns.html\">ApplyCns</a></p></div>\n\
\n\
