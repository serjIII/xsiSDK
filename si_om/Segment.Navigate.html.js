...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Segment.Navigate</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Segment.html\">Segment</a>.Navigate</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>Allows you to navigate through the segments of the associated geometry.</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Segment Segment.Navigate( siNavigateComponentType in_siNavigate );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = Segment.Navigate( Navigation );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p><a href=\"#!/url=./si_om/Segment.html\">Segment</a></p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
//INFO : The previous segment is of index 6</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/SegmentCollection.Navigate.html\">SegmentCollection.Navigate</a> <a href=\"#!/url=./si_om/Geometry.Segments.html\">Geometry.Segments</a></p></div>\n\
\n\
