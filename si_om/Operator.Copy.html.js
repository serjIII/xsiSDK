...
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Operator.html\">Operator</a>.Copy</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Creates a copy of the operator. Only the operator\'s parameter values are copied. If any of its\n\
parameters are driven by other sources (for example an <a href=\"#!/url=./si_om/FCurve.html\">FCurve</a>) these are not copied.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Operator Operator.Copy();</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = Operator.Copy();</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
// Expected result:\n\
//INFO : cube.polymsh.bendop.angle=45</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
