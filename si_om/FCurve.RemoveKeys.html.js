...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>FCurve.RemoveKeys</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/FCurve.html\">FCurve</a>.RemoveKeys</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Removes all keys between StartFrame and EndFrame and returns \n\
the number of keys removed.<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Int32 FCurve.RemoveKeys( Object in_StartFrame, Object in_EndFrame, Boolean in_OverrideKeyLock );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oLong = FCurve.RemoveKeys( [StartFrame], [EndFrame], [OverrideKeyLock] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
The time in frames at which to start removing keys.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
The frame of the first key on the function curve.			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
The frame of the last key on the function curve			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
//INFO : \"keys removed 11\"</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/FCurve.Locked.html\">FCurve.Locked</a> <a href=\"#!/url=./si_om/FCurve.RemoveKey.html\">FCurve.RemoveKey</a> <a href=\"#!/url=./si_om/FCurve.RemoveKeyAtIndex.html\">FCurve.RemoveKeyAtIndex</a> <a href=\"#!/url=./si_om/FCurve.RemoveKeysAtIndex.html\">FCurve.RemoveKeysAtIndex</a></p></div>\n\
\n\
