...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>CustomProperty.AddParameter</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>CustomProperty.AddParameter</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/CustomProperty.html\">CustomProperty</a>.AddParameter</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Adds a new custom parameter to the custom property. <br /><br />\n\
Note: For a JScript-compliant version, see <a href=\"#!/url=./si_om/CustomProperty.AddParameter2.html\">CustomProperty.AddParameter2</a>,\n\
and for a simplified version see <a href=\"#!/url=./si_om/CustomProperty.AddParameter3.html\">CustomProperty.AddParameter3</a>.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Parameter CustomProperty.AddParameter( String in_ScriptName, siVariantType in_ValueType, siParamClassification in_Classif, Int32 in_Caps, String in_name, String in_LongName, String in_Guid, Object in_DefaultValue, Object in_Min, Object in_Max, Object in_SuggestedMin, Object in_SuggestedMax );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = CustomProperty.AddParameter( ScriptName, ValueType, [Classification], [Capabilities], [Name], [Description], [ObsoleteArg], [DefaultValue], [Min], [Max], [SuggestedMin], [SuggestedMax] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
argument specifies the ScriptName of a parameter and should not contain any spaces.  \n\
...
this name is also used as the short name and description.		</td>\n\
	</tr>\n\
	<tr>\n\
...
The recommended types are: siString, siBool, siInt4, siUByte, and siDouble.\n\
The supported types are: siString, siBool, siDouble, siFloat, \n\
siInt4, siInt2, siUInt4, siUInt2, siByte, siUByte\n\
...
these flags can be overridden on a per-instance basis via <a href=\"#!/url=./si_om/Parameter.Capabilities.html\">Parameter.Capabilities</a>.\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/CustomProperty.html\">CustomProperty</a> <a href=\"#!/url=./si_om/CustomProperty.AddParameter2.html\">CustomProperty.AddParameter2</a> <a href=\"#!/url=./si_om/CustomProperty.AddParameter3.html\">CustomProperty.AddParameter3</a> <a href=\"#!/url=./si_om/Parameter.html\">Parameter</a></p></div>\n\
\n\
