...
\n\
<h2 class=\"pagehead\">Framebuffer</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_Framebuffer\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1Framebuffer.html\">Framebuffer</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
<p class=\"level1\"><a href=\"#!/url=./si_om/SIObject.html\">SIObject</a></p>\n\
<p class=\"level2\"><a href=\"#!/url=./si_om/ProjectItem.html\">ProjectItem</a></p>\n\
<p class=\"level3\">Framebuffer</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> The Framebuffer object controls the file output of a <a href=\"#!/url=./si_om/RenderChannel.html\">RenderChannel</a> object. \n\
It can be created using the <a href=\"#!/url=./si_om/Pass.CreateFramebuffer.html\">Pass.CreateFramebuffer</a> method or the \n\
<a href=\"#!/url=./si_cmds/CreateFramebuffer.html\">CreateFramebuffer</a> command.\n\
<br /><br />\n\
The framebuffer format can be selected from the list of formats provided by the rendering \n\
engine selected on the framebuffer\'s <a href=\"#!/url=./si_om/Pass.html\">Pass</a> object.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
...
// INFO : Framebuffer \'Diffuse\' writes to \'&lt;factory_path&gt;\\Data\\XSI_SAMPLES\\Render_Pictures\\diffuse.####.pic\'</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/RenderChannel.html\">RenderChannel</a> <a href=\"#!/url=./si_om/FramebufferCollection.html\">FramebufferCollection</a> <a href=\"#!/url=./si_om/SceneRenderProperty.html\">SceneRenderProperty</a> <a href=\"#!/url=./si_om/Pass.html\">Pass</a></p></div>\n\
\n\
