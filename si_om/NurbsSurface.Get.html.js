...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>NurbsSurface.Get</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/NurbsSurface.html\">NurbsSurface</a>.Get <img src=\"images/operator.gif\" alt=\"operator\" /></h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a complete data description of the NurbsSurface. <br /><br />\n\
...
<a href=\"#!/url=./si_om/NurbsSurface.Get2.html\">NurbsSurface.Get2</a>.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>NurbsSurface.Get( siNurbsFormat in_eNurbsFormat, Object& out_pvsaUVControlPoints, Object& out_pvsaUKnots, Object& out_pvsaVKnots, Object& out_pvbUClosed, Object& out_pvbVClosed, Object& out_pvlUDegree, Object& out_pvlVDegree, Object& out_pveUParam, Object& out_pveVParam );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>NurbsSurface.Get( [NurbsFormat], ControlPoints, [UKnots], [VKnots], [UClosed], [VClosed], [UDegree], [VDegree], [UParameterization], [VParameterization] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
