...
\n\
<h2 class=\"pagehead\">Layer</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_Layer\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1Layer.html\">Layer</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
...
<p class=\"level5\">Layer</p>\n\
\n\
<h3>Description</h3>\n\
<div><p> The Layer is a self-contained collection of <a href=\"#!/url=./si_om/Scene.html\">Scene</a> items. \n\
It reports \"Layer\" when queried with the <a href=\"#!/url=./si_om/Application.ClassName.html\">Application.ClassName</a> method.\n\
A layer group is just when a layer itself has some sub layer as children. It allows to override what the\n\
sub layer is doing (visibility override for example) in a non-destructive way.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Scene.ActiveLayer.html\">Scene.ActiveLayer</a> <a href=\"#!/url=./si_om/LayerCollection.html\">LayerCollection</a></p></div>\n\
\n\
