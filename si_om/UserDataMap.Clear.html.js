...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>UserDataMap.Clear</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/UserDataMap.html\">UserDataMap</a>.Clear <img src=\"images/operator.gif\" alt=\"operator\" /></h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Removes all user data information from the user data map.  This does not change\n\
the size of the user data map as reported by <a href=\"#!/url=./si_om/UserDataMap.Count.html\">UserDataMap.Count</a>, because\n\
the size is always the same as the <a href=\"#!/url=./si_om/Cluster.html\">Cluster</a>.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>UserDataMap.Clear();</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\'This example demonstrates UserDataMap.Clear\n\
