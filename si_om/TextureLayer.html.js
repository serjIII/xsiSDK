...
\n\
<h2 class=\"pagehead\">TextureLayer</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_TextureLayer\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1TextureLayer.html\">TextureLayer</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
<p class=\"level1\"><a href=\"#!/url=./si_om/SIObject.html\">SIObject</a></p>\n\
<p class=\"level2\"><a href=\"#!/url=./si_om/ProjectItem.html\">ProjectItem</a></p>\n\
<p class=\"level3\">TextureLayer</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> The TextureLayer is an object which simplifies layering of shader effects on top of shaders \n\
...
<br /><br /><a href=\"#!/url=./si_om/TextureLayerPort.html\">TextureLayerPort</a> objects are owned by TextureLayers, and are used to specify \n\
...
<br /><br />\n\
TextureLayers can be created using <a href=\"#!/url=./si_om/Shader.CreateTextureLayer.html\">Shader.CreateTextureLayer</a> and\n\
<a href=\"#!/url=./si_om/Material.CreateTextureLayer.html\">Material.CreateTextureLayer</a>.  TextureLayers can have \"sub\" render trees \n\
connected to them as driving inputs, in the same way one would connect <a href=\"#!/url=./si_om/Shader.html\">Shader</a> \n\
objects together (using <a href=\"#!/url=./si_om/Parameter.ConnectFromPreset.html\">Parameter.ConnectFromPreset</a> or \n\
<a href=\"#!/url=./si_om/Parameter.Connect.html\">Parameter.Connect</a>).\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">// This example shows creation of texture layers,\n\
