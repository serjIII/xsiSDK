...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>SIMatrix3.Value</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/SIMatrix3.html\">SIMatrix3</a>.Value</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Sets or returns the (i,j)th value (<a href=\"#!/url=./files/Double.htm\">Double</a>) of the 3x3 matrix, \n\
where i are rows and j are columns. <br /><br />\n\
	| m[0,0]  m[0,1]  m[0,2] |<br /><br />\n\
	| m[1,0]  m[1,1]  m[1,2] |<br /><br />\n\
	| m[2,0]  m[2,1]  m[2,2] |<br /><br />\n\
Tip: Value is the SIMatrix3 object\'s default property, which means that\n\
you can call the method by just using the parenthesis and leaving \n\
out the property name for example m(i,j).\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
...
// set accessor\n\
ISIMatrix3.set_Value( Int16 in_nRow, Int16 in_nCol, Double pVal );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
