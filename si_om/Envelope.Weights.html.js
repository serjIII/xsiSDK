...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Envelope.Weights</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Envelope.html\">Envelope</a>.Weights</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a <a href=\"#!/url=./si_om/ClusterElementCollection.html\">ClusterElementCollection</a> containing the deformer weights \n\
for the envelope. The <a href=\"#!/url=./si_om/ClusterElementCollection.Array.html\">ClusterElementCollection.Array</a> property provides \n\
access to a 2-dimensional <a href=\"#!/url=./files/Array.htm\">Array</a>, where the first dimension maps to the  \n\
...
ClusterElementCollection Envelope.get_Weights( Object );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Envelope.GetWeights2.html\">Envelope.GetWeights2</a></p></div>\n\
\n\
