...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>ImageClip.GetImage</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ImageClip.GetImage</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/ImageClip.html\">ImageClip</a>.GetImage</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v2.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns the <a href=\"#!/url=./si_om/Image.html\">Image</a> data associated with the clip.<br /><br />\n\
...
can determine the resolution more quickly via the <a href=\"#!/url=./si_om/Source.html\">Source</a> \n\
object, as demonstrated in one of the examples under the main \n\
<a href=\"#!/url=./si_om/ImageClip.html\">ImageClip</a> topic.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Image ImageClip.GetImage( Object in_vFrame );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = ImageClip.GetImage( [Variant] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
\n\
		Frame corresponding to the play cursor at the time that the \n\
		ImageClip instance was created.\n\
				</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
