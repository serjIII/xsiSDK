...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>Geometry1D.LocalReferenceFrame</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Geometry1D.LocalReferenceFrame</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Geometry1D.html\">Geometry1D</a>.LocalReferenceFrame</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>Get the local reference frame at a given 1D geometry</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Geometry1D.LocalReferenceFrame( compIdx, XAxis, XAxisValid, YAxis, YAxisValid, ZAxis, ZAxisValid );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
 ...
 Index of the component 			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				...
				<tr>\n\
					<td class=\"name\">0 <= compidx=\"\"></=>< number=\"\" of=\"\" 1d=\"\" geometry=\"\" /></td>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Upon return, contains the X axis of the local reference frame at the (compIdx)th 1D geometry 		</td>\n\
	</tr>\n\
	<tr>\n\
 ...
 Upon return, contains TRUE if the X axis of the reference frame is valid, else FALSE 		</td>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./si_om/SIVector3.html\">SIVector3</a>		</td>\n\
		<td>\n\
 Upon return, contains the Y axis of the local reference frame at the (compIdx)th 1D geometry 		</td>\n\
	</tr>\n\
	<tr>\n\
 ...
 Upon return, contains TRUE if the Y axis of the reference frame is valid, else FALSE 		</td>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./si_om/SIVector3.html\">SIVector3</a>		</td>\n\
		<td>\n\
 Upon return, contains the Z axis of the local reference frame at the (compIdx)th 1D geometry 		</td>\n\
	</tr>\n\
	<tr>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Geometry1D.AverageLocalReferenceFrame.html\">Geometry1D.AverageLocalReferenceFrame</a> <a href=\"#!/url=./si_om/Geometry_V1.Geometry1D.html\">Geometry_V1.Geometry1D</a> <a href=\"#!/url=./si_om/Geometry_V1.Nb1D.html\">Geometry_V1.Nb1D</a> <a href=\"#!/url=./si_om/SIVector3.html\">SIVector3</a></p></div>\n\
\n\
