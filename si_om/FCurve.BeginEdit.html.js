...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>FCurve.BeginEdit</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/FCurve.html\">FCurve</a>.BeginEdit</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Starts recording bulk edits made to the fcurve. A call to BeginEdit \n\
must be paired with a call to <a href=\"#!/url=./si_om/FCurve.EndEdit.html\">FCurve.EndEdit</a>, which \n\
commit your changes to the undo/redo stack.<br /><br />\n\
Editing changes can be undone by calling <a href=\"#!/url=./si_om/FCurve.UndoEdit.html\">FCurve.UndoEdit</a> \n\
and you can check if the fcurve is being bulk-edited by using the \n\
<a href=\"#!/url=./si_om/FCurve.IsEditing.html\">FCurve.IsEditing</a> method. <br /><br />\n\
Note: If you try to begin another bulk-edit a warning is issued and the \n\
current editing is committed to the undo/redo stack.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>FCurve.BeginEdit();</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/FCurve.EndEdit.html\">FCurve.EndEdit</a> <a href=\"#!/url=./si_om/FCurve.UndoEdit.html\">FCurve.UndoEdit</a> <a href=\"#!/url=./si_om/FCurve.IsEditing.html\">FCurve.IsEditing</a></p></div>\n\
\n\
