...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Kinematics.Local</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Kinematics.html\">Kinematics</a>.Local <img src=\"images/operator.gif\" alt=\"operator\" /></h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a <a href=\"#!/url=./si_om/KinematicState.html\">KinematicState</a> containing the local transformation \n\
of the <a href=\"#!/url=./si_om/X3DObject.html\">X3DObject</a> (the transformation relative to the parent).\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
...
KinematicState rtn = Kinematics.Local;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">dim cone, n\n\
...
logmessage \"Cone scaling: \" &amp; cone.Kinematics.Local.Parameters(\"sclx\").value &amp;\",\"&amp; cone.Kinematics.Local.Parameters(\"scly\").value &amp;\",\"&amp; cone.Kinematics.Local.Parameters(\"sclz\").value</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Kinematics.Global.html\">Kinematics.Global</a> <a href=\"#!/url=./si_om/X3DObject.LocalTranslation.html\">X3DObject.LocalTranslation</a> <a href=\"#!/url=./si_om/X3DObject.LocalScaling.html\">X3DObject.LocalScaling</a> <a href=\"#!/url=./si_om/X3DObject.LocalRotation.html\">X3DObject.LocalRotation</a></p></div>\n\
\n\
