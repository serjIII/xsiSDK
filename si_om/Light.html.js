...
\n\
<h2 class=\"pagehead\">Light</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_Light\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1Light.html\">Light</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
...
<p class=\"level6\">Light</p>\n\
\n\
<h3>Description</h3>\n\
<div><p> The Light object represents a Softimage light within a scene, such as a light \n\
point, a spot light, etc. Light can be created with <a href=\"#!/url=./si_om/X3DObject.AddLight.html\">X3DObject.AddLight</a>.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">dim pointLight\n\
set pointLight = ActiveProject.ActiveScene.Root.AddLight(\"Point\")\n\
LogMessage \"Point light name: \" &amp; pointLight.Name</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
