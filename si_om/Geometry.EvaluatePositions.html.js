...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>Geometry.EvaluatePositions</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Geometry.EvaluatePositions</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Geometry.html\">Geometry</a>.EvaluatePositions <img src=\"images/operator.gif\" alt=\"operator\" /></h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v5.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Evaluates the positions at the surface locations defined by the input point locator data.\n\
The returned positions are in geometry\'s local space reference.\n\
<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Object Geometry.EvaluatePositions( PointLocatorData in_pPtLocators, Object in_pPointLocatorsIndices );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oArray = Geometry.EvaluatePositions( PointLocators, [Indices] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
Point locators to be evaluated.		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
Indices of the point locators to be evaluated (all if not specified).		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
