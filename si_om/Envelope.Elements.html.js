...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Envelope.Elements</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Envelope.html\">Envelope</a>.Elements</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a <a href=\"#!/url=./si_om/ClusterElementCollection.html\">ClusterElementCollection</a> which provides access to the \n\
mapping between the indices of the Envelope and the associated vertex indices.  \n\
This is important for Envelopes applied on partial clusters.  This is equivalent\n\
to calling <a href=\"#!/url=./si_om/Cluster.Elements.html\">Cluster.Elements</a> on the Cluster that the Envelope is \n\
attached to.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
...
ClusterElementCollection Envelope.get_Elements( Object );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\'vbscript example that demonstrates how Envelope indices are mapped\n\
...
\'INFO : \"Envelope Weight 2 refers to point 12 on the Geometry\"</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
