...
\n\
<h2 class=\"pagehead\">ICETree</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_ICETree\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1ICETree.html\">ICETree</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
...
<p class=\"level5\">ICETree</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> The ICETree object represents a node graph and holds all the effect nodes together. It serves as a container for \n\
objects such as <a href=\"#!/url=./si_om/ICENode.html\">ICENode</a> and <a href=\"#!/url=./si_om/ICECompoundNode.html\">ICECompoundNode</a>. The ICETree is attached to the \n\
<a href=\"#!/url=./si_om/Primitive.html\">Primitive</a> being modified and acts like the evaluation entry-point for the entire graph.\n\
ICETree objects can be created with the ApplyOp command by passing the ICETree preset as argument.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
...
\n\
	<tr>\n\
\n\
		<td class=\"members\"><a href=\"#!/url=./si_om/SIObject.NestedObjects.html\">NestedObjects</a>		</td>		<td class=\"members\"><a href=\"#!/url=./si_om/ICENodeContainer.Nodes.html\">Nodes</a>		</td>		<td class=\"members\"><a href=\"#!/url=./si_om/ProjectItem.ObjectID.html\">ObjectID</a>		</td>		<td class=\"members\"><a href=\"#!/url=./si_om/SIObject.Origin.html\">Origin</a>		</td>	</tr>\n\
\n\
	<tr>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\">#Simple example for creating a ICETree object.\n\
...
Application.LogMessage( Application.ClassName( t(0) ) )</pre></td></tr>\n\
</table>\n\
</div><h4>2. Python Example</h4><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"python\">#Simple example for accessing a ICETree object.\n\
Application.CreatePrim(\"Grid\", \"MeshSurface\", \"\", \"\")\n\
Application.ApplyOp(\"ICETree\", \"grid\", \"\", \"\", \"\", 0)\n\
x3DGrid = Application.Selection( 0 )\n\
trees = x3DGrid.GetActivePrimitive3().ICETrees\n\
for t in trees:\n\
	Application.LogMessage( Application.ClassName( t ) )</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
