...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>X3DObject.NodeAnimatedParameters</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>X3DObject.NodeAnimatedParameters</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/X3DObject.html\">X3DObject</a>.NodeAnimatedParameters</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a collection of <a href=\"#!/url=./si_om/Parameter.html\">Parameter</a> objects for all parameters \n\
animated by a specific animation source type on this object\'s node. This \n\
function looks for animated parameters locally and doesn\'t recursively visit \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ParameterCollection X3DObject.NodeAnimatedParameters( siSourceType, Boolean );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = X3DObject.NodeAnimatedParameters( [sourceType], [Local] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
next\n\
\' Expected results:\n\
\'INFO : cube.kine.local.posx is node animated</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/X3DObject.IsNodeAnimated.html\">X3DObject.IsNodeAnimated</a></p></div>\n\
\n\
