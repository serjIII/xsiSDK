...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>View.BeginEdit</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/View.html\">View</a>.BeginEdit</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Puts the view in edit mode. The edit mode allows you to change several\n\
view attributes in bulk without affecting the current UI. Call the \n\
<a href=\"#!/url=./si_om/View.EndEdit.html\">View.EndEdit</a> method to quit the edit mode.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>View.BeginEdit();</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/View.EndEdit.html\">View.EndEdit</a></p></div>\n\
\n\
