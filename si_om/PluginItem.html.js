...
\n\
<h2 class=\"pagehead\">PluginItem</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_PluginItem\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1PluginItem.html\">PluginItem</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
<p class=\"level1\"><a href=\"#!/url=./si_om/SIObject.html\">SIObject</a></p>\n\
<p class=\"level2\">PluginItem</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> The PluginItem object contains the information on each item registered for \n\
plug-ins using the <a href=\"#!/url=./si_om/PluginRegistrar.html\">PluginRegistrar</a> object. A plug-in item is \n\
basically an Softimage customizable component such as command, operator, filter, etc...\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
...
<td class=\"example\"><pre class=\"jscript\">/*\n\
	This example shows how to enumerate plug-in items to display their information.\n\
*/\n\
var items = Application.Plugins(\"Mesh Filter plugin\").Items;\n\
for (var i=0; i&lt;items.Count; i++) \n\
{\n\
	Application.LogMessage( items(i).Name + \" is a \" + items(i).Type );\n\
}</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Plugin.html\">Plugin</a> <a href=\"#!/url=./si_om/Plugin.Items.html\">Plugin.Items</a> <a href=\"#!/url=./si_om/PluginRegistrar.html\">PluginRegistrar</a></p></div>\n\
\n\
