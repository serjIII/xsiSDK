...
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/FCurve.html\">FCurve</a>.Mute</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Sets or returns the fcurve\'s muted state as a <a href=\"#!/url=./files/Boolean.htm\">Boolean</a> (true if \n\
the fcurve is muted). When an fcurve is muted it will not be evaluated during \n\
playback and the corresponding parameter will not be updated. By default this \n\
property is false.<br /><br />\n\
...
// Because the FCurve was muted, the parameter does not update</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
