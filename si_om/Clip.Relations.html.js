...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Clip.Relations</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Clip.html\">Clip</a>.Relations</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a <a href=\"#!/url=./si_om/ClipRelationCollection.html\">ClipRelationCollection</a> containing each <a href=\"#!/url=./si_om/ClipRelation.html\">ClipRelation</a> \n\
objects which is directly affecting this clip. \n\
<br /><br />\n\
Note: To get the collection of <a href=\"#!/url=./si_om/ClipRelation.html\">ClipRelation</a> objects nested under a \n\
<a href=\"#!/url=./si_om/ClipContainer.html\">ClipContainer</a> or the <a href=\"#!/url=./si_om/Mixer.html\">Mixer</a>, use \n\
<a href=\"#!/url=./si_om/ClipContainer.NestedRelations.html\">ClipContainer.NestedRelations</a>.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
...
ClipRelationCollection rtn = Clip.Relations;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
//INFO : The number of clip relations nested affecting myClip is: 1</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
