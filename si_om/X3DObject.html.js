...
\n\
<h2 class=\"pagehead\">X3DObject</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_X3DObject\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1X3DObject.html\">X3DObject</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
...
<p class=\"level4\">X3DObject</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> The X3DObject object represents a 3D-object inside the active <a href=\"#!/url=./si_om/Scene.html\">Scene</a>.  \n\
<br /><br />\n\
...
<a href=\"#!/url=./si_om/ChainRoot.html\">ChainRoot</a>, <a href=\"#!/url=./si_om/ChainBone.html\">ChainBone</a> and <a href=\"#!/url=./si_om/ChainEffector.html\">ChainEffector</a> \n\
X3DObjects. The Scene Explorer view shows this hierarchy. The top node of this tree is the \n\
Scene Root, which is a <a href=\"#!/url=./si_om/Model.html\">Model</a>, and hence an X3DObject itself. \n\
<a href=\"#!/url=./si_om/X3DObject.Children.html\">X3DObject.Children</a> and <a href=\"#!/url=./si_om/SIObject.Parent.html\">SIObject.Parent</a> are available for \n\
...
These generally begin with \"Add\"; for example, the <a href=\"#!/url=./si_om/X3DObject.AddGeometry.html\">X3DObject.AddGeometry</a> \n\
...
nested objects. Most of these nested objects are <a href=\"#!/url=./si_om/Property.html\">Property</a> objects.  For example \n\
the position and other transformation information is available from the <a href=\"#!/url=./si_om/Kinematics.html\">Kinematics</a> \n\
property. The <a href=\"#!/url=./si_om/Material.html\">Material</a> used by the object also appears as a property.\n\
<br /><br />\n\
Polygon Meshes and other X3DObjects with a shape have a nested <a href=\"#!/url=./si_om/Geometry.html\">Geometry</a> object \n\
which is accessible via <a href=\"#!/url=./si_om/X3DObject.ActivePrimitive.html\">X3DObject.ActivePrimitive</a>.Geometry.  The Geometry in turn \n\
could potentially have <a href=\"#!/url=./si_om/Cluster.html\">Cluster</a>s and <a href=\"#!/url=./si_om/ClusterProperty.html\">ClusterProperty</a> objects.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
	<tr>\n\
\n\
		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.Add2DChain.html\">Add2DChain</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.Add3DChain.html\">Add3DChain</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddAnnotation.html\">AddAnnotation</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddCamera.html\">AddCamera</a>		</td>	</tr>\n\
\n\
	<tr>\n\
\n\
		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddCameraRig.html\">AddCameraRig</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddChild.html\">AddChild</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddControl.html\">AddControl</a>		</td>		<td class=\"members\"><a href=\"#!/url=./si_om/ProjectItem.AddCustomOp.html\">AddCustomOp</a>		</td>	</tr>\n\
\n\
	<tr>\n\
\n\
		<td class=\"members\"><a href=\"#!/url=./si_om/SceneItem.AddCustomProperty.html\">AddCustomProperty</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddFxTree.html\">AddFxTree</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddGeometry.html\">AddGeometry</a>		</td>		<td class=\"members\"><a href=\"#!/url=./si_om/ProjectItem.AddICEAttribute.html\">AddICEAttribute</a>		</td>	</tr>\n\
\n\
	<tr>\n\
\n\
		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddLattice.html\">AddLattice</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddLight.html\">AddLight</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddLightRig.html\">AddLightRig</a>		</td>		<td class=\"members\"><a href=\"#!/url=./si_om/SceneItem.AddMaterial.html\">AddMaterial</a>		</td>	</tr>\n\
\n\
	<tr>\n\
\n\
		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddModel.html\">AddModel</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddNull.html\">AddNull</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddNurbsCurve.html\">AddNurbsCurve</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddNurbsCurveList.html\">AddNurbsCurveList</a>		</td>	</tr>\n\
\n\
	<tr>\n\
\n\
		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddNurbsCurveList2.html\">AddNurbsCurveList2</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddNurbsSurface.html\">AddNurbsSurface</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddNurbsSurfaceMesh.html\">AddNurbsSurfaceMesh</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.AddNurbsSurfaceMesh2.html\">AddNurbsSurfaceMesh2</a>		</td>	</tr>\n\
\n\
	<tr>\n\
\n\
...
\n\
	<tr>\n\
\n\
		<td class=\"members\"><a href=\"#!/url=./si_om/SceneItem.SetMaterial.html\">SetMaterial</a>		</td>		<td class=\"members\" style=\"background:#ffffc0;\"><a href=\"#!/url=./si_om/X3DObject.ShapeAnimatedClusters.html\">ShapeAnimatedClusters</a>		</td>		<td class=\"members\"><a href=\"#!/url=./si_om/ProjectItem.TaggedParameters.html\">TaggedParameters</a>		</td>		<td class=\"members\"><a href=\"#!/url=./si_om/ProjectItem.UnSetLock.html\">UnSetLock</a>		</td>	</tr>\n\
\n\
</table>\n\
</p></div>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">var x3dObj, x3dObjSphere;\n\
...
// Expected output: \n\
//INFO : Sphere object\'s name: MySphere</pre></td></tr>\n\
</table>\n\
</div><h4>2. Python Example</h4><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"python\">x3dObj = Application.ActiveSceneRoot\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">dim x3dObj, x3dObjSphere\n\
