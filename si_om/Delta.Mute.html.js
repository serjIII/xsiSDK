...
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Delta.html\">Delta</a>.Mute</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Sets or returns a <a href=\"#!/url=./files/Boolean.htm\">Boolean</a> value indicating whether \n\
the Delta is muted or not (true = muted; false = active).\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
...
//INFO : muting Delta</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/ActionDeltaItem.Mute.html\">ActionDeltaItem.Mute</a></p></div>\n\
\n\
