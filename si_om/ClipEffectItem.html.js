...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ClipEffectItem</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">ClipEffectItem</h2>\n\
\n\
<p><a href=\"#!/url=./si_om/_hier.html#oh_ClipEffectItem\">Object Hierarchy</a> | Related C++ Class: <a href=\"#!/url=./si_cpp/classXSI_1_1ClipEffectItem.html\">ClipEffectItem</a></p>\n\
\n\
<h3>Inheritance<h3>\n\
<p class=\"level1\"><a href=\"#!/url=./si_om/SIObject.html\">SIObject</a></p>\n\
<p class=\"level2\">ClipEffectItem</p>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> A ClipEffectItem is an expression that is bound to a <a href=\"#!/url=./si_om/MappedItem.html\">MappedItem</a> of a Clip.\n\
You can get the ClipEffectItem either from the <a href=\"#!/url=./si_om/ClipEffect.Items.html\">ClipEffect.Items</a> property or\n\
from the <a href=\"#!/url=./si_om/MappedItem.ClipEffectItem.html\">MappedItem.ClipEffectItem</a> property.\n\
</p></div>\n\
\n\
<h3>Methods</h3>\n\
<div><p><table>\n\
...
for i in range(oClip.MappedItems.Count):\n\
	...
	if oParam.FullName == \"cube.kine.local.posy\":\n\
		...
		break\n\
Application.LogMessage(\"The expression associated with the posy item is \" +oCurrMappedItem.ClipEffectItem.Expression)</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Clip.html\">Clip</a> <a href=\"#!/url=./si_om/Model.Mixer.html\">Model.Mixer</a> <a href=\"#!/url=./si_om/Track.html\">Track</a> <a href=\"#!/url=./si_om/Transition.html\">Transition</a> <a href=\"#!/url=./si_cmds/GetMappingRule.html\">GetMappingRule</a> <a href=\"#!/url=./si_cmds/SetMappingRule.html\">SetMappingRule</a></p></div>\n\
\n\
