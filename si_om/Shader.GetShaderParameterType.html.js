...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>Shader.GetShaderParameterType</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Shader.GetShaderParameterType</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Shader.html\">Shader</a>.GetShaderParameterType</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns whether the shader parameter is an input or output parameter and also its type. \n\
If the parameter is not connected to a shader, this method returns \n\
<a href=\"#!/url=./si_om/siShaderParameterType.html#siUnknownParameterType\">siUnknownParameterType</a> instead. \n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Object Shader.GetShaderParameterType( String in_ParameterName );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oArray = Shader.GetShaderParameterType( ParameterScriptName );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p> A two-member <a href=\"#!/url=./files/Array.htm\">Array</a> where item[0] is a <a href=\"#!/url=./files/Boolean.htm\">Boolean</a> \n\
and item[1] is a <a href=\"#!/url=./si_om/siShaderParameterType.html\">siShaderParameterType</a> value.\n\
<br /><br />\n\
If the parameter is not connected to a shader, this method returns \n\
<a href=\"#!/url=./si_om/siShaderParameterType.html#siUnknownParameterType\">siUnknownParameterType</a> instead. \n\
</p></div>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
Script name of parameter (<a href=\"#!/url=./si_om/Parameter.ScriptName.html\">Parameter.ScriptName</a>).		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
