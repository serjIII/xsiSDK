...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>MenuItem.Command</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/MenuItem.html\">MenuItem</a>.Command</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Sets or returns the command for this menu item. The <a href=\"#!/url=./si_om/Command.html\">Command</a> \n\
object command is always returned, but you can specify either the object or\n\
the command\'s <a href=\"#!/url=./si_om/SIObject.Name.html\">SIObject.Name</a> as a <a href=\"#!/url=./files/String.htm\">String</a>. \n\
...
target is passed in. See  <a href=\"#!/url=./si_om/ArgumentCollection.AddWithHandler.html\">ArgumentCollection.AddWithHandler</a> \n\
...
// set accessor\n\
MenuItem.set_Command( Object out_ppCommand );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Menu.html\">Menu</a> <a href=\"#!/url=./si_om/Menu.AddCommandItem.html\">Menu.AddCommandItem</a> <a href=\"#!/url=./si_om/MenuItem.Callback.html\">MenuItem.Callback</a> <a href=\"#!/url=./si_om/ArgumentCollection.AddWithHandler.html\">ArgumentCollection.AddWithHandler</a></p></div>\n\
\n\
