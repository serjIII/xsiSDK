...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>ICEAttribute.GetDataArrayChunk</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ICEAttribute.GetDataArrayChunk</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/ICEAttribute.html\">ICEAttribute</a>.GetDataArrayChunk</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a read-only <a href=\"#!/url=./files/Array.htm\">Array</a> object containing the data defined by this attribute. \n\
The data can be accessed in multiple chunks given an index offset that refers to the attribute\'s \n\
global data buffer and a chunk size. This method is particularly useful for minimizing the \n\
memory allocation required to store the data retrieved from a very large data set. An empty array \n\
is returned if the attribute\'s structure type is not a singleton.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Object ICEAttribute.GetDataArrayChunk( Int32 in_nOffset, Int32 in_nSize );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oArray = ICEAttribute.GetDataArrayChunk( Offset, ChunkSize );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/ICEAttribute.DataArray.html\">ICEAttribute.DataArray</a> <a href=\"#!/url=./si_om/ICEAttribute.DataArray2D.html\">ICEAttribute.DataArray2D</a> <a href=\"#!/url=./si_om/ICEAttribute.GetDataArray2DChunk.html\">ICEAttribute.GetDataArray2DChunk</a></p></div>\n\
\n\
