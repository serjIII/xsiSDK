...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Material.UsedBy</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Material.html\">Material</a>.UsedBy</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns a <a href=\"#!/url=./si_om/ProjectItemCollection.html\">ProjectItemCollection</a> containing <a href=\"#!/url=./si_om/ProjectItem.html\">ProjectItem</a> \n\
objects including not only the owners that contain it but all the objects in the scene \n\
...
Object rtn = Material.UsedBy;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
