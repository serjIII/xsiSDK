...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>PolygonMesh.Set</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/PolygonMesh.html\">PolygonMesh</a>.Set <img src=\"images/operator.gif\" alt=\"operator\" /></h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Sets from a complete data description of the polygon mesh. If you use it on an \n\
object with some clusters and you change the topology the burden of updating the \n\
clusters is on the user.\n\
<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>PolygonMesh.Set( Object in_vertices, Object in_polygonData );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>PolygonMesh.Set( [Vertices], [PolygonData] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
Array representing the polygon vertices. The array is a 2D array (Nx3) of x,y,z values.		</td>\n\
	</tr>\n\
	<tr>\n\
 ...
 \n\
		...
		a ccw ordering to get out going normals (right-hand rule). E.g. array of \n\
		polygons with 4 indices each e.g. {4,0,1,4,3,4,1,2,5,4... }\n\
			</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
...
oCone.ActivePrimitive.Geometry.Set(vertices,polygonData);</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
