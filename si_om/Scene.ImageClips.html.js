...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Scene.ImageClips</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Scene.html\">Scene</a>.ImageClips</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v5.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns an <a href=\"#!/url=./si_om/ImageClipCollection.html\">ImageClipCollection</a> containing all <a href=\"#!/url=./si_om/ImageClip.html\">ImageClip</a> objects \n\
associated with the scene. Image clips and their sources are always stored under the Scene in the \n\
Clips (\"Scene.Clips.Image\") and Sources (\"Scene.Sources.Image\") containers. <br /><br />\n\
...
the <a href=\"#!/url=./si_om/ClipContainer.Clips.html\">ClipContainer.Clips</a> and <a href=\"#!/url=./si_om/Track.Clips.html\">Track.Clips</a> properties return only clips \n\
...
ImageClipCollection rtn = Scene.ImageClips;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
