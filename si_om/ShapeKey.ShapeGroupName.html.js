...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>ShapeKey.ShapeGroupName</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ShapeKey.ShapeGroupName</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/ShapeKey.html\">ShapeKey</a>.ShapeGroupName</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v5.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns or sets a <a href=\"#!/url=./files/String.htm\">String</a> representing the name of the shape group to \n\
...
String rtn = ShapeKey.ShapeGroupName;\n\
// set accessor\n\
ShapeKey.ShapeGroupName = String;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
<td class=\"example\"><pre class=\"jscript\">/* ------------------------------------------------------------------------------\n\
	This example demonstrates how to get and set shape group identifiers.\n\
------------------------------------------------------------------------------ */\n\
NewScene(null, false);\n\
...
// Changing the shape group.\n\
oShapeKey0.ShapeGroupName = \"MyShapeGroup\";\n\
oShapeKey1.ShapeGroupName = \"MyShapeGroup\";\n\
// Logs \"MyShapeGroup\" for both keys.\n\
LogMessage(oShapeKey0.ShapeGroupName);\n\
LogMessage(oShapeKey1.ShapeGroupName);</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/CreateShapeGroup.html\">CreateShapeGroup</a> <a href=\"#!/url=./si_cmds/SetShapeGroup.html\">SetShapeGroup</a></p></div>\n\
\n\
