...
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/CollectionItem.html\">CollectionItem</a>.Name</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns the name of the object or subcomponent as a <a href=\"#!/url=./files/String.htm\">String</a>. For objects, \n\
just the object name is returned, but for subcomponents (points, segments, facets, etc.), \n\
this property returns the name of the 3D object and the subcomponent\'s position on it \n\
(for example, \"cube.pnt[4]\"). \n\
<br /><br />\n\
Note: The behavior of this property for subcomponents changed in version 3.0. Before version \n\
3.0, subcomponents returned their object\'s name only.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
...
String rtn = CollectionItem.Name;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
