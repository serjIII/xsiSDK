...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>FileReference.GUID</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>FileReference.GUID</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/FileReference.html\">FileReference</a>.GUID</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Returns the GUID of a path object as a <a href=\"#!/url=./files/String.htm\">String</a>. The GUID is a unique \n\
identifier for the dynamic life of a path. It should be used to retrieve a handle \n\
on the path object when dealing with the external file list.\n\
<br /><br />\n\
...
String rtn = FileReference.GUID;</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/FileReference.ResolvedPath.html\">FileReference.ResolvedPath</a> <a href=\"#!/url=./si_om/FileReference.Path.html\">FileReference.Path</a> <a href=\"#!/url=./si_om/Scene.ExternalFiles.html\">Scene.ExternalFiles</a> <a href=\"#!/url=./si_om/Scene.GetExternalFile.html\">Scene.GetExternalFile</a></p></div>\n\
\n\
