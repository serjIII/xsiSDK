...
\n\
<h2 class=\"pagehead\"><a href=\"#!/url=./si_om/Delta.html\">Delta</a>.Apply</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p> Applies the Delta to a reference model. Use this method when you add modifications \n\
to a delta (for example, using the <a href=\"#!/url=./si_om/ActionDelta.AddFCurveItem.html\">ActionDelta.AddFCurveItem</a> method)\n\
and you want to apply those changes back to the reference model.\n\
</p></div>\n\
\n\
<h3>C# Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Delta.Apply();</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/ApplyDelta.html\">ApplyDelta</a></p></div>\n\
\n\
