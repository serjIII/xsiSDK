...
function openRefLinkDiv(e)
{
   var $oRefLinkDiv = $("#reflinkdiv");
	...
	if (!getResults($(this).attr('data'), $oRefLinkDiv))
		return false;
...
function getResults(symbolName, $oRefLinkDiv)
{
	...
	{
		window.location.href = prefix + a_reflinkmatches[0][1];
		return false;
	}
...
function resizeRefLinkDiv (evt, $oRefLinkDiv) 
{
    ...
    {
    	if (contentDiv.css("position") == "absolute")  // we are in mobile
    	{
