    ...
    function loader() {
        ...
        function docClickHandler(e) {
            ...
            if (msgDiv && msgDiv.style.visibility === "visible") msgDiv.style.visibility = "hidden";
                ...
                var json = { functionName: "HelpFindUI", invokeAsCommand: false, functionParams: { ID: "" } };
        ...
        function clickHandler(e) {
            ...
            var json = { functionName: "HelpFindUI", invokeAsCommand: false, functionParams: { ID: helpTopic, IsTopic: hasTopic } };
            var ret = exec(JSON.stringify(json));
            var retJson = JSON.parse(ret);
            if (retJson.error) showMessage(retJson.error, btn);
            e.stopPropagation();
            monitor(true);
        }
