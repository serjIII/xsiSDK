...
(function($, UTILS) {
    ...
    $.widget('adsk.appview', {
        ...
        _topicOriginalMarginLeft:           undefined,
        ...
        _toggleNavigationPane: function() {
            ...
            if (navigationPaneWidth > 0) {
                ...
                var newTopicMarginLeft = this._topicOriginalMarginLeft - navigationPaneWidth;

                // Resize panes.
                this._resizeSplitPanes(0, 0, 0, 0, newTopicMarginLeft);
                ...
                var newNavigationPaneWidth = this._navigationOpenedWidth,
                    newTopicMarginLeft = this._topicOriginalMarginLeft + newNavigationPaneWidth;

                this._resizeSplitPanes(0, 0, newNavigationPaneWidth, 0, newTopicMarginLeft);
            }
        },
        ...
        _splitterMouseDownHandler: function(event) {
            ...
            this._topicOriginalMarginLeft = parseInt(this._$topic.css('margin-left'), 10);
        ...
        _splitterMouseMoveHandler: function(event) {
            ...
            if (this._splitterTracking) {
                ...
                var topicWidth = this._$topic.width(),
                    ...
                    deltaX = event.clientX - this._splitterOriginalX,
                ...
                if ((deltaX < 0 && navigationWidth > this.options.minNavigationWidth) ||
                    ...
                    var newNavigationWidth = this._navigationOriginalWidth + deltaX,
                        newTopicMarginLeft = this._topicOriginalMarginLeft + deltaX,
                        newTopicWidth = this._topicOriginalWidth - deltaX;

                    this._resizeSplitPanes(minNavigationWidth, 0, newNavigationWidth, newTopicWidth, newTopicMarginLeft);

                }
            }
        },

        _resizeSplitPanes: function(minNavigationWidth, minTopicWidth, newNavigationWidth, newTopicWidth, newTopicMarginLeft) {
            if (newNavigationWidth < minNavigationWidth) {
                var delta = minNavigationWidth - newNavigationWidth;
                newNavigationWidth += delta;
                newTopicMarginLeft += delta;
            ...
            this._$topic.css('margin-left', newTopicMarginLeft + 'px');
        ...
        _renderHeader: function() {
            ...
            if (this.options.features.header) {
                return  '<div class="header">' +
                            '<div class="wrapper">' +
                                '<a class="title" href="#">' +
                                    '<img class="product-title" src="images/desktop-product-title.png"/>' +
