...
// Determine span class (whether it is tree leaf).
                ...
                this._html += ('<li>' +
                    '<span ' +
                        ...
                        this._createAttributeWithValue('data-tn', data[i].attr.tn) +
...
// Determine span class (whether it is tree leaf).
                    ...
                    this._html += ('<li>' +
                        '<span ' + this._createAttributeWithValue('class', nodeClass) + '>' +
                            booklist[i].data +
                        '</span>');
        ...
        _toggleTopicStyle: function (data) {
            ...
            if (this._$content != undefined) {
                var $treeElem = this._$content.find('span[data-href="'+ href +'"]');
        ...
        handlers: {
            click: function(event) {
                ...
                var $tocItem = $(event.target).closest('span');
