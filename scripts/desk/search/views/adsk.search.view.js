            ...
            var html =  '<div class="block-preloader hidden"/>' +
                        '<div class="content">' +
                            ...
                            '<div id="search-options" class="search-options closed">' + /* add\remove collapsed */
                                ...
                                '<label>' +
                                 '<input type="radio" name="search-method" value="or"/>' +
                                 caps.anyWord +
                                '</label>' +

                                '<label>' +
                                 '<input type="radio" name="search-method" value="and"/>' +
                                 caps.allWords +
                                '</label>' +

                                '<label>' +
                                 '<input type="radio" name="search-method" value="phrase"/>' +
                                 caps.phrase +
                                '</label>' +
                                ...
                                '<label>' +
                                 '<input type="checkbox" name="search-whole-words"/>' +
                                 caps.exactWords +
                                '</label>' +
