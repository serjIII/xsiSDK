...
<html>\n\
   <head><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>CShape::ParameterReference Struct Reference</title>\n\
   \n\
</head>\n\
...
complete: function() {\n\
  ...
  dQuery(document).ready( function () {\n\
    setTimeout( function () {\n\
      initResizable();\n\
      initNavTree(\'structXSI_1_1MATH_1_1CShape_1_1ParameterReference.html\', prefix);\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>CShape::ParameterReference Struct Reference</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">CShape::ParameterReference Struct Reference</div>  </div>\n\
</div><!--header-->\n\
...
<div class=\"textblock\"><p>A struct to hold the parameters for a shape reference. </p>\n\
