...
<html>\n\
   <head><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>StaticSource Class Reference</title>\n\
   \n\
</head>\n\
...
complete: function() {\n\
  ...
  dQuery(document).ready( function () {\n\
    setTimeout( function () {\n\
      initResizable();\n\
      initNavTree(\'classXSI_1_1StaticSource.html\', prefix);\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>StaticSource Class Reference</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">StaticSource Class Reference</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
\n\
<p><code>#include &lt;<a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/xsi__staticsource_8h_source.html\">xsi_staticsource.h</a>&gt;</code></p>\n\
<a name=\"details\" id=\"details\"></a><h2 class=\"groupheader\">Class Description</h2>\n\
<div class=\"textblock\"><p>The <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\" title=\"The StaticSource object represents a constant value stored as an AnimationSourceItem. When instantiated, the parameter value takes on the value of the StaticSource. A static pose is a kind of a StaticSource. \">StaticSource</a> object represents a constant value stored as an <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1AnimationSourceItem.html\" title=\"An ActionSource contains a collection of animation source items, which you can get at using ActionSou...\">AnimationSourceItem</a>. When instantiated, the parameter value takes on the value of the <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\" title=\"The StaticSource object represents a constant value stored as an AnimationSourceItem. When instantiated, the parameter value takes on the value of the StaticSource. A static pose is a kind of a StaticSource. \">StaticSource</a>. A static pose is a kind of a <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\" title=\"The StaticSource object represents a constant value stored as an AnimationSourceItem. When instantiated, the parameter value takes on the value of the StaticSource. A static pose is a kind of a StaticSource. \">StaticSource</a>. </p>\n\
<p>This object can be one of the <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1AnimationSourceItem.html\" title=\"An ActionSource contains a collection of animation source items, which you can get at using ActionSou...\">AnimationSourceItem</a> objects in an <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1ActionSource.html\" title=\"The ActionSource class is a specialization of the Source class, representing sources for action and s...\">ActionSource</a>.</p>\n\
<dl class=\"section see\"><dt>See Also</dt><dd><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1AnimationSourceItem.html#a4120d0f5a8c5296445162539bb64fee8\">AnimationSourceItem::GetSource</a>, <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1AnimationSourceItem.html#ac8561e3fd4f90f909795151c0baedee5\">AnimationSourceItem::SetAsStatic</a>, <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1ActionSource.html#a2eeb928209f362fb9016d060907701e7\">ActionSource::AddSourceItem</a> </dd></dl>\n\
<dl class=\"section since\"><dt>Since</dt><dd>4.0</dd></dl>\n\
<dl class=\"section user\"><dt>Example:</dt><dd>This example illustrates creating a source and accessing the source items contained in it.</dd></dl>\n\
...
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1AnimationSourceItem.html\">AnimationSourceItem</a> currItem(aSourceItems[i]);</div>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\">    <span class=\"comment\">// In this case it&#39;s a static value you can switch on type.</span></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\">StaticSource</a> myVal = currItem.GetSource();</div>\n\
<div class=\"line\">    app.<a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1Application.html#a9b269de260f6a9fca710d9b9003bd1a3\">LogMessage</a>( L<span class=\"stringliteral\">&quot; The value is &quot;</span> + myVal.<a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html#a9046261c28c2fdde820f8e6eaf07ba6c\">GetValue</a>().<a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CValue.html#aa6bc9a7b39751a8415262efb422a87b3\">GetAsText</a>() );</div>\n\
<div class=\"line\">}</div>\n\
</div><!-- fragment --> </div><div id=\"dynsection-0\" onclick=\"return toggleVisibility(this)\" class=\"dynheader closed\" style=\"cursor:pointer;\">\n\
  <img id=\"dynsection-0-trigger\" src=\"closed.png\" alt=\"+\"> Inheritance diagram for StaticSource:</div>\n\
<div id=\"dynsection-0-summary\" class=\"dynsummary\" style=\"display:block;\">\n\
</div>\n\
<div id=\"dynsection-0-content\" class=\"dyncontent\" style=\"display:none;\">\n\
 <div class=\"center\">\n\
  <img src=\"classXSI_1_1StaticSource.png\" usemap=\"#StaticSource_map\" alt=\"\">\n\
  <map id=\"StaticSource_map\" name=\"StaticSource_map\">\n\
...
<tr class=\"memitem:acd97a765b309a314a1b8f9b2aff6078c\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html#acd97a765b309a314a1b8f9b2aff6078c\">StaticSource</a> ()</td></tr>\n\
<tr class=\"separator:acd97a765b309a314a1b8f9b2aff6078c\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a9da6b76f3f729a33a3e686ec28f8bbdc\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html#a9da6b76f3f729a33a3e686ec28f8bbdc\">~StaticSource</a> ()</td></tr>\n\
<tr class=\"separator:a9da6b76f3f729a33a3e686ec28f8bbdc\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a19bba759fb8e2f82fc0126a454923347\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html#a19bba759fb8e2f82fc0126a454923347\">StaticSource</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CRef.html\">CRef</a> &amp;in_ref)</td></tr>\n\
<tr class=\"separator:a19bba759fb8e2f82fc0126a454923347\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:acae003db4b960921f5cfed6845f5df99\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html#acae003db4b960921f5cfed6845f5df99\">StaticSource</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\">StaticSource</a> &amp;in_obj)</td></tr>\n\
<tr class=\"separator:acae003db4b960921f5cfed6845f5df99\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a6dd5a8a11eee55f434f151d1cd5d29d8\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">bool&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html#a6dd5a8a11eee55f434f151d1cd5d29d8\">IsA</a> (<a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/namespaceXSI.html#ad483c77b3d997caca1f369db99c1e68b\">siClassID</a> in_ClassID) const </td></tr>\n\
<tr class=\"separator:a6dd5a8a11eee55f434f151d1cd5d29d8\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:acc34f4a01f2089e40f7abc7e9d98bf15\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/namespaceXSI.html#ad483c77b3d997caca1f369db99c1e68b\">siClassID</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html#acc34f4a01f2089e40f7abc7e9d98bf15\">GetClassID</a> () const </td></tr>\n\
<tr class=\"separator:acc34f4a01f2089e40f7abc7e9d98bf15\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:ad2a219a0c94e37a1b2b8000f916cdcd0\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\">StaticSource</a> &amp;&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html#ad2a219a0c94e37a1b2b8000f916cdcd0\">operator=</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\">StaticSource</a> &amp;in_obj)</td></tr>\n\
<tr class=\"separator:ad2a219a0c94e37a1b2b8000f916cdcd0\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a88bd2eb003147ad7ab956376cd6f3f88\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\">StaticSource</a> &amp;&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html#a88bd2eb003147ad7ab956376cd6f3f88\">operator=</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CRef.html\">CRef</a> &amp;in_ref)</td></tr>\n\
<tr class=\"separator:a88bd2eb003147ad7ab956376cd6f3f88\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
...
<tr class=\"memitem:af8fd29808f64888aafdef57aa7d81961\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CStatus.html\">CStatus</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html#af8fd29808f64888aafdef57aa7d81961\">PutValue</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CValue.html\">CValue</a> &amp;in_val)</td></tr>\n\
<tr class=\"separator:af8fd29808f64888aafdef57aa7d81961\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
...
<a class=\"anchor\" id=\"acd97a765b309a314a1b8f9b2aff6078c\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
          <td class=\"memname\" translate=\"no\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\">StaticSource</a> </td>\n\
          <td>(</td>\n\
...
<a class=\"anchor\" id=\"a9da6b76f3f729a33a3e686ec28f8bbdc\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<a class=\"anchor\" id=\"a19bba759fb8e2f82fc0126a454923347\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<a class=\"anchor\" id=\"acae003db4b960921f5cfed6845f5df99\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
          <td class=\"memname\" translate=\"no\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\">StaticSource</a> </td>\n\
          <td>(</td>\n\
          <td class=\"paramtype\">const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\">StaticSource</a> &amp;&#160;</td>\n\
...
<a class=\"anchor\" id=\"ad2a219a0c94e37a1b2b8000f916cdcd0\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
          <td class=\"memname\" translate=\"no\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\">StaticSource</a>&amp; operator= </td>\n\
          <td>(</td>\n\
          <td class=\"paramtype\">const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\">StaticSource</a> &amp;&#160;</td>\n\
          <td class=\"paramname\"><em>in_obj</em></td><td>)</td>\n\
          <td></td>\n\
...
<dl class=\"section return\"><dt>Returns</dt><dd>The new <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1StaticSource.html\" title=\"The StaticSource object represents a constant value stored as an AnimationSourceItem. When instantiated, the parameter value takes on the value of the StaticSource. A static pose is a kind of a StaticSource. \">StaticSource</a> object. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
<a class=\"anchor\" id=\"a88bd2eb003147ad7ab956376cd6f3f88\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<p>Returns a value which is used as a constant value for the corresponding <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1AnimationSourceItem.html\" title=\"An ActionSource contains a collection of animation source items, which you can get at using ActionSou...\">AnimationSourceItem</a>. </p>\n\
<dl class=\"section return\"><dt>Returns</dt><dd>Constant value for an animation source. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
<a class=\"anchor\" id=\"af8fd29808f64888aafdef57aa7d81961\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<p>Sets a value which is used as a constant value for the corresponding <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1AnimationSourceItem.html\" title=\"An ActionSource contains a collection of animation source items, which you can get at using ActionSou...\">AnimationSourceItem</a>. </p>\n\
<dl class=\"params\"><dt>Parameters</dt><dd>\n\
  <table class=\"params\">\n\
    <tr><td class=\"paramname\">in_val</td><td>New value for this animation SourceItem. </td></tr>\n\
  </table>\n\
  </dd>\n\
</dl>\n\
...
<li><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/xsi__staticsource_8h_source.html\">xsi_staticsource.h</a></li>\n\
</ul>\n\
</div><!-- contents -->\n\
</div><!-- doc-content -->\n\
