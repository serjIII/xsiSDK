...
<html>\n\
   <head><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>xsi_ppglayout.h File Reference</title>\n\
   \n\
</head>\n\
...
complete: function() {\n\
  ...
  dQuery(document).ready( function () {\n\
    setTimeout( function () {\n\
      initResizable();\n\
      initNavTree(\'xsi__ppglayout_8h.html\', prefix);\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>xsi_ppglayout.h File Reference</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">xsi_ppglayout.h File Reference</div>  </div>\n\
</div><!--header-->\n\
...
<div class=\"textblock\"><p>PPGLayout class declaration. </p>\n\
...
Classes</h2></td></tr>\n\
<tr class=\"memitem:\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">class &#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1PPGLayout.html\">PPGLayout</a></td></tr>\n\
<tr class=\"memdesc:\"><td class=\"mdescLeft\">&#160;</td><td class=\"mdescRight\">The PPGLayout object represents the visual appearance of an object\'s state when it is inspected. (<code>PPG</code> is a common acronym for Property Page). The layout makes it possible to group objects together, use special controls, hide obsolete parameters, add Buttons and in general create a presentation of an object\'s state that is pleasing to the eye.  <a href=\"#!/url=./si_cpp/classXSI_1_1PPGLayout.html#details\">More...</a><br></td></tr>\n\
...
\n\
<p><a href=\"#!/url=./si_cpp/xsi__ppglayout_8h_source.html\">Go to the source code of this file.</a></p>\n\
</div><!-- contents -->\n\
</div><!-- doc-content -->\n\
