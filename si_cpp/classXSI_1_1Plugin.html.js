...
complete: function() {\n\
  ...
  dQuery(document).ready( function () {\n\
    setTimeout( function () {\n\
      initResizable();\n\
      initNavTree(\'classXSI_1_1Plugin.html\', prefix);\n\
...
<div class=\"title\">Plugin Class Reference</div>  </div>\n\
</div><!--header-->\n\
...
\n\
<p><code>#include &lt;<a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/xsi__pluginitem_8h_source.html\">xsi_pluginitem.h</a>&gt;</code></p>\n\
<a name=\"details\" id=\"details\"></a><h2 class=\"groupheader\">Class Description</h2>\n\
<div class=\"textblock\"><p>A <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\" title=\"A Plugin object holds read-only information on a particular plug-in file registered in Softimage...\">Plugin</a> object holds read-only information on a particular plug-in file registered in Softimage. </p>\n\
<p>Plug-in objects are filled in with the <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1PluginRegistrar.html\" title=\"This class provides functions for registering a PluginItem in Softimage. \">PluginRegistrar</a> object at startup and can be accessed with the <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Application.html#aaa3854e073cf463152aa8b3780d41452\">Application::GetPlugins</a> property.</p>\n\
<dl class=\"section since\"><dt>Since</dt><dd>4.0</dd></dl>\n\
<dl class=\"section user\"><dt>Example:</dt><dd>Shows how to access information about the plug-ins that are currently registered in Softimage</dd></dl>\n\
...
<div class=\"line\"></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CRefArray.html\">CRefArray</a> pluginArray = app.GetPlugins();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"keywordflow\">for</span> (LONG i=0; i&lt;pluginArray.GetCount(); i++)</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\">Plugin</a> plugin(pluginArray[i]);</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;***&quot;</span> + plugin.GetName() + L<span class=\"stringliteral\">&quot;***&quot;</span> );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    LONG minor, major;</div>\n\
<div class=\"line\">    plugin.GetVersion( major, minor );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;version: &quot;</span> +</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CValue.html\">CValue</a>((LONG)major).GetAsText() + L<span class=\"stringliteral\">&quot;:&quot;</span> +</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CValue.html\">CValue</a>((LONG)minor).GetAsText() );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;author: &quot;</span> + plugin.GetAuthor() );</div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;language: &quot;</span> + plugin.GetLanguage() );</div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;file name: &quot;</span> + plugin.GetFilename() );</div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;url: &quot;</span> + plugin.GetURL() );</div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;email: &quot;</span> + plugin.GetEmail() );</div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;help: &quot;</span> + plugin.GetHelp() );</div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;help button: &quot;</span> + plugin.GetHelpButton() );</div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;origin: &quot;</span> + <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CValue.html\">CValue</a>((LONG)plugin.GetOrigin()).GetAsText() );</div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;origin path: &quot;</span> + plugin.GetOriginPath() );</div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;loaded: &quot;</span> + <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CValue.html\">CValue</a>(plugin.IsLoaded()).GetAsText() );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CString.html\">CString</a> strCat;</div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CStringArray.html\">CStringArray</a> strArray = plugin.GetCategories();</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span> (LONG j=0; j&lt;strArray.<a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CStringArray.html#a845aa1e5063b24aedec1a99da2d8a4f3\">GetCount</a>(); j++)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        strCat += strArray[j]; strCat += L<span class=\"stringliteral\">&quot;,&quot;</span>;</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">    app.LogMessage( L<span class=\"stringliteral\">&quot;category: &quot;</span> + strCat );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CRefArray.html\">CRefArray</a> itemArray = plugin.GetItems();</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">for</span> (LONG j=0; j&lt;itemArray.<a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CRefArray.html#a922e4c0f3b9c356806a07bd1f1b34736\">GetCount</a>(); j++)</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1PluginItem.html\">PluginItem</a> pluginItem(itemArray[j]);</div>\n\
<div class=\"line\">        app.LogMessage( L<span class=\"stringliteral\">&quot;*** item name: &quot;</span> + pluginItem.GetName() );</div>\n\
<div class=\"line\">        app.LogMessage( L<span class=\"stringliteral\">&quot;    item type: &quot;</span> + pluginItem.GetType() );</div>\n\
<div class=\"line\">        app.LogMessage( L<span class=\"stringliteral\">&quot;    item help: &quot;</span> + pluginItem.GetHelp() );</div>\n\
<div class=\"line\">        app.LogMessage( L<span class=\"stringliteral\">&quot;    item help button: &quot;</span> + pluginItem.GetHelpButton() );</div>\n\
<div class=\"line\">        app.LogMessage( L<span class=\"stringliteral\">&quot;    item origin: &quot;</span> + <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CValue.html\">CValue</a>((LONG)pluginItem.GetOrigin()).GetAsText() );</div>\n\
<div class=\"line\">        app.LogMessage( L<span class=\"stringliteral\">&quot;    item origin path: &quot;</span> + pluginItem.GetOriginPath() );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">        <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CStringArray.html\">CStringArray</a> strArray = pluginItem.GetCategories();</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">for</span> (LONG j=0; j&lt;strArray.<a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CStringArray.html#a845aa1e5063b24aedec1a99da2d8a4f3\">GetCount</a>(); j++)</div>\n\
<div class=\"line\">        {</div>\n\
<div class=\"line\">            strCat += strArray[j]; strCat += L<span class=\"stringliteral\">&quot;,&quot;</span>;</div>\n\
<div class=\"line\">        }</div>\n\
<div class=\"line\">        app.LogMessage( L<span class=\"stringliteral\">&quot;    item category: &quot;</span> + strCat );</div>\n\
<div class=\"line\">    }</div>\n\
<div class=\"line\">}</div>\n\
</div><!-- fragment --> </div><div id=\"dynsection-0\" onclick=\"return toggleVisibility(this)\" class=\"dynheader closed\" style=\"cursor:pointer;\">\n\
  <img id=\"dynsection-0-trigger\" src=\"closed.png\" alt=\"+\"> Inheritance diagram for Plugin:</div>\n\
<div id=\"dynsection-0-summary\" class=\"dynsummary\" style=\"display:block;\">\n\
</div>\n\
<div id=\"dynsection-0-content\" class=\"dyncontent\" style=\"display:none;\">\n\
 <div class=\"center\">\n\
  <img src=\"classXSI_1_1Plugin.png\" usemap=\"#Plugin_map\" alt=\"\">\n\
  <map id=\"Plugin_map\" name=\"Plugin_map\">\n\
...
<tr class=\"memitem:ac6f2688af203e5a5aa47ec9cea5fb6f2\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#ac6f2688af203e5a5aa47ec9cea5fb6f2\">Plugin</a> ()</td></tr>\n\
<tr class=\"separator:ac6f2688af203e5a5aa47ec9cea5fb6f2\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:ab266c54e71d23d8527e233e4e964680c\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#ab266c54e71d23d8527e233e4e964680c\">~Plugin</a> ()</td></tr>\n\
<tr class=\"separator:ab266c54e71d23d8527e233e4e964680c\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a8f3ff570223742938f05e93ba72e3432\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a8f3ff570223742938f05e93ba72e3432\">Plugin</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CRef.html\">CRef</a> &amp;in_ref)</td></tr>\n\
<tr class=\"separator:a8f3ff570223742938f05e93ba72e3432\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a8a0cce50b5f59953903b51cb7304b59e\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a8a0cce50b5f59953903b51cb7304b59e\">Plugin</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\">Plugin</a> &amp;in_obj)</td></tr>\n\
<tr class=\"separator:a8a0cce50b5f59953903b51cb7304b59e\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a6dd5a8a11eee55f434f151d1cd5d29d8\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">bool&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a6dd5a8a11eee55f434f151d1cd5d29d8\">IsA</a> (<a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/namespaceXSI.html#ad483c77b3d997caca1f369db99c1e68b\">siClassID</a> in_ClassID) const </td></tr>\n\
<tr class=\"separator:a6dd5a8a11eee55f434f151d1cd5d29d8\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:acc34f4a01f2089e40f7abc7e9d98bf15\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/namespaceXSI.html#ad483c77b3d997caca1f369db99c1e68b\">siClassID</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#acc34f4a01f2089e40f7abc7e9d98bf15\">GetClassID</a> () const </td></tr>\n\
<tr class=\"separator:acc34f4a01f2089e40f7abc7e9d98bf15\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a916bc09cd2f77b492f2c249297c1c447\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\">Plugin</a> &amp;&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a916bc09cd2f77b492f2c249297c1c447\">operator=</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\">Plugin</a> &amp;in_obj)</td></tr>\n\
<tr class=\"separator:a916bc09cd2f77b492f2c249297c1c447\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a25a6b2db2b8a3fc4d37d3bfde0aa4241\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\">Plugin</a> &amp;&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a25a6b2db2b8a3fc4d37d3bfde0aa4241\">operator=</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CRef.html\">CRef</a> &amp;in_ref)</td></tr>\n\
<tr class=\"separator:a25a6b2db2b8a3fc4d37d3bfde0aa4241\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:af34da75aa522dd3e9caa487c0915924b\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CString.html\">CString</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#af34da75aa522dd3e9caa487c0915924b\">GetAuthor</a> () const </td></tr>\n\
<tr class=\"separator:af34da75aa522dd3e9caa487c0915924b\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:ab4744f8a323d98e9a291276400abd5c0\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CString.html\">CString</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#ab4744f8a323d98e9a291276400abd5c0\">GetURL</a> () const </td></tr>\n\
<tr class=\"separator:ab4744f8a323d98e9a291276400abd5c0\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a04c64f73235695f54afcaec05bb7fd08\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CString.html\">CString</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a04c64f73235695f54afcaec05bb7fd08\">GetEmail</a> () const </td></tr>\n\
<tr class=\"separator:a04c64f73235695f54afcaec05bb7fd08\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a3cee3b0e21183e2805befba15e0e9c15\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CStatus.html\">CStatus</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a3cee3b0e21183e2805befba15e0e9c15\">GetVersion</a> (LONG &amp;out_major, LONG &amp;out_minor) const </td></tr>\n\
<tr class=\"separator:a3cee3b0e21183e2805befba15e0e9c15\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:ac3fbd0d75fed06893afdfc8799ec263c\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CString.html\">CString</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#ac3fbd0d75fed06893afdfc8799ec263c\">GetLanguage</a> () const </td></tr>\n\
<tr class=\"separator:ac3fbd0d75fed06893afdfc8799ec263c\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a478b6380749dba61a4161116d90143fd\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CString.html\">CString</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a478b6380749dba61a4161116d90143fd\">GetFilename</a> () const </td></tr>\n\
<tr class=\"separator:a478b6380749dba61a4161116d90143fd\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:ac03e187fa46a223517e94ebd426fcfaa\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">bool&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#ac03e187fa46a223517e94ebd426fcfaa\">IsLoaded</a> () const </td></tr>\n\
<tr class=\"separator:ac03e187fa46a223517e94ebd426fcfaa\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a964400efa039786d6a4fc6ca3d76a5c5\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CRefArray.html\">CRefArray</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a964400efa039786d6a4fc6ca3d76a5c5\">GetItems</a> () const </td></tr>\n\
<tr class=\"separator:a964400efa039786d6a4fc6ca3d76a5c5\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a70bc1b65f444a8f8886e95a03c6b56f0\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CStatus.html\">CStatus</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a70bc1b65f444a8f8886e95a03c6b56f0\">PutUserData</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CValue.html\">CValue</a> &amp;in_val)</td></tr>\n\
<tr class=\"separator:a70bc1b65f444a8f8886e95a03c6b56f0\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a75f393786b96b669f0b7959e06733178\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CValue.html\">CValue</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a75f393786b96b669f0b7959e06733178\">GetUserData</a> () const </td></tr>\n\
<tr class=\"separator:a75f393786b96b669f0b7959e06733178\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a958079eebaec1095b00a6e635f8471a3\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CString.html\">CString</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html#a958079eebaec1095b00a6e635f8471a3\">GetHelpButton</a> () const </td></tr>\n\
...
<a class=\"anchor\" id=\"ac6f2688af203e5a5aa47ec9cea5fb6f2\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
          <td class=\"memname\" translate=\"no\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\">Plugin</a> </td>\n\
          <td>(</td>\n\
...
<a class=\"anchor\" id=\"ab266c54e71d23d8527e233e4e964680c\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<a class=\"anchor\" id=\"a8f3ff570223742938f05e93ba72e3432\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<a class=\"anchor\" id=\"a8a0cce50b5f59953903b51cb7304b59e\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
          <td class=\"memname\" translate=\"no\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\">Plugin</a> </td>\n\
          <td>(</td>\n\
          <td class=\"paramtype\">const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\">Plugin</a> &amp;&#160;</td>\n\
...
<a class=\"anchor\" id=\"a916bc09cd2f77b492f2c249297c1c447\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
          <td class=\"memname\" translate=\"no\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\">Plugin</a>&amp; operator= </td>\n\
          <td>(</td>\n\
          <td class=\"paramtype\">const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\">Plugin</a> &amp;&#160;</td>\n\
          <td class=\"paramname\"><em>in_obj</em></td><td>)</td>\n\
          <td></td>\n\
...
<dl class=\"section return\"><dt>Returns</dt><dd>The new <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\" title=\"A Plugin object holds read-only information on a particular plug-in file registered in Softimage...\">Plugin</a> object. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
<a class=\"anchor\" id=\"a25a6b2db2b8a3fc4d37d3bfde0aa4241\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<p>Returns the name of the plug-in\'s author. </p>\n\
<dl class=\"section return\"><dt>Returns</dt><dd>The name of the plug-in\'s author </dd></dl>\n\
\n\
</div>\n\
</div>\n\
...
<dl class=\"section return\"><dt>Returns</dt><dd>The URL path. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
...
<dl class=\"section return\"><dt>Returns</dt><dd>The email address. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
...
<dl class=\"section return\"><dt>Returns</dt><dd>The name of the implementation language. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
...
<dl class=\"section return\"><dt>Returns</dt><dd>The filename of the plug-in. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
<a class=\"anchor\" id=\"ac03e187fa46a223517e94ebd426fcfaa\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<p>Returns true if the plug-in is currently loaded in the application. </p>\n\
<dl class=\"section return\"><dt>Returns</dt><dd>true if the plug-in is currently loaded </dd></dl>\n\
\n\
</div>\n\
</div>\n\
...
<p>Returns a <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CRefArray.html\" title=\"The CRefArray class holds generic CRef objects and acts as a base class for other specialized CRef ar...\">CRefArray</a> object containing the plug-in items (<a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1PluginItem.html\" title=\"The PluginItem class contains the information on each item of a plug-in. \">PluginItem</a>) registered by this plug-in. A single <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Plugin.html\" title=\"A Plugin object holds read-only information on a particular plug-in file registered in Softimage...\">Plugin</a> object can contain multiple customizable items, such as custom menus, operators and filters. </p>\n\
<dl class=\"section return\"><dt>Returns</dt><dd>Array of <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1PluginItem.html\" title=\"The PluginItem class contains the information on each item of a plug-in. \">PluginItem</a> objects. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
...
<p>Stores a <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CValue.html\" title=\"The CValue object provides the convenience of a loosely typed variable inside a strictly typed langua...\">CValue</a> inside the plug-in object. Softimage does not care about the content or meaning of the data. Once created, the data remains active as long as Softimage is running or until you manually unload the plug-in.</p>\n\
<p>You can use this to store a value to be accessed locally in the plug-in implementation or accessed globally by other plug-ins. The user data is not persisted.</p>\n\
...
<dl class=\"params\"><dt>Parameters</dt><dd>\n\
  <table class=\"params\">\n\
    <tr><td class=\"paramname\">in_val</td><td>User data to set. </td></tr>\n\
  </table>\n\
  </dd>\n\
</dl>\n\
...
<dl class=\"section see\"><dt>See Also</dt><dd><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Application.html#a32b516600876cef56562552ad1280779\">Application::UnloadPlugin</a> </dd></dl>\n\
...
<p>Returns the user data stored in the plug-in. </p>\n\
...
<p>Returns the help button file replacing the factory \"?\" button in the property pages of the plug-in items of this plug-in.</p>\n\
<p>Note: A plug-in item can override the default help button file specified by the plug-in.</p>\n\
...
<li><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/xsi__plugin_8h_source.html\">xsi_plugin.h</a></li>\n\
</ul>\n\
</div><!-- contents -->\n\
</div><!-- doc-content -->\n\
