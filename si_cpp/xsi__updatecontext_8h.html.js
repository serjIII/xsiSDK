...
<html>\n\
   <head><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>xsi_updatecontext.h File Reference</title>\n\
   \n\
</head>\n\
...
complete: function() {\n\
  ...
  dQuery(document).ready( function () {\n\
    setTimeout( function () {\n\
      initResizable();\n\
      initNavTree(\'xsi__updatecontext_8h.html\', prefix);\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>xsi_updatecontext.h File Reference</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">xsi_updatecontext.h File Reference</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
...
<div class=\"textblock\"><p>UpdateContext class declaration. </p>\n\
...
Classes</h2></td></tr>\n\
<tr class=\"memitem:\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">class &#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1UpdateContext.html\">UpdateContext</a></td></tr>\n\
<tr class=\"memdesc:\"><td class=\"mdescLeft\">&#160;</td><td class=\"mdescRight\">This object represents the operator update context. It gives access to the operator and the evaluation time. The <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1UpdateContext.html\" title=\"This object represents the operator update context. It gives access to the operator and the evaluatio...\">UpdateContext</a> is only valid within the context of the Update() function for operators that are based on a Preset and SPDL. Self-Installed CustomOperators use the <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1OperatorContext.html\" title=\"This class is provided as the context object in the Operator update callback for a Self-Installed Cus...\">OperatorContext</a> object instead.  <a href=\"#!/url=./si_cpp/classXSI_1_1UpdateContext.html#details\">More...</a><br></td></tr>\n\
...
\n\
<p><a href=\"#!/url=./si_cpp/xsi__updatecontext_8h_source.html\">Go to the source code of this file.</a></p>\n\
</div><!-- contents -->\n\
</div><!-- doc-content -->\n\
