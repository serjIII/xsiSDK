...
<html>\n\
   <head><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>MemoCamera Class Reference</title>\n\
   \n\
</head>\n\
...
complete: function() {\n\
  ...
  dQuery(document).ready( function () {\n\
    setTimeout( function () {\n\
      initResizable();\n\
      initNavTree(\'classXSI_1_1MemoCamera.html\', prefix);\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>MemoCamera Class Reference</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">MemoCamera Class Reference</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
\n\
<p><code>#include &lt;<a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/xsi__memocamera_8h_source.html\">xsi_memocamera.h</a>&gt;</code></p>\n\
<a name=\"details\" id=\"details\"></a><h2 class=\"groupheader\">Class Description</h2>\n\
<div class=\"textblock\"><p>The <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\" title=\"The MemoCamera class represents a memo camera control in a view. \">MemoCamera</a> class represents a memo camera control in a view. </p>\n\
<dl class=\"section see\"><dt>See Also</dt><dd><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\" title=\"The MemoCamera class represents a memo camera control in a view. \">MemoCamera</a> </dd></dl>\n\
<dl class=\"section since\"><dt>Since</dt><dd>10.5 (2012)</dd></dl>\n\
<dl class=\"section user\"><dt>Example:</dt><dd>Demonstrates how to record the 4 memo cameras in the perspective view. <div class=\"fragment\"><div class=\"line\"><span class=\"keyword\">using namespace </span>XSI;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1Application.html\">Application</a> app;</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">// Get the View Manager</span></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1View.html\">View</a> vm = app.GetDesktop().GetActiveLayout().<a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1View.html#a1367acad67c9f3df9b9928827c073e92\">GetViews</a>().<a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CRefArray.html#a52d3e64b2147598316a824665e587f85\">GetItem</a>( <span class=\"stringliteral\">&quot;vm&quot;</span> );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">// Get view B (perspective)</span></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1View.html\">View</a> viewB = vm.<a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1View.html#a1367acad67c9f3df9b9928827c073e92\">GetViews</a>()[ 1 ];</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">// Get memocams for view B</span></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CRefArray.html\">CRefArray</a> memoCameras = viewB.GetMemoCameras();</div>\n\
<div class=\"line\">app.LogMessage( <span class=\"stringliteral\">&quot;Memo camera count for view B: &quot;</span> +  <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1CString.html\">CString</a>( memoCameras.GetCount() ) );</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">// Get View B&#39;s camera object</span></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1Camera.html\">Camera</a> camB = app.GetActiveSceneRoot().FindObjects( <a class=\"code\" href=\"#!/url=./si_cpp/namespaceXSI.html#ad483c77b3d997caca1f369db99c1e68bacf1b08f12221152f31132079e4bd67e1\">XSI::siCameraID</a> )[ 0 ];</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">// Get the camera global KinematicState</span></div>\n\
<div class=\"line\"><a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1KinematicState.html\">KinematicState</a> kinestate = camB.GetKinematics().GetGlobal();</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\"><span class=\"comment\">// Record 4 memo cameras in view B</span></div>\n\
<div class=\"line\"><span class=\"keywordflow\">for</span> ( <span class=\"keywordtype\">int</span> index = 0; index &lt; 4; index++ )</div>\n\
<div class=\"line\">{</div>\n\
<div class=\"line\">    <span class=\"keywordflow\">switch</span>( index )</div>\n\
<div class=\"line\">    {</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">case</span> 0:</div>\n\
<div class=\"line\">            kinestate.<a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1Parameter.html#a23d5cca19145f749c6863cce9fffabf1\">PutParameterValue</a>( <span class=\"stringliteral\">&quot;posx&quot;</span>, -10.0 );</div>\n\
<div class=\"line\">            kinestate.PutParameterValue( <span class=\"stringliteral\">&quot;posy&quot;</span>, 2.0 );</div>\n\
<div class=\"line\">            kinestate.PutParameterValue( <span class=\"stringliteral\">&quot;posz&quot;</span>, 20.0 );</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">break</span>;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">case</span> 1:</div>\n\
<div class=\"line\">            kinestate.PutParameterValue( <span class=\"stringliteral\">&quot;posx&quot;</span>, 0.0 );</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">break</span>;</div>\n\
<div class=\"line\">        <span class=\"keywordflow\">case</span> 2:</div>\n\
<div class=\"line\">            kinestate.PutParameterValue( <span class=\"stringliteral\">&quot;posx&quot;</span>, 10.0 );</div>\n\
<div class=\"line\">            <span class=\"keywordflow\">break</span>;</div>\n\
...
<div class=\"line\">    }</div>\n\
<div class=\"line\"></div>\n\
<div class=\"line\">    <a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\">MemoCamera</a> memoCamera = memoCameras[ index] ;</div>\n\
<div class=\"line\">    memoCamera.<a class=\"code\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#a326a701ed21e69d62358bb0ce12b782a\">Record</a>();</div>\n\
<div class=\"line\">}</div>\n\
</div><!-- fragment --> </dd></dl>\n\
</div><div id=\"dynsection-0\" onclick=\"return toggleVisibility(this)\" class=\"dynheader closed\" style=\"cursor:pointer;\">\n\
  <img id=\"dynsection-0-trigger\" src=\"closed.png\" alt=\"+\"> Inheritance diagram for MemoCamera:</div>\n\
<div id=\"dynsection-0-summary\" class=\"dynsummary\" style=\"display:block;\">\n\
</div>\n\
<div id=\"dynsection-0-content\" class=\"dyncontent\" style=\"display:none;\">\n\
 <div class=\"center\">\n\
  <img src=\"classXSI_1_1MemoCamera.png\" usemap=\"#MemoCamera_map\" alt=\"\">\n\
  <map id=\"MemoCamera_map\" name=\"MemoCamera_map\">\n\
<area href=\"classXSI_1_1UIObject.html\" title=\"The UIObject is the base class for Softimage UI objects such as UIPersistable and MenuItem...\" alt=\"UIObject\" shape=\"rect\" coords=\"0,112,90,136\">\n\
<area href=\"classXSI_1_1SIObject.html\" title=\"SIObject derives from CBase and acts as the base class for the Softimage Object Model library...\" alt=\"SIObject\" shape=\"rect\" coords=\"0,56,90,80\">\n\
<area href=\"classXSI_1_1CBase.html\" title=\"CBase is the base class of all API classes and provides access to Softimage objects through generic C...\" alt=\"CBase\" shape=\"rect\" coords=\"0,0,90,24\">\n\
</map>\n\
 </div></div>\n\
<table class=\"memberdecls\">\n\
<tr class=\"heading\"><td colspan=\"2\"><h2 class=\"groupheader\"><a name=\"pub-methods\"></a>\n\
Public Member Functions</h2></td></tr>\n\
<tr class=\"memitem:a177b75ffeb4913b0f9429d0a7e185d59\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#a177b75ffeb4913b0f9429d0a7e185d59\">MemoCamera</a> ()</td></tr>\n\
<tr class=\"separator:a177b75ffeb4913b0f9429d0a7e185d59\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a6fe588789b89ca01992583d11a391b3e\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#a6fe588789b89ca01992583d11a391b3e\">~MemoCamera</a> ()</td></tr>\n\
<tr class=\"separator:a6fe588789b89ca01992583d11a391b3e\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a85f367517aaa12bba7e81fe2b0f75fec\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#a85f367517aaa12bba7e81fe2b0f75fec\">MemoCamera</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CRef.html\">CRef</a> &amp;in_ref)</td></tr>\n\
<tr class=\"separator:a85f367517aaa12bba7e81fe2b0f75fec\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a4ef9892a8cbcd98bd964e192f5814e59\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#a4ef9892a8cbcd98bd964e192f5814e59\">MemoCamera</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\">MemoCamera</a> &amp;in_obj)</td></tr>\n\
<tr class=\"separator:a4ef9892a8cbcd98bd964e192f5814e59\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a6dd5a8a11eee55f434f151d1cd5d29d8\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">bool&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#a6dd5a8a11eee55f434f151d1cd5d29d8\">IsA</a> (<a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/namespaceXSI.html#ad483c77b3d997caca1f369db99c1e68b\">siClassID</a> in_ClassID) const </td></tr>\n\
<tr class=\"separator:a6dd5a8a11eee55f434f151d1cd5d29d8\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:acc34f4a01f2089e40f7abc7e9d98bf15\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/namespaceXSI.html#ad483c77b3d997caca1f369db99c1e68b\">siClassID</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#acc34f4a01f2089e40f7abc7e9d98bf15\">GetClassID</a> () const </td></tr>\n\
<tr class=\"separator:acc34f4a01f2089e40f7abc7e9d98bf15\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a18901c6d375d0f1261afa5b81e379ebf\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\">MemoCamera</a> &amp;&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#a18901c6d375d0f1261afa5b81e379ebf\">operator=</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\">MemoCamera</a> &amp;in_obj)</td></tr>\n\
<tr class=\"separator:a18901c6d375d0f1261afa5b81e379ebf\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a73dba86d78e28a9137c03a07cb91c7eb\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\">MemoCamera</a> &amp;&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#a73dba86d78e28a9137c03a07cb91c7eb\">operator=</a> (const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CRef.html\">CRef</a> &amp;in_ref)</td></tr>\n\
<tr class=\"separator:a73dba86d78e28a9137c03a07cb91c7eb\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a326a701ed21e69d62358bb0ce12b782a\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CStatus.html\">CStatus</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#a326a701ed21e69d62358bb0ce12b782a\">Record</a> () const </td></tr>\n\
<tr class=\"separator:a326a701ed21e69d62358bb0ce12b782a\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:a60e9ef1ecaa67ec010afe5a3372d04e4\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CStatus.html\">CStatus</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#a60e9ef1ecaa67ec010afe5a3372d04e4\">Recall</a> () const </td></tr>\n\
<tr class=\"separator:a60e9ef1ecaa67ec010afe5a3372d04e4\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
<tr class=\"memitem:aadf6a07a1da24d8ab3df098b8ca72652\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CStatus.html\">CStatus</a>&#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html#aadf6a07a1da24d8ab3df098b8ca72652\">Reset</a> () const </td></tr>\n\
<tr class=\"separator:aadf6a07a1da24d8ab3df098b8ca72652\"><td class=\"memSeparator\" colspan=\"2\">&#160;</td></tr>\n\
...
<a class=\"anchor\" id=\"a177b75ffeb4913b0f9429d0a7e185d59\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
          <td class=\"memname\" translate=\"no\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\">MemoCamera</a> </td>\n\
          <td>(</td>\n\
...
<a class=\"anchor\" id=\"a6fe588789b89ca01992583d11a391b3e\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<a class=\"anchor\" id=\"a85f367517aaa12bba7e81fe2b0f75fec\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<a class=\"anchor\" id=\"a4ef9892a8cbcd98bd964e192f5814e59\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
          <td class=\"memname\" translate=\"no\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\">MemoCamera</a> </td>\n\
          <td>(</td>\n\
          <td class=\"paramtype\">const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\">MemoCamera</a> &amp;&#160;</td>\n\
...
<a class=\"anchor\" id=\"a18901c6d375d0f1261afa5b81e379ebf\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
          <td class=\"memname\" translate=\"no\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\">MemoCamera</a>&amp; operator= </td>\n\
          <td>(</td>\n\
          <td class=\"paramtype\">const <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\">MemoCamera</a> &amp;&#160;</td>\n\
          <td class=\"paramname\"><em>in_obj</em></td><td>)</td>\n\
          <td></td>\n\
...
<dl class=\"section return\"><dt>Returns</dt><dd>The new <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1MemoCamera.html\" title=\"The MemoCamera class represents a memo camera control in a view. \">MemoCamera</a> object. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
<a class=\"anchor\" id=\"a73dba86d78e28a9137c03a07cb91c7eb\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<a class=\"anchor\" id=\"a326a701ed21e69d62358bb0ce12b782a\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
          <td class=\"memname\" translate=\"no\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CStatus.html\">CStatus</a> Record </td>\n\
          <td>(</td>\n\
          <td class=\"paramname\"></td><td>)</td>\n\
          <td> const</td>\n\
        </tr>\n\
...
<a class=\"anchor\" id=\"a60e9ef1ecaa67ec010afe5a3372d04e4\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
          <td class=\"memname\" translate=\"no\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CStatus.html\">CStatus</a> Recall </td>\n\
          <td>(</td>\n\
          <td class=\"paramname\"></td><td>)</td>\n\
          <td> const</td>\n\
        </tr>\n\
...
<p>Recalls a memo camera. </p>\n\
<dl class=\"section return\"><dt>Returns</dt><dd><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CStatus.html#af31477bc48f67856bedb0fa8e5b5281da2bc49ec37d6a5715dd23e85f1ff5bb59\">CStatus::OK</a> Success. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
<a class=\"anchor\" id=\"aadf6a07a1da24d8ab3df098b8ca72652\"></a>\n\
<div class=\"memitem\">\n\
<div class=\"memproto\">\n\
      <table class=\"memname\">\n\
        <tr>\n\
...
<p>Resets a memo camera. </p>\n\
<dl class=\"section return\"><dt>Returns</dt><dd><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CStatus.html#af31477bc48f67856bedb0fa8e5b5281da2bc49ec37d6a5715dd23e85f1ff5bb59\">CStatus::OK</a> Success. </dd></dl>\n\
\n\
</div>\n\
</div>\n\
<hr>The documentation for this class was generated from the following file:<ul>\n\
<li><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/xsi__memocamera_8h_source.html\">xsi_memocamera.h</a></li>\n\
</ul>\n\
</div><!-- contents -->\n\
</div><!-- doc-content -->\n\
