...
\n\
  ...
  <div id=\"navrow1\" class=\"tabs\">\n\
    <ul class=\"tablist\">\n\
      <li class=\"current\"><a href=\"#!/url=./si_cpp/index.html\"><span>Main&#160;Page</span></a></li>\n\
...
Welcome to the Softimage C++ API Reference</h1>\n\
<p>This section contains reference information on every header file, namespace, class, method, enum, typedef, variable, and other C++ element that comprise the Softimage software development kit (SDK). </p>\n\
</div></div><!-- contents -->\n\
</div><!-- doc-content -->\n\
