...
<html>\n\
   <head><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>xsi_actiondeltaitem.h File Reference</title>\n\
   \n\
</head>\n\
...
complete: function() {\n\
  ...
  dQuery(document).ready( function () {\n\
    setTimeout( function () {\n\
      initResizable();\n\
      initNavTree(\'xsi__actiondeltaitem_8h.html\', prefix);\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>xsi_actiondeltaitem.h File Reference</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">xsi_actiondeltaitem.h File Reference</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
...
<div class=\"textblock\"><p>ActionDeltaItem class declaration. </p>\n\
...
Classes</h2></td></tr>\n\
<tr class=\"memitem:\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">class &#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1ActionDeltaItem.html\">ActionDeltaItem</a></td></tr>\n\
<tr class=\"memdesc:\"><td class=\"mdescLeft\">&#160;</td><td class=\"mdescRight\">The ActionDeltaItem object tracks changes made on a parameter that is part of a reference model. Each ActionDeltaItem represents a single change, or modification, to a referenced parameter. So each time there a change to a static value, an <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1FCurve.html\" title=\"The FCurve (function curve) class provides access to a set of functions for getting and setting Softi...\">FCurve</a>, a <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Constraint.html\" title=\"The Constraint object represents a constraint in the scene graph. \">Constraint</a>, an <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1Expression.html\" title=\"An expression string is a mathematical formula that controls any animatable parameter. It may include object and parameter names, mathematical operators, and tokens representing functions or constants. \">Expression</a> or a GroupRelation, a new ActionDeltaItem is generated.  <a href=\"#!/url=./si_cpp/classXSI_1_1ActionDeltaItem.html#details\">More...</a><br></td></tr>\n\
...
\n\
<p><a href=\"#!/url=./si_cpp/xsi__actiondeltaitem_8h_source.html\">Go to the source code of this file.</a></p>\n\
</div><!-- contents -->\n\
</div><!-- doc-content -->\n\
