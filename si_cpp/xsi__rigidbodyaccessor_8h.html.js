...
<html>\n\
   <head><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>xsi_rigidbodyaccessor.h File Reference</title>\n\
   \n\
</head>\n\
...
complete: function() {\n\
  ...
  dQuery(document).ready( function () {\n\
    setTimeout( function () {\n\
      initResizable();\n\
      initNavTree(\'xsi__rigidbodyaccessor_8h.html\', prefix);\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>xsi_rigidbodyaccessor.h File Reference</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">xsi_rigidbodyaccessor.h File Reference</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
...
<div class=\"textblock\"><p>CRigidBodyAccessor class declaration. </p>\n\
...
Classes</h2></td></tr>\n\
<tr class=\"memitem:\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">class &#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CRigidBodyAccessor.html\">CRigidBodyAccessor</a></td></tr>\n\
<tr class=\"memdesc:\"><td class=\"mdescLeft\">&#160;</td><td class=\"mdescRight\">The rigid body accessor provides an optimized access to the data and property values of a rigid body dynamics object. <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1CRigidBodyAccessor.html\" title=\"The rigid body accessor provides an optimized access to the data and property values of a rigid body ...\">CRigidBodyAccessor</a> is suitable for data export applications as it allows access to rigid body data more quickly and efficiently than the regular API classes.  <a href=\"#!/url=./si_cpp/classXSI_1_1CRigidBodyAccessor.html#details\">More...</a><br></td></tr>\n\
...
\n\
<p><a href=\"#!/url=./si_cpp/xsi__rigidbodyaccessor_8h_source.html\">Go to the source code of this file.</a></p>\n\
</div><!-- contents -->\n\
</div><!-- doc-content -->\n\
