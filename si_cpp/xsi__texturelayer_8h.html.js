...
<html>\n\
   <head><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>xsi_texturelayer.h File Reference</title>\n\
   \n\
</head>\n\
...
complete: function() {\n\
  ...
  dQuery(document).ready( function () {\n\
    setTimeout( function () {\n\
      initResizable();\n\
      initNavTree(\'xsi__texturelayer_8h.html\', prefix);\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>xsi_texturelayer.h File Reference</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">xsi_texturelayer.h File Reference</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
...
<code>#include &lt;<a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/xsi__texturelayerport_8h_source.html\">xsi_texturelayerport.h</a>&gt;</code><br>\n\
</div><a name=\"details\" id=\"details\"></a><h2 class=\"groupheader\">File Description</h2>\n\
<div class=\"textblock\"><p>TextureLayer class declaration. </p>\n\
...
\n\
<p><a href=\"#!/url=./si_cpp/xsi__texturelayer_8h_source.html\">Go to the source code of this file.</a></p>\n\
</div><!-- contents -->\n\
</div><!-- doc-content -->\n\
