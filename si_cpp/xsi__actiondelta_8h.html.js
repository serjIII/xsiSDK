...
<html>\n\
   <head><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>xsi_actiondelta.h File Reference</title>\n\
   \n\
</head>\n\
...
complete: function() {\n\
  ...
  dQuery(document).ready( function () {\n\
    setTimeout( function () {\n\
      initResizable();\n\
      initNavTree(\'xsi__actiondelta_8h.html\', prefix);\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>xsi_actiondelta.h File Reference</h1>\n\
         </div>\n\
\n\
...
<div class=\"title\">xsi_actiondelta.h File Reference</div>  </div>\n\
</div><!--header-->\n\
<div class=\"contents\">\n\
...
<div class=\"textblock\"><p>ActionDelta class declaration. </p>\n\
...
Classes</h2></td></tr>\n\
<tr class=\"memitem:\"><td class=\"memItemLeft\" translate=\"no\" align=\"right\" valign=\"top\">class &#160;</td><td class=\"memItemRight\" translate=\"no\" valign=\"bottom\"><a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1ActionDelta.html\">ActionDelta</a></td></tr>\n\
<tr class=\"memdesc:\"><td class=\"mdescLeft\">&#160;</td><td class=\"mdescRight\">The ActionDelta object tracks changes made on a parameter that is part of a reference model. Every ActionDelta contains one or more <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/classXSI_1_1ActionDeltaItem.html\" title=\"The ActionDeltaItem object tracks changes made on a parameter that is part of a reference model...\">ActionDeltaItem</a> objects, each of which represents a single change, or modification, to a referenced parameter. Each ActionDelta object has a specific type (see <a class=\"el\" translate=\"no\" href=\"#!/url=./si_cpp/namespaceXSI.html#a65288d31e9e6ea845f59a105c0a7e0d4\">siModificationDeltaType</a>) and each ActionDeltaItem it contains is of the same type.  <a href=\"#!/url=./si_cpp/classXSI_1_1ActionDelta.html#details\">More...</a><br></td></tr>\n\
...
\n\
<p><a href=\"#!/url=./si_cpp/xsi__actiondelta_8h_source.html\">Go to the source code of this file.</a></p>\n\
</div><!-- contents -->\n\
</div><!-- doc-content -->\n\
