...
XSIPLUGINCALLBACK XSI::CStatus DemoTool_Init( XSI::CRef& in_ctxt )
{
	...
	oMenu.AddCallbackItem( L"Import Export Demo", L"OnImportExportMenuClicked", oNewItem );
...
XSIPLUGINCALLBACK XSI::CStatus OnImportExportMenuClicked( XSI::CRef& in_ref)
{	
