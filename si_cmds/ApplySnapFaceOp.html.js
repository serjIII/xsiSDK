...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ApplySnapFaceOp</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">ApplySnapFaceOp</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
...
with the SnapFace operator.<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = ApplySnapFaceOp( [ConnectionSet], [ConnectType], [ImmediateMode], [OutputObjs] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns an <a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a> that contains the created snap face operators.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
 Specifies the objects connected to the operator.  			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
...
ApplySnapFaceOp oRighty &amp; \".bndry[0];\" &amp; oLefty &amp; \".bndry[2]\"</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
