...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>SIApplyFlexEnv</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">SIApplyFlexEnv</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>Applies a flexible envelope.</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = SIApplyFlexEnv( [ConnectionSet], [Interactive], [AssignNewDeformers], [ConstructionMode] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>\n\
Returns an <a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a> that contains the created Envelope \n\
operators (EnvelopeAutoAssignOp and EnvelopeOp).\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
False			</p>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/Boolean.htm\">Boolean</a>		</td>\n\
		<td>\n\
 True to automatically assign deformer objects when they are added to existing Envelopes. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
False			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
SIApplyFlexEnv \"sphere;bone,bone1,eff\", False, False</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
