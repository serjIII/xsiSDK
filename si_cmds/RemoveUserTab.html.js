...
\n\
<h2 class=\"pagehead\">RemoveUserTab</h2>\n\
\n\
<h3>Introduced</h3>\n\
...
<h3>Description</h3>\n\
<div><p>\n\
Removes one or more user tab(s) from each object in the specified list. User tabs \n\
are lists of comma-separated strings, identical to user keywords, except that they\n\
are shown as tabs in the Material Manager.  Presently, they are not used anywhere\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>RemoveUserTab( [InputObjs], Keywords );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
