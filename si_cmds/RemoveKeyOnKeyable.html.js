...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>RemoveKeyOnKeyable</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>RemoveKeyOnKeyable</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">RemoveKeyOnKeyable</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v5.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Removes key frames from the keyable parameters at a given frame.<br /><br />\n\
Note: If any of the keys cannot be removed the command raises an siErrCancelled error; see \n\
<a href=\"#!/url=./si_om/siErrorValueEnum.html\">siErrorValueEnum</a> for details. To avoid an error, wrap the call to \n\
RemoveKeyOnKeyable with the \'On Error Resume Next...On Error Goto 0\' statements in VBScript \n\
or the \'try()...catch(e)\' construction in JScript.<br /><br />\n\
This command is very similiar to <a href=\"#!/url=./si_cmds/RemoveKey.html\">RemoveKey</a> with the only difference being \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>RemoveKeyOnKeyable( [InputObjs], [Time], [Tolerance], [Layer] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/RemoveKeyOnKeyable.html\">RemoveKeyOnKeyable</a> <a href=\"#!/url=./si_cmds/RemoveKeyOnMarkedKeyable.html\">RemoveKeyOnMarkedKeyable</a></p></div>\n\
\n\
