...
\n\
<h2 class=\"pagehead\">SwitchToView</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
...
You specify the name of the view (you can get it from the <a href=\"#!/url=./si_om/SIObject.Name.html\">SIObject.Name</a> \n\
property of the <a href=\"#!/url=./si_om/View.html\">View</a> object) to identify it. This allows you to \n\
pick from multiple instances of one view type, if necessary. Alternatively, you \n\
can use the <a href=\"#!/url=./si_cmds/SwitchToViewByType.html\">SwitchToViewByType</a> command, which allows you to\n\
specify the view to switch to by <a href=\"#!/url=./si_om/SIObject.Type.html\">SIObject.Type</a> instead.\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SwitchToView( ViewName );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./si_om/SIObject.Name.html\">SIObject.Name</a> of the view to display. 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
