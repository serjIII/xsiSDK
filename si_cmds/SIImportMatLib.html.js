...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>SIImportMatLib</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">SIImportMatLib</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Imports a material library in the form of a .xsi file. Only the SI_MaterialLibrary\n\
part of the file is read. It becomes part of the scene as if merged. \n\
<br /><br />\n\
Note: If the Reference flag is set, original path is maintained and the library itself \n\
is flagged locked. If the Reference flag is not set, the original path is lost. \n\
<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SIImportMatLib( FileName, [ShareOptions], [Value] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
 Name of the model file to import. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If this parameter is not specified, a browser pops up, prompting the user to pick an .xsi file			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td>\n\
Bit field values of type <a href=\"#!/url=./files/Integer.htm\">Integer</a> that specify whether to import the model as a reference model			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
siImportShareOptionsNone			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Value		</td>\n\
		<td><a href=\"#!/url=./si_om/MaterialLibrary.html\">MaterialLibrary</a>		</td>\n\
		<td>\n\
 Returns the library created		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
NewScene , false\n\
SIImportMatLib dotXSIFile</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/ExportMaterialLibrary.html\">ExportMaterialLibrary</a> <a href=\"#!/url=./si_cmds/SIImportReferencedMatLib.html\">SIImportReferencedMatLib</a> <a href=\"#!/url=./si_om/Material.Library.html\">Material.Library</a> <a href=\"#!/url=./si_om/Scene.ActiveMaterialLibrary.html\">Scene.ActiveMaterialLibrary</a></p></div>\n\
\n\
