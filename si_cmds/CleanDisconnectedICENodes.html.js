...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>CleanDisconnectedICENodes</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>CleanDisconnectedICENodes</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">CleanDisconnectedICENodes</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Removes the terminal nodes (<a href=\"#!/url=./si_om/ICETree.html\">ICETree</a>s) that have not been connected \n\
in the specified ICE tree.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>CleanDisconnectedICENodes( [ICETree] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		<td class=\"name\">ICETree		</td>\n\
		<td><a href=\"#!/url=./files/listexpr.htm\">Selection list</a>		</td>\n\
		<td>\n\
The <a href=\"#!/url=./si_om/ICETree.html\">ICETree</a> to clean.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
