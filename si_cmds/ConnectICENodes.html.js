...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ConnectICENodes</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">ConnectICENodes</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>Connects two nodes through the specified ports (components).</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ConnectICENodes( [InputPort], [OutputPort] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		<td class=\"name\">InputPort		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
Input port on the target node (<a href=\"#!/url=./si_om/ICENodeInputPort.html\">ICENodeInputPort</a>).			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If not specified, the user is prompted to select a target.			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">OutputPort		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
Output port on the source node (<a href=\"#!/url=./si_om/ICENodeOutputPort.html\">ICENodeOutputPort</a>).			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If not specified, the user is prompted to select a source.			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
...
Application.ConnectICENodes(tree.InputPorts(0), setData.OutputPorts(0))</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
