...
<h3>Description</h3>\n\
<div><p>\n\
Adds an image operator to an <a href=\"#!/url=./si_om/FxTree.html\">FxTree</a>.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = AddFxOp( [FxTree], PresetName );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
Current selection. <br /><br />Note: If the current selection is not a valid FxTree, an error occurs.			</p>\n\
	...
	<tr>\n\
		...
		<td>Fx Operator Preset		</td>\n\
		<td>\n\
Name of operator preset. This can be either a built-in effect name or a file on disk (with path).		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\' This example creates an FxTree, adds some operators to it\n\
...
\'INFO : \"Name of Fx Operator: EdgeDetect\"</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
