...
\n\
<h2 class=\"pagehead\">UnfoldUpdate</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.5</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Recalculates the unfold based on the current settings and stores the new unfolding in the \n\
Unfold texture UV <a href=\"#!/url=./si_om/Property.html\">Property</a>.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oBoolean = UnfoldUpdate( [UnfoldProperty(s)], [Options] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/listtexpr.htm\">List</a> of Unfold <a href=\"#!/url=./si_om/Property.html\">Property</a> objects		</td>\n\
		<td>\n\
The Unfold property to update.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If not specified, the current selection is used.			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
Specify \"DoPack\" to unpack while updating.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
\"DoPack\"			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
