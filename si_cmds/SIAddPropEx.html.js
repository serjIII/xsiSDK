...
\n\
<h2 class=\"pagehead\">SIAddPropEx</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>Adds an existing property to an object.<br /><br />\n\
Notice that UV cluster properties and vertex color properties can only be added to \n\
clusters which are always complete, see <a href=\"#!/url=./si_om/Geometry.AddCluster.html\">Geometry.AddCluster</a> method.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SIAddPropEx( InputObj, Property, [PropagationType] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./files/objectexpr.htm\">Object</a> to which the property is added. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Property		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
<a href=\"#!/url=./files/paramexpr.htm\">Property</a> to add 		</td>\n\
	</tr>\n\
	<tr>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\' The following example uses SIAddPropEx to first create \n\
...
logMessage \"the annotation property has been added to the cone\"</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
