...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>UnfoldAddToCut</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">UnfoldAddToCut</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.5</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Adds the specified edge list as a cutting line to the specified Unfold <a href=\"#!/url=./si_om/Property.html\">Property</a>.\n\
<br /><br />\n\
Unfolding creates a UV texture projection by \'unwrapping\' a polygon mesh object using the \n\
edges you specify as cut lines or seams. When unfolding, the cut lines are treated as if \n\
they are disconnected to create borders or separate islands in the texture projection. \n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oBoolean = UnfoldAddToCut( UnfoldProperty, [EdgeList(s)] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
The Unfold property to which you want to add the new cut(s).		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
Edges to be added to the cutting line definition.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
...
UnfoldUpdate(\"grid.Unfold\");</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
