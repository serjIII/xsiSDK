...
\n\
<h2 class=\"pagehead\">SIInstantiate</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Instantiates the specified <a href=\"#!/url=./si_om/Model.html\">Model</a>. When you instantiate \n\
a model, you create a \"Render Instance\" of it. A render instance stores \n\
no geometry, unlike Clones. Render instances are light-weight references \n\
to their \"Master\" (the input model); only the transformations may be modified. \n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = SIInstantiate( InputObjs, [NbItems], [Name] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./files/objectexpr.htm\">Objects</a> to instantiate. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current selection			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
1			</p>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
Name to use for new instance.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
\"\"			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
...
Translate oWraiths(3), -5.0, 0.0, 5.0, siRelative, siView, siObj, siXYZ</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/Instantiate.html\">Instantiate</a></p></div>\n\
\n\
