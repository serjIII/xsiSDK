...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>CreateImageClip2</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">CreateImageClip2</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
...
a single image clip will be created and returned.<br /><br /></p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = CreateImageClip2( [FileName], [Name] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns an <a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a> that contains the list \n\
of newly created Image Clips.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Filename argument handler will pop up if nothing specified.			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
If no name is supplied, then a default value will be used.			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">set NewClips = CreateImageClip2(\"c:\\windows\\clock.avi\" )\n\
