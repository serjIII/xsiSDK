...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>ConvertQuatToEuler</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ConvertQuatToEuler</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">ConvertQuatToEuler</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Converts quaternion animation to individual (Euler) fcurves.<br /><br />\n\
If there is keyframe animation on the local rotation\n\
channels then it will be converted to individual (Euler) fcurves.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ConvertQuatToEuler( [InputObjs] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
\' which are then converted to quaternion animation and back \n\
\' to Euler fcurves.\n\
\'\n\
NewScene\n\
...
ConvertEulerToQuat\n\
\' Convert back to normal fcurves\n\
ConvertQuatToEuler\n\
\' Play the animation\n\
