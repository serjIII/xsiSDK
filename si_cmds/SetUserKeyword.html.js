...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>SetUserKeyword</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">SetUserKeyword</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Sets the user keyword(s) on each object in the specified list. \n\
<br /><br />\n\
Note: Calling this command will erase any existing keywords. To set a user keyword while\n\
preserving any existing list, use the <a href=\"#!/url=./si_cmds/AddUserKeyword.html\">AddUserKeyword</a> command instead.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SetUserKeyword( [InputObjs], [Keywords] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Current selection			</p>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
Keywords to set, as a comma separated list.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
\"\"			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
