...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>RenderRegionSetRenderChannel</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>RenderRegionSetRenderChannel</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">RenderRegionSetRenderChannel</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Sets which particular render channel should be shown in the render region for\n\
the specified viewport(s). Which render channel are available depends on the \n\
current rendering engine being used and which render channels it makes available \n\
for render.\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>RenderRegionSetRenderChannel( [Viewport], [RenderChannel] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
The viewport(s) containing the render region with the render channel to set.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
siViewportCurrent (the viewport the cursor is currently hovering over)			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
The render channel to render for the render region.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
\"Main\"			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
...
RenderRegionSetRenderChannel( siViewportB, \"specular\" );</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
