...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>DeleteUnusedCamSeqTracks</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>DeleteUnusedCamSeqTracks</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">DeleteUnusedCamSeqTracks</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v12.0 (2014)</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>Deletes all tracks (of all types) on the camera sequencer which are currently not in use (i.e. have no clips on them).</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>DeleteUnusedCamSeqTracks();</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Examples</h3>\n\
...
DeleteUnusedCamSeqTracks( );</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/AddTrack.html\">AddTrack</a> <a href=\"#!/url=./si_cmds/AddShotClip.html\">AddShotClip</a> <a href=\"#!/url=./si_cmds/GetShotClip.html\">GetShotClip</a> <a href=\"#!/url=./si_om/Track.html\">Track</a></p></div>\n\
\n\
