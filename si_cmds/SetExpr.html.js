...
execution, use the <a href=\"#!/url=./si_cmds/AddExpr.html\">AddExpr</a> command instead.\n\
<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SetExpr( [InputObj], [ExprStr], [ExprObj] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Current parameter value (for example, \"a.kine.global.posx = 3.5\")			</p>\n\
	...
	<tr>\n\
		<td class=\"name\">ExprObj		</td>\n\
		<td><a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a>		</td>\n\
		<td>\n\
 Returns a list of expression objects 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_om/Parameter.AddExpression.html\">Parameter.AddExpression</a> <a href=\"#!/url=./si_cmds/EditExpr.html\">EditExpr</a> <a href=\"#!/url=./si_cmds/RemoveAnimation.html\">RemoveAnimation</a> <a href=\"#!/url=./si_cmds/RemoveAllAnimation.html\">RemoveAllAnimation</a> <a href=\"#!/url=./si_cmds/AddExpr.html\">AddExpr</a></p></div>\n\
\n\
