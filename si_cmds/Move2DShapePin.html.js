...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Move2DShapePin</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">Move2DShapePin</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Sets the position of a scale\'s pin (its center). This is the scripting equivalent of \n\
selecting the shape, and clicking and dragging its center (pin marker) in the Fx Tree.<br /><br />\n\
Moving the pin changes how the shape rotates and scales. For example, if you\n\
move the pin to the left of the shape and then rotate it, the shape pivots from the\n\
left.<br /><br />\n\
Note: If you need to move the whole shape, use the <a href=\"#!/url=./si_cmds/Move2DShape.html\">Move2DShape</a> \n\
command instead.\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Move2DShapePin( [Shape], [x], [y] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./files/paramexpr.htm\">Parameter path name</a> for the shape whose pin you are moving.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current selection. <br /><br />Note: If the current selection is not a valid shape, an error occurs.			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
Specifies the new position of the center in X.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/Double.htm\">Double</a>		</td>\n\
		<td>\n\
Specifies the new position of the center in Y.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/Add2DShape.html\">Add2DShape</a> <a href=\"#!/url=./si_cmds/Move2DShape.html\">Move2DShape</a> <a href=\"#!/url=./si_cmds/Scale2DShape.html\">Scale2DShape</a> <a href=\"#!/url=./si_cmds/Set2DShapeRotation.html\">Set2DShapeRotation</a></p></div>\n\
\n\
