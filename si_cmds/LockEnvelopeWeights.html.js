...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>LockEnvelopeWeights</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>LockEnvelopeWeights</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">LockEnvelopeWeights</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v5.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Prevents modifying the envelope weights for point deformer pairs. <br /><br />\n\
...
for some deformers to be modified either directly or indirectly through normalization. <br /><br />\n\
Note that this command requires two arrays. These two arrays together define the (point,deformer) pairs \n\
to lock. For example, if the point array (2,62,93) and the deformer array (1,12,16) are passed this means \n\
that the weight between the second point of and the first deformer will be locked, the weight between the \n\
62nd point and 12th deformer will be locked, and the weight between the 93rd point and 16th deformer will \n\
be locked. Hence, the size of these two arrays must be equal. The deformer indices are as connected to the \n\
envelope property.\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = LockEnvelopeWeights( PropObj, Points, Deformers, [Locked] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns an <a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a> that contains the new operator that applies the locking.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
 ...
 Envelope weights property for which we want to lock the weights.		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Array of points indices to be locked.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Deformers		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Array of point deformers to be locked.		</td>\n\
	</tr>\n\
	<tr>\n\
