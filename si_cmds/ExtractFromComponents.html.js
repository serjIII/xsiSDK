...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>ExtractFromComponents</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ExtractFromComponents</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">ExtractFromComponents</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v2.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Creates new objects (eg: curves, meshes) from components (eg: subcurves, polygons)<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ExtractFromComponents( PresetObj, [ConnectionSet], [Name], [DeleteInputComponents], [ImmediateMode], [GenOpInputsDisposal], [OutputObjs] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
Extraction (Generator and Converter Operators) operator 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If nothing is specified, the user will be prompted to pick a preset from the browser			</p>\n\
			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				...
				<tr>\n\
					<td class=\"name\">ExtractEdgeLoopOp					</td>\n\
					<td>ExtractEdgeLoopOp operator preset					</td>\n\
				</tr>\n\
				<tr>\n\
					<td class=\"name\">ExtractPolygonsOp					</td>\n\
					<td>ExtractPolygonsOp operator preset					</td>\n\
				</tr>\n\
				<tr>\n\
					<td class=\"name\">ExtractSubCrvOp					</td>\n\
					<td>ExtractSubCrvOp operator preset					</td>\n\
				</tr>\n\
			</table>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td>\n\
Components to extract. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Currently selected components are used.<br /><br />Warning: An error occurs if the connection set is invalid. Please verify the connection set required for this operator to avoid breaking your scripts.			</p>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 name to use for new objects 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">DeleteInputComponents		</td>\n\
		<td><a href=\"#!/url=./files/Boolean.htm\">Boolean</a>		</td>\n\
		<td>\n\
 True to automatically delete the input components after the operation. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
False			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
siUnspecified			</p>\n\
			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				...
				<tr>\n\
					<td class=\"name\">siPersistentOperation					</td>\n\
					<td>The operator will NOT be frozen after the duplicate (extrude)					</td>\n\
				</tr>\n\
				<tr>\n\
					<td class=\"name\">siImmediateOperation					</td>\n\
					<td>The operator will be frozen after the duplicate (extrude)					</td>\n\
				</tr>\n\
			</table>\n\
		</td>\n\
	</tr>\n\
...
siKeepGenOpInputs			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Returns the created primitives. 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
