...
\n\
<h2 class=\"pagehead\">DeleteKeys</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
...
from one or more <a href=\"#!/url=./si_om/FCurve.html\">FCurve</a>s. This is similar to the <a href=\"#!/url=./si_cmds/CutKeys.html\">CutKeys</a> \n\
command, except that the deleted keys are not copied to the buffer and thus are not available\n\
to the <a href=\"#!/url=./si_cmds/PasteKeys.html\">PasteKeys</a> command.<br /><br />\n\
Tip: You specify each fcurve to modify by identifying the parameter it drives in the InputObjs \n\
argument.<br /><br /> \n\
DeleteKeys is the command equivalent of deleting keys in the dopesheet and should be used \n\
when trying to emulate dopesheet behaviour.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>DeleteKeys( [InputObjs], [StartFrame], [EndFrame], [Ripple], [SelectedKeysOnly], [Type] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
False			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
 \n\
		True to delete only the selected keys within the timerange (from StartFrame to EndFrame). To create or modify a key selection, \n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/SelectKeysInTimespan.html\">SelectKeysInTimespan</a> <a href=\"#!/url=./si_cmds/DeselectAllKeys.html\">DeselectAllKeys</a> <a href=\"#!/url=./si_cmds/CopyKeys.html\">CopyKeys</a> <a href=\"#!/url=./si_cmds/CutKeys.html\">CutKeys</a> <a href=\"#!/url=./si_cmds/PasteKeys.html\">PasteKeys</a></p></div>\n\
\n\
