...
\n\
<h2 class=\"pagehead\">CopyKeys</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Copies <a href=\"#!/url=./si_om/FCurveKey.html\">FCurveKey</a>s for the specified timerange (from StartFrame to EndFrame) \n\
from one or more <a href=\"#!/url=./si_om/FCurve.html\">FCurve</a>s to the buffer. You can then use the <a href=\"#!/url=./si_cmds/PasteKeys.html\">PasteKeys</a> \n\
command to complete the copy-paste action (move the copied keys from the buffer onto another fcurve).<br /><br />\n\
Tip: You specify each fcurve to copy from by identifying the parameter it drives in the InputObjs argument.<br /><br /> \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>CopyKeys( [InputObjs], [StartFrame], [EndFrame], [Reset], [SelectedKeysOnly], [Type] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
100			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Flag to force the buffer cleanup before copy 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
True			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/SelectKeysInTimespan.html\">SelectKeysInTimespan</a> <a href=\"#!/url=./si_cmds/DeselectAllKeys.html\">DeselectAllKeys</a> <a href=\"#!/url=./si_cmds/CutKeys.html\">CutKeys</a> <a href=\"#!/url=./si_cmds/DeleteKeys.html\">DeleteKeys</a> <a href=\"#!/url=./si_cmds/PasteKeys.html\">PasteKeys</a></p></div>\n\
\n\
