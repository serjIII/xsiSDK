...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>RenderRegionSetRefreshMode</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>RenderRegionSetRefreshMode</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">RenderRegionSetRefreshMode</h2>\n\
\n\
<h3>Introduced</h3>\n\
...
<h3>Description</h3>\n\
<div><p>\n\
Sets which refresh mode should be used in the render region for the specified viewport(s).\n\
...
it only obeys explicit refresh requests or changes to the camera, to the time or to the region state. Finally,\n\
when the refresh mode is set to the manual mode, it only obeys explicit refresh requests. \n\
<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>RenderRegionSetRefreshMode( [Viewport], [RefreshMode] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
The viewport(s) containing the render region with the refresh mode to modify.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
siViewportAll			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">RefreshMode		</td>\n\
		<td><a href=\"#!/url=./si_om/siRenderRegionRefreshMode.html\">siRenderRegionRefreshMode</a>		</td>\n\
		<td>\n\
The render region refresh mode to be used.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
siRenderRegionRefreshModeInteractive (re-render upon any render-relevant change in the scene)			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">// Sets the refresh mode of the render region in the viewport A (the top view) to the manual mode.\n\
RenderRegionSetRefreshMode( siViewportA, siRenderRegionRefreshModeManual );</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
