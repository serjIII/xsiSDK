...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>SIExportDotXSIFile</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>SIExportDotXSIFile</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">SIExportDotXSIFile</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Exports an object to a dotXSI file. <br /><br />\n\
This command is accessed through the main menu by selecting File->Export->dotXSI, then by selecting the desired \n\
export options and pressing Ok. This command is equivalent to the <a href=\"#!/url=./si_cmds/ExportDotXSI.html\">ExportDotXSI</a> command, except \n\
that the user is not prompted for export options.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SIExportDotXSIFile( [Model], FileName );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
 Object or  model to be exported 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">FileName		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Name of the output dotXSI file. 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/ExportDotXSI.html\">ExportDotXSI</a> <a href=\"#!/url=./si_cmds/ImportDotXSI.html\">ImportDotXSI</a> <a href=\"#!/url=./si_cmds/ExportModel.html\">ExportModel</a> <a href=\"#!/url=./si_cmds/SIImportDotXSIFile.html\">SIImportDotXSIFile</a></p></div>\n\
\n\
