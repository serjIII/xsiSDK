...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>DuplicateAnimationLayer</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>DuplicateAnimationLayer</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">DuplicateAnimationLayer</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Duplicates and mutes the specified animation layer and make the duplicated layer the current animation layer.<br /><br />\n\
Note: A value of 0 for the layer will be ignored because the base animation layer cannot be removed with this command.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>DuplicateAnimationLayer( [InputObjs], [Layer] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Currently selected objects			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Animation layer to remove. Only layers greater than 0 can be removed. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
