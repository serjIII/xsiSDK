...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>SICreateRefPlane</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">SICreateRefPlane</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.5</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Creates a new reference plane based on the selection. \n\
It does not set this new reference plane as the active reference plane.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = SICreateRefPlane( [InputObjs] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
MsgBox \"Move the sphere around interactively.  It will snap to the reference plane defined by the grid.\"</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/CreateReferencePlane.html\">CreateReferencePlane</a> <a href=\"#!/url=./si_cmds/SetCurrentReferencePlane.html\">SetCurrentReferencePlane</a></p></div>\n\
\n\
