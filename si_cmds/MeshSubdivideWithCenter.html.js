...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>MeshSubdivideWithCenter</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>MeshSubdivideWithCenter</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">MeshSubdivideWithCenter</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.5</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>MeshSubdivideWithCenter( PresetObj, [ConnectionSet], [ConnectType], [ImmediateMode], [GenOpInputsDisposal] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a> or preset object (see <a href=\"#!/url=./si_cmds/SIGetPreset.html\">SIGetPreset</a>)		</td>\n\
		<td>\n\
One of the mesh subdivide Generator Operators			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
\"MeshSubdivideWithCenter\"			</p>\n\
			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				...
				<tr>\n\
					<td class=\"name\">MeshSubdivideWithCenter					</td>\n\
					<td>MeshSubdivideWithCenter operator preset					</td>\n\
				</tr>\n\
				<tr>\n\
					<td class=\"name\">MeshSubdivide					</td>\n\
					<td>MeshSubdivide operator preset					</td>\n\
				</tr>\n\
			</table>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td>\n\
Objects to apply subdivide to.<br /><br />Note: Because this is an in/out parameter, any string (variable or value) you pass into this parameter is automatically converted to a ConnectionSet object.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
No default.<br /><br />Warning: An error occurs if the connection set is invalid. Please verify the connection set required for this operator to avoid breaking your scripts.			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td>\n\
Specifies whether this applies to the object as a node or as a branch.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
siUnspecified			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\'This example shows how to generate a subdivision surface from an input mesh.\n\
newscene\n\
...
MeshSubdivideWithCenter , \"sphere\", , siPersistentOperation</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/ApplyOp.html\">ApplyOp</a></p></div>\n\
\n\
