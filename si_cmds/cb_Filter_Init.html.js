...
\n\
<h2 class=\"pagehead\">Init (Filter)</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
<div><p><a name=\"Description\"> </a>	<p>\n\
				The Init callback for a plug-in item is fired when Softimage loads the plug-in. For example, Init is fired \n\
				when you start Softimage, connect to a workgroup, click Update All in the Plug-in Manager, or call \n\
				<a href=\"#!/url=./si_om/XSIApplication.LoadPlugin.html\">XSIApplication.LoadPlugin</a>.\n\
			</p>\n\
</p></div>\n\
\n\
<hr width=\"100%\" />\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"cplusplus\">CStatus &lt;filter_name&gt;_Init( CRef&amp; in_context )\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">function &lt;filter_name&gt;_Init( in_context )\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\">def &lt;filter_name&gt;_Init( in_context ):\n\
	...</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"perlscript\">sub &lt;filter_name&gt;_Init \n\
{ \n\
	my $in_context = shift; \n\
}</pre></td></tr>\n\
</table>\n\
