...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>CreateShaderFromProgID</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>CreateShaderFromProgID</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">CreateShaderFromProgID</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Adds a <a href=\"#!/url=./si_om/Shader.html\">Shader</a> to a render tree based on the specified <a href=\"#!/url=./si_om/Shader.ProgID.html\">Shader.ProgID</a>.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = CreateShaderFromProgID( ProgID, [Container], Name );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
\n\
		Identify the shader to add by its <a href=\"#!/url=./si_om/Shader.ProgID.html\">Shader.ProgID</a>. You can \n\
		also create shader compounds if you supply a valid shader compound ProgID.\n\
			</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td>\n\
The shader compound or material to which we\'re adding the node.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If not specified, the user is prompted to select a shader container.			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
// Expected results:\n\
// INFO : XSIRTCOMPOUND\n\
// INFO : XSIRTCOMPOUND.XSIDOC_PhongSpecFractal.1.0</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
