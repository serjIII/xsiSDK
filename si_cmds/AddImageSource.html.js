...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>AddImageSource</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">AddImageSource</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
...
composting effects, such as texturing. <br /><br />\n\
This command is similar in syntax and behavior to the \n\
<a href=\"#!/url=./si_cmds/SIAddImageClip.html\">SIAddImageClip</a> command, except that it returns a value \n\
from the function directly, instead of through a parameter.<br /><br />\n\
It is accessed from the main menu under Render-<get -=\"\"></get><create source=\"\" from=\"\" file,=\"\" and=\"\" then=\"\" choosing=\"\" an=\"\" image=\"\" source=\"\" file.=\"\"></create></p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = AddImageSource( [FileName], [Name] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
