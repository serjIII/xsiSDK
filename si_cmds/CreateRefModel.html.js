...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>CreateRefModel</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">CreateRefModel</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = CreateRefModel( [FileName], [ModelName], [ResolutionName], [Parent], [Activate], [CreateFile], [ExternalCnxMappingTemplate], [ShareOptions] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
CreateRefModel( sPath, \"alaind\", \"low\", null, false, true) ;</pre></td></tr>\n\
</table>\n\
...
CreateRefModel( sPath, \"man\", \"low\", \"mymodel\", true, false );</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/CommitToReference.html\">CommitToReference</a> <a href=\"#!/url=./si_cmds/ConvertToRefModel.html\">ConvertToRefModel</a> <a href=\"#!/url=./si_cmds/ImportModel.html\">ImportModel</a> <a href=\"#!/url=./si_cmds/ExportModel.html\">ExportModel</a></p></div>\n\
\n\
