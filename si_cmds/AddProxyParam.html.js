...
\n\
<h2 class=\"pagehead\">AddProxyParam</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Adds proxy parameters to a list of 3D objects or custom parameter sets.  A proxy parameter\n\
is a parameter which appears under a custom parameter set but which has its value tied to a \n\
parameter on another object.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>AddProxyParam( [InputObjs], [Proxied], [Prefix] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./files/listexpr.htm\">List</a> of custom property sets or\n\
...
Current selection			</p>\n\
	...
	<tr>\n\
		<td class=\"name\">Proxied		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
<a href=\"#!/url=./files/listexpr.htm\">List</a> of specific parameters or \n\
		entire property sets to specify as the master(s) for this proxy parameter.\n\
				<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If nothing is specified, a picking session is launched.			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
Proxy parameter will be created with this as a prefix for name 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
\"\"			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
...
InspectObj oNull &amp; \".CustomPSet\"</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
