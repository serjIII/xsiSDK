...
\n\
<h2 class=\"pagehead\">CreateModel</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
...
parameter).\n\
<br /><br />\n\
This command is the scripting equivalent of selecting Create > Model > New \n\
Model from the Model toolbar. It is similar in syntax and behavior to the \n\
<a href=\"#!/url=./si_cmds/SICreateModel.html\">SICreateModel</a> command, except that it selects the new model.\n\
<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>CreateModel( [InputObj], [Name], [Parent], [Value] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
