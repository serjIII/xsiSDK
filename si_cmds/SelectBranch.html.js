...
\n\
<h2 class=\"pagehead\">SelectBranch</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Branch-selects the 3D objects that are currently selected. This is the same as calling \n\
SelectObj , \"BRANCH\" \n\
<br /><br /> \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SelectBranch( [CheckObjectSelectability] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\' Make sure all selected 3D objects are branch-selected\n\
SelectBranch</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
