...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>OnButtonClicked (GridData)</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>OnButtonClicked (GridData)</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">OnButtonClicked (GridData)</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">function &lt;property_name&gt;_&lt;parameter_name&gt;_OnButtonClicked()\n\
{\n\
...\n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\">def &lt;property_name&gt;_&lt;parameter_name&gt;_OnButtonClicked():\n\
				...</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">Function &lt;property_name&gt;_&lt;parameter_name&gt;_OnButtonClicked()\n\
				...\n\
End Function</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"perlscript\">sub &lt;property_name&gt;_&lt;parameter_name&gt;_OnButtonClicked\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
\n\
	...
	for col in range( gridData.ColumnCount ):\n\
		...
		gridData.SetColumnDef( col, constants.siColumnButton )\n\
...
def MyProperty_OnClosed( ):\n\
	pass\n\
\n\
def MyProperty_MyGrid_OnButtonClicked( in_ExtraParams ):\n\
	param = PPG.MyGrid\n\
	gridData = param.Value\n\
	\n\
	# Retrieve the set of cells on which a button was clicked\n\
	# (if multiple \"button\" cells are selected prior to clicking \n\
	# then all the cells are part of the callback extra parameters)\n\
	columnRowPairs = []\n\
	columnRowPairs.extend( in_ExtraParams[0] )\n\
	\n\
	logString = \"Button clicked on these cells: \"\n\
...
\n\
	Application.LogMessage( logString )</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<hr width=\"100%\" />\n\
