...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>ConvertEulerToQuat</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ConvertEulerToQuat</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">ConvertEulerToQuat</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Converts rotation fcurves to quaternion fcurves.<br /><br />\n\
If there is keyframe animation on the local rotation\n\
channels then it will be converted to quaternion fcurves.<br /><br />\n\
If the rotation channels are not animated then an empty\n\
quaternion fcurve will be created to drive the local rotation\n\
channels. This fcurve can be keyframed/edited like any other\n\
fcurve.\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ConvertEulerToQuat( [InputObjs] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
