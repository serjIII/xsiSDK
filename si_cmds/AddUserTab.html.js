...
\n\
<h2 class=\"pagehead\">AddUserTab</h2>\n\
\n\
<h3>Introduced</h3>\n\
...
<h3>Description</h3>\n\
<div><p>\n\
Adds a user tab to each object in the specified list. User tabs are lists of comma-separated strings, \n\
identical to user keywords, except that they are shown as tabs in the Material Manager.  Presently, \n\
they are not used anywhere else in the software. \n\
<br /><br />\n\
To replace an existing tab in the list, use the <a href=\"#!/url=./si_cmds/SetUserTab.html\">SetUserTab</a> command instead.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>AddUserTab( [InputObjs], Keywords );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
If not specified, the current selection is used.			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
User tabs to set, as a comma separated list		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbcript\">NewScene\n\
