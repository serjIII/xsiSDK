...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>Insert2DShapePoint</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Insert2DShapePoint</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">Insert2DShapePoint</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
...
clicking on the outline of the shape to add points to it in the Fx Viewer.<br /><br />\n\
The difference between Insert2DShapePoint and the <a href=\"#!/url=./si_cmds/Add2DShapePoint.html\">Add2DShapePoint</a> \n\
or <a href=\"#!/url=./si_cmds/Add2DShapePointArray.html\">Add2DShapePointArray</a> commands is that Insert2DShapePoint\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oLong = Insert2DShapePoint( [Shape], position, x, y );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./files/paramexpr.htm\">Parameter path name</a> for the shape where you are adding the new point.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current selection. <br /><br />Note: If the current selection is not a valid list, an error occurs.			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
Index position for the new point in the array of points for the shape.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">x		</td>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/Add2DShape.html\">Add2DShape</a> <a href=\"#!/url=./si_cmds/Add2DShapePoint.html\">Add2DShapePoint</a> <a href=\"#!/url=./si_cmds/Add2DShapePointArray.html\">Add2DShapePointArray</a> <a href=\"#!/url=./si_cmds/Delete2DShapePoint.html\">Delete2DShapePoint</a></p></div>\n\
\n\
