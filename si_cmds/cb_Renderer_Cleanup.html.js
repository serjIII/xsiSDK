...
\n\
<h2 class=\"pagehead\">Cleanup</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
<div><p><a name=\"Description\"> </a>	<p>\n\
				This optional callback is used by the Render Manager to instruct the rendering engine to clean up all data \n\
				created by it by previous <a href=\"#!/url=./si_cmds/cb_Renderer_Process.html\">Process</a> callback. The two callbacks \n\
				are guaranteed to always be called one after the other, never at the same time.\n\
			</p>\n\
</p></div>\n\
\n\
<hr width=\"100%\" />\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"cplusplus\">CStatus &lt;renderer_name&gt;_Cleanup( CRef&amp; in_context )\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<div><p><a name=\"ContextAttributes\"> </a><a name=\"ContextAttributes_Renderers\"></a>	<table>		<tr>			<th>Attribute</th>\n\
		...
		<tr>			<td class=\"example\">RenderID</td>\n\
			<td>unsigned int</td>\n\
			<td>\n\
						(Optional) The unique identifier for this particular rendering job. \n\
						\n\
					</td>\n\
</tr>\n\
</table>\n\
