...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>BlendClipsInTextureLayers</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>BlendClipsInTextureLayers</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">BlendClipsInTextureLayers</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
...
attached to the given objects. Creates layers with the requested clips, and adds these\n\
layers on the located ports.<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = BlendClipsInTextureLayers( ClipList, [InputObjs], [SharedMatAction], [NotifyNoResult], [Mode], [Ambient], [Diffuse], [Transparency], [Reflection] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns the layers created as an <a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a>. If the value of Mode is siReplaceNoBlend,\n\
the first image shader is returned as a shader rather than a layer.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./files/listexpr.htm\">List</a> of clips to attach to the layers		</td>\n\
	</tr>\n\
	<tr>\n\
