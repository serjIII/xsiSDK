...
\n\
<h2 class=\"pagehead\">ImportDelta</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Imports a model delta object from a specific file. The file must be in a delta format \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = ImportDelta( FileName, Model, [Reference], [Interactive] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
\n\
		...
		Tip: You can also use the <a href=\"#!/url=./si_cmds/ImportReferencedDelta.html\">ImportReferencedDelta</a> command.\n\
		directly.\n\
