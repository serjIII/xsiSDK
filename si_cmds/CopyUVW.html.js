...
\n\
<h2 class=\"pagehead\">CopyUVW</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>Copies the UVs of the selected sampled points onto the clipboard.</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>CopyUVW( TextureProjection, [SubComp] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
 The texture projection to copy.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">SubComp		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Cluster of sampled points or tagged sampled points to copy 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
All sampled points			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
