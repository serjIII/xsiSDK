...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>BlendInTextureLayersInsp</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>BlendInTextureLayersInsp</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">BlendInTextureLayersInsp</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
...
<br /><br />\n\
Same as <a href=\"#!/url=./si_cmds/BlendInTextureLayers.html\">BlendInTextureLayers</a> except that it also inspects the \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = BlendInTextureLayersInsp( [PresetNames], [InputObjs], [SharedMatAction], [NotifyNoResult], [Mode], [Ambient], [Diffuse], [Transparency], [Reflection] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
\' returned by BlendInTextureLayersInsp and through the object\'s material.\n\
\'\n\
NewScene , false\n\
\' Create a default cube\n\
Set oBox = ActiveSceneRoot.AddGeometry( \"Cube\", \"MeshSurface\" )\n\
\' Apply Cloud and Gradient presets on all texture ports\n\
Set oLayers = BlendInTextureLayersInsp( \"Cloud,Gradient\", oBox, 1, False, False )\n\
