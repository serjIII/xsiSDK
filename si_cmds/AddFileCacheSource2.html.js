...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>AddFileCacheSource2</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>AddFileCacheSource2</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">AddFileCacheSource2</h2>\n\
\n\
<h3>Introduced</h3>\n\
...
CacheOnFileNode node in an ICE Tree, or by running the <a href=\"#!/url=./si_cmds/CacheObjectsIntoFile.html\">CacheObjectsIntoFile</a> \n\
command and then the <a href=\"#!/url=./si_cmds/CacheObjectsIntoFileDialog.html\">CacheObjectsIntoFileDialog</a> command. \n\
<br /><br />\n\
This function is similar to the <a href=\"#!/url=./si_cmds/.html\">.html</a> command but supports an additional SourceObject parameter\n\
for cache formats which support multiple objects like Alembic.\n\
<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>AddFileCacheSource2( [InputObj], [FileName], [DeployInMixer], [SourceObject], [Source] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
The object to be linked to the file cache			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current selection			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Full path of the new file cache source. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
User is prompted to select a file			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">DeployInMixer		</td>\n\
		<td><a href=\"#!/url=./files/Boolean.htm\">Boolean</a>		</td>\n\
		<td>\n\
 True to make available in the animation mixer. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
True			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Name of the object in the cache file to use (useful for cache files with an object hierarchy like Alembic) 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Empty			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Source		</td>\n\
		<td><a href=\"#!/url=./si_om/CollectionItem.html\">CollectionItem</a>Legacy		</td>\n\
		<td>\n\
 The new file cache source. 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"Python\">app = Application\n\
True = 1\n\
False = 0\n\
app.NewScene(\"\", False)\n\
...
rtn = app.AddFileCacheSource2(\"grid\", \"Simulation\\Scene_Root\\grid\\grid_Wave_[1..100].icecache\", true, \"\")\n\
...
# Now hit Playback\n\
app.PlayForwards()</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/AddFileCacheSource.html\">AddFileCacheSource</a> <a href=\"#!/url=./si_cmds/CacheObjectsIntoFile.html\">CacheObjectsIntoFile</a> <a href=\"#!/url=./si_cmds/CacheObjectsIntoFileDialog.html\">CacheObjectsIntoFileDialog</a> <a href=\"#!/url=./si_om/Source.html\">Source</a></p></div>\n\
\n\
