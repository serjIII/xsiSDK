...
\n\
<h2 class=\"pagehead\">Add2DShape</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Adds a 2D shape (mask shape) to the shape list of any <a href=\"#!/url=./si_om/FxOperator.html\">FxOperator</a>\n\
except Painterly Fx (for example, a Color Correct operator). <br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = Add2DShape( [ShapeList], ShapeType );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>The new 2D shape (mask shape) as a <a href=\"#!/url=./si_om/CollectionItem.html\">CollectionItem</a>Legacy.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		<td class=\"name\">ShapeList		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
<a href=\"#!/url=./files/paramexpr.htm\">Parameter path name</a> for the shape list where you are adding the new shape.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current selection. <br /><br />Note: If the current selection is not a valid list, an error occurs.			</p>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
Specifies the type of 2D shape.			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				<tr>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/Add2DShapePoint.html\">Add2DShapePoint</a> <a href=\"#!/url=./si_cmds/Add2DShapePointArray.html\">Add2DShapePointArray</a> <a href=\"#!/url=./si_cmds/Insert2DShapePoint.html\">Insert2DShapePoint</a> <a href=\"#!/url=./si_cmds/Move2DShape.html\">Move2DShape</a> <a href=\"#!/url=./si_cmds/Scale2DShape.html\">Scale2DShape</a> <a href=\"#!/url=./si_cmds/Move2DShapePin.html\">Move2DShapePin</a> <a href=\"#!/url=./si_cmds/Set2DShapeRotation.html\">Set2DShapeRotation</a> <a href=\"#!/url=./si_cmds/Move2DShapePoint.html\">Move2DShapePoint</a> <a href=\"#!/url=./si_cmds/Move2DShapeLHandle.html\">Move2DShapeLHandle</a> <a href=\"#!/url=./si_cmds/Move2DShapeRHandle.html\">Move2DShapeRHandle</a> <a href=\"#!/url=./si_cmds/Delete2DShapePoint.html\">Delete2DShapePoint</a> <a href=\"#!/url=./si_cmds/Key2DShapePoints.html\">Key2DShapePoints</a></p></div>\n\
\n\
