...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>SetCurrentCharacterKeySet</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>SetCurrentCharacterKeySet</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">SetCurrentCharacterKeySet</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Sets the name of the current character key set as a string in the \"CurrentCharacterKeySet\" \n\
property of the <a href=\"#!/url=./si_om/Scene.html\">Scene</a> object. You can also specify an empty string to \n\
clear the current current character key set.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SetCurrentCharacterKeySet( CharacterKeySet );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
The new current character key set			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
