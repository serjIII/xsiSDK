...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>AddMappingRule</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">AddMappingRule</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>Adds a rule to an existing connection or value mapping template.</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>AddMappingRule( MappingTemplate, From, [To], Index );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
 Mapping template to which a rule is added 		</td>\n\
	</tr>\n\
	<tr>\n\
 ...
 The Map To part of a connection mapping rule, the Expression part of a value mapping rule, or the Expr part of a clip value mapping rule. 		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Specifies where to insert the rule in the mapping template. Rules are numbered starting at 1, but an index of 0 or 1 refers to the first rule. If the index is greater than the size of the mapping template then the rule is added at the end. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
