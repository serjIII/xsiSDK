...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>Plug-in Manager Attributes</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Plug-in Manager Attributes</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">Plug-in Manager Attributes</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v5.0</p></div>\n\
\n\
<div>\n\
	<p>View attributes for the <a href=\"#!/url=./files/ManageLibraries__Dialog.htm\">Plug-in Manager</a>.  You can use these attributes when extending the functionality of the Plug-in Manager via its custom menu hooks. \n\
			Use of these attributes are demonstrated extensively inside the \"PluginTreeActions\" plug-in (installed under the <span style=\"font-family: courier, monospace;\">&lt;factory&gt;\\Addons\\sdkui\\Application\\Plugins</span> folder)..</p>\n\
<div class=\"tip\">\n\
...
The currently selected file or directory in the plug-in.  For example if the SPDL tab is active and a SPDL file is selected, then the complete path\n\
				to the SPDL file will be returned.  If more than one item is selected, only the first item in the list is returned.			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				<tr>\n\
				...
				<tr>\n\
					...
					<td>A valid path to a file or directory					</td>\n\
				</tr>\n\
			</table>\n\
		</td>\n\
		<td class=\"sa\">\n\
<a href=\"#!/url=./si_om/View.GetAttributeValue.html\">View.GetAttributeValue</a> only.</td>\n\
	...
	<tr>\n\
		<td class=\"example\">pluginitem</td>\n\
		<td>\n\
This attribute provides information about which specific Plug-in Item is selected in the Plug-in Manager.  \n\
				...
				when the selection is not a plug-in item.			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				<tr>\n\
					<td>						<p class=\"cell\"><span class=\"hilite\">Possible Values: </span>						</p>\n\
					</td>					<td>						<p class=\"cell\"><span class=\"hilite\">Description: </span>						</p>\n\
					</td>				</tr>\n\
				<tr>\n\
					<td class=\"name\">&lt;a string&gt;</td>\n\
					<td>Name and type of the Plug-in Item, encoded as TYPE::NAME, for example \"Property::PSetUIDemo\"					</td>\n\
				</tr>\n\
			</table>\n\
		</td>\n\
		<td class=\"sa\">\n\
<a href=\"#!/url=./si_om/View.GetAttributeValue.html\">View.GetAttributeValue</a> only.</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
Force the plug-in manager to rebuild its list of plug-ins.  This only impacts the currently active tab.			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				<tr>\n\
					<td>						<p class=\"cell\"><span class=\"hilite\">Possible Values: </span>						</p>\n\
					</td>					<td>						<p class=\"cell\"><span class=\"hilite\">Description: </span>						</p>\n\
					</td>				</tr>\n\
...
Get or Set the currently active tab of the plug-in manager.  For example \"Workgroups\", \"Tree\", \"SPDLs\".  This property is always in English,\n\
				even when the user interface is set to a different language.			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				<tr>\n\
					<td>						<p class=\"cell\"><span class=\"hilite\">Possible Values: </span>						</p>\n\
					</td>					<td>						<p class=\"cell\"><span class=\"hilite\">Description: </span>						</p>\n\
					</td>				</tr>\n\
