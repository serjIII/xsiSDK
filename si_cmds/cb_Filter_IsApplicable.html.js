...
\n\
<h2 class=\"pagehead\">IsApplicable</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
<div><p><a name=\"Description\"> </a>	<p>\n\
				Softimage uses the IsApplicable callback to determine whether to add subcomponent filters to the \n\
				filter list in the main command area. Softimage has its own default criteria for determining whether \n\
				a subcomponent filter is applicable to the current selection (basically, Softimage checks if the \n\
				selected objects have subcomponents). Softimage calls your IsApplicable callback only if its default \n\
...
<tr>\n\
<td class=\"example\"><pre class=\"cplusplus\">CStatus &lt;filter_name&gt;_IsApplicable( CRef&amp; in_context )\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">function &lt;filter_name&gt;_IsApplicable( in_context )\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\">def &lt;filter_name&gt;_IsApplicable( in_context ):\n\
	...</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">Function &lt;filter_name&gt;_IsApplicable( in_context )\n\
	...\n\
End Function</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"perlscript\">sub &lt;filter_name&gt;_IsApplicable \n\
{ \n\
	my $in_context = shift; \n\
}</pre></td></tr>\n\
</table>\n\
