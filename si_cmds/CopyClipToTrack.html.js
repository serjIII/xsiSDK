...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>CopyClipToTrack</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">CopyClipToTrack</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.5</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Copies a <a href=\"#!/url=./si_om/Clip.html\">Clip</a> within one <a href=\"#!/url=./si_om/Track.html\">Track</a>, or to \n\
another track of the same type within a <a href=\"#!/url=./si_om/Model.html\">Model</a>.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = CopyClipToTrack( Model, Clip, [Compound], Track, [Time] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
 ...
 The model owning the clip. Note: The parameter is ignored for the shot clip type. 		</td>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Source clip to copy. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Compound		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 The compound container (track owner) to copy the clip to. Note: The parameter is ignored for the shot clip type. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Track		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 The track to copy the clip to. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Time		</td>\n\
		<td><a href=\"#!/url=./files/Double.htm\">Double</a>		</td>\n\
		<td>\n\
 Frame to copy the clip to. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current frame.			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/MoveClipToTrack.html\">MoveClipToTrack</a> <a href=\"#!/url=./si_cmds/AddClip.html\">AddClip</a> <a href=\"#!/url=./si_cmds/AddTrack.html\">AddTrack</a></p></div>\n\
\n\
