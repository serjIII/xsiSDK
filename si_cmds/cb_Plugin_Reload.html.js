...
<div><p><a name=\"Description\"> </a>	<p>\n\
	...
	<p>\n\
				...
				Cached check. This unloads the plug-in (the .dll/.so file, or the script file) from memory, but does not \n\
				\"unload\" the plug-in from Softimage. The <a href=\"#!/url=./si_om/Plugin.html\">Plugin</a> and <a href=\"#!/url=./si_om/PluginItem.html\">PluginItem</a> objects still \n\
				exist in Softimage, and the plug-in is still registered. \n\
			</p>\n\
	<p>\n\
				When a plug-in is not cached, it is loaded and unloaded every time a plug-in item (such as a command) is \n\
				invoked. This triggers the Reload and <a href=\"#!/url=./si_cmds/cb_Plugin_Unload.html\">Unload</a> callbacks.\n\
			</p>\n\
</p></div>\n\
\n\
<hr width=\"100%\" />\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"cplusplus\">CStatus &lt;plugin-item_name&gt;_Reload( CRef&amp; in_context ) \n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">function &lt;plugin-item_name&gt;_Reload( in_context ) \n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\">def &lt;plugin-item_name&gt;_Reload( in_context ):\n\
	...</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">Function &lt;plugin-item_name&gt;_Reload( in_context )\n\
	...\n\
End Function</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"perlscript\">sub &lt;plugin-item_name&gt;_Reload \n\
{ \n\
	my $in_context = shift; \n\
}</pre></td></tr>\n\
</table>\n\
</div>	<p><span style=\"font-family: courier, monospace;\">&lt;plugin-item-name&gt;</span> is the name used to register the plug-in item in \n\
...
<div><p><a name=\"SeeAlso\"> </a><ul>\n\
	<li><a href=\"#!/url=./si_cmds/cb_Plugin_Unload.html\">Unload</a></li>\n\
