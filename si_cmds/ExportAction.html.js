...
\n\
<h2 class=\"pagehead\">ExportAction</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Exports the specified action to a file. The file formats accepted by this command are: <br /><br />\n\
- External Softimage Native Binary Action (\".eani\") files.<br /><br />\n\
- dotXSI Action (\".xsi\") files.<br /><br />\n\
- Softimage Preset Action(\".Preset\") files.<br /><br /></p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ExportAction( Action, [FileName] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a> or <a href=\"#!/url=./si_om/ActionSource.html\">ActionSource</a>		</td>\n\
		<td>\n\
 Action to export. 		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td>\n\
 The full path to export to. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
User is prompted to select location and enter a file name			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/ImportAction.html\">ImportAction</a></p></div>\n\
\n\
