...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>SIGetPrimLight</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">SIGetPrimLight</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SIGetPrimLight( PresetObj, [Name], [Parent], [3DObject], [3DObjSpotInterest], [PrimObj], [PrimObjSpotInterest] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Any preset for the <a href=\"#!/url=./si_cmds/LightPrimitives.html#\">Light Primitives</a>		</td>\n\
 ...
 Parent <a href=\"#!/url=./files/objectexpr.htm\">object</a> for the light. 		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Returns the light object. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">3DObjSpotInterest		</td>\n\
		<td><a href=\"#!/url=./si_om/Null.html\">Null</a>		</td>\n\
		<td>\n\
 Returns the interest for Spot and Light_Box lights (or Nothing for all other types). 		</td>\n\
	</tr>\n\
	<tr>\n\
 ...
 Returns the light primitive. 		</td>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./si_om/Primitive.html\">Primitive</a>		</td>\n\
		<td>\n\
 Returns the spot interest primitive for Spot and Light_Box lights (or Nothing for all other types). 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">SIGetPrimLight \"Infinite\", \"MyLight\"</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/GetPrimLight.html\">GetPrimLight</a> <a href=\"#!/url=./si_cmds/SIGetPrimSpotLight.html\">SIGetPrimSpotLight</a></p></div>\n\
\n\
