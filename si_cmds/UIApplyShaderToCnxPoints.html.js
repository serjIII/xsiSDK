...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>UIApplyShaderToCnxPoints</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>UIApplyShaderToCnxPoints</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">UIApplyShaderToCnxPoints</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Pops up a menu of shader presets to let the user select one, then instantiates \n\
this shader and connects it to the specified connection points of another \n\
shader through intermediate Mix 2 Colors shaders. <br /><br />\n\
Note: The command fails if the selected shader cannot be connected to the \n\
connection points because of connection type mismatch or because shaders \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>UIApplyShaderToCnxPoints( [InputObj], [InputObjs], [X], [Y] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>		</td>\n\
		<td>\n\
This parameter is NOT USED.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">InputObjs		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
<a href=\"#!/url=./files/listexpr.htm\">List</a> of connection points 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current Selection			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td>\n\
 X screen coordinate of menu (from left of screen) 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/Long.htm\">Long</a>		</td>\n\
		<td>\n\
 Y screen coordinate of menu (from top of screen) 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
