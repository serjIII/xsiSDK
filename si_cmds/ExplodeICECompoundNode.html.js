...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>ExplodeICECompoundNode</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ExplodeICECompoundNode</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">ExplodeICECompoundNode</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Explodes the <a href=\"#!/url=./si_om/ICECompoundNode.html\">ICECompoundNode</a> into its parent\'s container.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ExplodeICECompoundNode( [InputObj], [OutputObjs] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
Node to explode.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If not specified, the user is prompted to make a selection.			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
\n\
		Contents of the former compound (as <a href=\"#!/url=./si_om/ICENode.html\">ICENode</a> \n\
		and/or <a href=\"#!/url=./si_om/ICECompoundNode.html\">ICECompoundNode</a> objects).\n\
			</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
