...
\n\
<h2 class=\"pagehead\">RenderFxOp</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Renders an <a href=\"#!/url=./si_om/FxOperator.html\">FxOperator</a> of the \'File Output\' type. <br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>RenderFxOp( [InputObj], [Interactive] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Current selection. <br /><br />Note: If the current selection is not a valid FxOperator, an error occurs.			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
If set to True, a dialog box appears asking the user to start the rendering.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
False			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\' This example creates an FxTree, two FxOperators, connects\n\
...
RenderFxOp oFxOp2, False</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
