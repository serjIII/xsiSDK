...
\n\
<h2 class=\"pagehead\">Evaluate</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
<div><p><a name=\"Description\"> </a>	<p>\n\
				The Evaluate callback is where a custom <a href=\"#!/url=./si_cpp/classXSI_1_1ICENode.html\">ICENode</a> performs the main \n\
				computation. The Evaluate callback uses the <a href=\"#!/url=./si_cpp/classXSI_1_1ICENodeContext.html\">ICENodeContext</a>\n\
				object to get the input and output port data.\n\
			</p>\n\
<div class=\"tip\">\n\
<table cellpadding=\"5\" cellspacing=\"5\">\n\
	<tr>\n\
		...
		<td class=\"emph\">\n\
				The user data stored in <a href=\"#!/url=./si_cmds/cb_ICENode_BeginEvaluate.html\">BeginEvaluate</a> or \n\
				<a href=\"#!/url=./si_cmds/cb_ICENode_Init.html\">Init</a> is always accessible from the Evaluate callback. However, unless the \n\
				custom node threading mode is single-threading, the <a href=\"#!/url=./si_cpp/classXSI_1_1Context.html#PutUserData\">Context::PutUserData</a> \n\
...
<tr>\n\
<td class=\"example\"><pre class=\"cplusplus\">CStatus &lt;icenode_name&gt;_Evaluate( CRef&amp; in_context )\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
