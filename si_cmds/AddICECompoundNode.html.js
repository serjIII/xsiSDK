...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>AddICECompoundNode</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>AddICECompoundNode</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">AddICECompoundNode</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>Adds an <a href=\"#!/url=./si_om/ICECompoundNode.html\">ICECompoundNode</a> to an ICE tree.</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = AddICECompoundNode( File, [Container] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>The new <a href=\"#!/url=./si_om/ICECompoundNode.html\">ICECompoundNode</a>.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
A path to the definition file of the compound node. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Container		</td>\n\
		<td><a href=\"#!/url=./files/listexpr.htm\">Selection list</a>		</td>\n\
		<td>\n\
The ICE tree to which we\'re adding the compound node.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If not specified, the user is prompted to select an ICE tree.			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
