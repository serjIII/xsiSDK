...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>CreateEventWizard</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">CreateEventWizard</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.5</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Creates an instance of an event wizard you can use to generate self-installing event plug-ins. The resulting wizard \n\
is a <a href=\"#!/url=./si_om/CustomProperty.html\">CustomProperty</a> nested under the SDK wizard model which itself resides under the scene root.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = CreateEventWizard( [DestinationDir] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Newly created event wizard as a <a href=\"#!/url=./si_om/CustomProperty.html\">CustomProperty</a> object.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
