...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>Fx Tree Attributes</title>\n\
   \n\
</head>\n\
...
<div><table class=\"values\">\n\
	...
	<tr>\n\
		...
		<td>\n\
Returns or sets the Fx Tree displayed in the view. If more than one item is specified, only the first valid FX Tree is displayed.			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				<tr>\n\
					<td>						<p class=\"cell\"><span class=\"hilite\">Possible Values: </span>						</p>\n\
					</td>					<td>						<p class=\"cell\"><span class=\"hilite\">Description: </span>						</p>\n\
					</td>				</tr>\n\
				<tr>\n\
					<td class=\"name\">&lt;Fx Tree name&gt;</td>\n\
					<td>The <a href=\"#!/url=./si_om/SIObject.FullName.html\">SIObject.FullName</a> of the <a href=\"#!/url=./si_om/FxTree.html\">FxTree</a>.					</td>\n\
				</tr>\n\
			</table>\n\
		</td>\n\
		<td class=\"sa\">\n\
