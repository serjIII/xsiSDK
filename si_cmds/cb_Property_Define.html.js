...
\n\
<h2 class=\"pagehead\">Define</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
<div><p><a name=\"Description\"> </a>	<p>\n\
				Defines the property set (either standalone or associated with a self-installed custom operator), including \n\
				all parameters that underlie the controls on the property page. Use this callback to build a set of parameters \n\
				that will appear in the property page. This is where you define the number of parameters, their type, any \n\
				defaults, value limitations, and so on.\n\
			</p>\n\
	<p>\n\
				This callback is fired when you instantiate the property on a scene item (for example, using \n\
				<a href=\"#!/url=./si_om/SceneItem.AddProperty.html\">SceneItem.AddProperty</a> on the scene root or a cube in the scene). \n\
			</p>\n\
<div class=\"tip\">\n\
<table cellpadding=\"5\" cellspacing=\"5\">\n\
	<tr>\n\
		...
		<td class=\"emph\">\n\
				For parameters defined on custom operators, this is only called for new operators, not operators being loaded \n\
				out of a scene file. This behavior differs from that of the \n\
				<a href=\"#!/url=./si_cmds/cb_Operator_Init.html\">Init (Operator)</a> callback.\n\
			</td>\n\
	</tr>\n\
</table>\n\
</div>\n\
...
<div><p><a name=\"Parameters\"> </a>	<table>		<tr>			<th>Parameter</th>\n\
		...
		<tr>			<td class=\"name\">in_context</td>\n\
			...
			<td><a href=\"#!/url=./si_om/Context.Source.html\">Context.Source</a> returns the <a href=\"#!/url=./si_om/CustomProperty.html\">CustomProperty</a> or \n\
					<a href=\"#!/url=./si_om/CustomOperator.html\">CustomOperator</a>. </td>\n\
</tr>\n\
		<tr>			<td class=\"name\"></td>\n\
			<td>C++</td>\n\
			<td><a href=\"#!/url=./si_cpp/classXSI_1_1CRef.html\">CRef</a>& </td>\n\
			<td>A reference to the <a href=\"#!/url=./si_cpp/classXSI_1_1CustomProperty.html\">CustomProperty</a> or \n\
					<a href=\"#!/url=./si_cpp/classXSI_1_1CustomOperator.html\">CustomOperator</a>.</td>\n\
</tr>\n\
</table>\n\
</p></div>\n\
\n\
