...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>OnHeaderDoubleClick (GridData)</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>OnHeaderDoubleClick (GridData)</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">OnHeaderDoubleClick (GridData)</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">function &lt;property_name&gt;_&lt;parameter_name&gt;_OnHeaderDoubleClick()\n\
{\n\
...\n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\">def &lt;property_name&gt;_&lt;parameter_name&gt;_OnHeaderDoubleClick():\n\
				...</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">Function &lt;property_name&gt;_&lt;parameter_name&gt;_OnHeaderDoubleClick()\n\
				...\n\
End Function</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"perlscript\">sub &lt;property_name&gt;_&lt;parameter_name&gt;_OnHeaderDoubleClick\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<div><p><a name=\"Parameters\"> </a>	<table>		<tr>			<th>Parameter</th>\n\
		...
		<tr>			<td class=\"name\">extra_param</td>\n\
          ...
          Indices are arranged as [col1, row1, col2, row2, ...]. Row values are always -1 for this event.\n\
        </td>\n\
</tr>\n\
</table>\n\
</p></div>\n\
...
def MyProperty_OnClosed( ):\n\
	pass\n\
\n\
def MyProperty_MyGrid_OnHeaderDoubleClick( in_ExtraParams ):\n\
	param = PPG.MyGrid\n\
	gridData = param.Value\n\
	\n\
	# Just log the header that was double-clicked\n\
	columnRowPair = in_ExtraParams[0]\n\
	col = columnRowPair[0]\n\
	row = columnRowPair[1]\n\
	\n\
	if col == -1:\n\
		# A row header was double-clicked\n\
		Application.LogMessage(\"Row %d header was double-clicked\"%row)\n\
	else:\n\
		# A column header was double-clicked\n\
		Application.LogMessage(\"Column %d header was double-clicked\"%col)</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<hr width=\"100%\" />\n\
