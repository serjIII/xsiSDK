...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>RenderRegionClose</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">RenderRegionClose</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Closes a render region, if one exists, in the specified viewport(s). The\n\
region releases all current render data, such that if it were to be opened\n\
again in the same viewport with no changes to the scene, it would need to\n\
re-render.\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>RenderRegionClose( [Viewport] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
The viewport(s) containing the render region to close.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">// Closes a render region in the viewport that has the current focus.\n\
RenderRegionClose( siViewportFocussed );</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
