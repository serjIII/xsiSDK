...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>CreateEmptyConnectionMap</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>CreateEmptyConnectionMap</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">CreateEmptyConnectionMap</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Creates an empty connection mapping template. This is a shortcut for calling \n\
SceneItem.AddProperty(\"MappingTemplate\"), but it is recommended that you use\n\
the <a href=\"#!/url=./si_cmds/CreateConnectionMap.html\">CreateConnectionMap</a> for scripting.\n\
<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>CreateEmptyConnectionMap( Obj1, [MappingTemplate] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./files/objectexpr.htm\">Root</a> of the \n\
		target hierarchy on which to create the connection map.\n\
		<br /><br />\n\
		Note: The mixer under this object\'s model will be the owner of the \n\
		newly created connection map. \n\
