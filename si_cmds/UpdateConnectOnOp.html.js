...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>UpdateConnectOnOp</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">UpdateConnectOnOp</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>UpdateConnectOnOp( Operator, GroupIndex, GroupInstanceIndex, InputObjs, AlreadyRefined, ForceDisconnect );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/objectexpr.htm\">Object</a>		</td>\n\
		<td>\n\
 The operator 		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td>\n\
 Id of the type of the group 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">GroupInstanceIndex		</td>\n\
		<td><a href=\"#!/url=./files/Integer.htm\">Integer</a>		</td>\n\
		<td>\n\
 The id of the group instance 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td>\n\
 List of objects to connect 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">AlreadyRefined		</td>\n\
		<td><a href=\"#!/url=./files/Boolean.htm\">Boolean</a>		</td>\n\
		<td>\n\
 Specifies whether the list of objects is already refined or not 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">ForceDisconnect		</td>\n\
		<td><a href=\"#!/url=./files/Boolean.htm\">Boolean</a>		</td>\n\
		<td>\n\
 Specifies the behavior of the command when it encounters an empty connection. If it\'s TRUE and the port corresponding to the empty elem ref is optional, that port will be disconnected, in all other cases it won\'t do anything. 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
