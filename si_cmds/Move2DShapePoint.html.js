...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Move2DShapePoint</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">Move2DShapePoint</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Moves the position of a point on a 2D shape (mask shape). This is the scripting \n\
equivalent of clicking on the Edit Points tool (in the ColorCorrect property \n\
editor), and then clicking and dragging on a point on the shape to move it. <br /><br />\n\
Note: You can also use the <a href=\"#!/url=./si_cmds/Move2DShapeLHandle.html\">Move2DShapeLHandle</a> and \n\
<a href=\"#!/url=./si_cmds/Move2DShapeRHandle.html\">Move2DShapeRHandle</a> commands to adjust a Bezier shape with \n\
its handles. \n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Move2DShapePoint( [Shape], [index], [x], [y] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./files/paramexpr.htm\">Parameter path name</a> for the shape where you are moving the point.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current selection. <br /><br />Note: If the current selection is not a valid shape, an error occurs.			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
Specifies the index of the point to delete.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If no value is specified for this argument, the first point in the shape is deleted.			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">x		</td>\n\
		...
		<td>\n\
Specifies the new position in X for the point.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/Double.htm\">Double</a>		</td>\n\
		<td>\n\
Specifies the new position in Y for the point.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
