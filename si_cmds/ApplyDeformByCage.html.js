...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ApplyDeformByCage</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">ApplyDeformByCage</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v2.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Applies a deformation by cage. Cage deformations allow you to use a\n\
low-resolution geometry to drive the deformation of a high-resolution\n\
object. They are similar to arbitrarily shaped lattices. <br /><br />\n\
Each point on the deformed object is weighted to the points or polygons\n\
on the cage, similarly to how an envelope\'s points are weighted to its\n\
deformers. However, you cannot paint the weight assignments nor adjust\n\
them manually. You can also have multiple cage deformations on the same\n\
object, unlike envelopes.<br /><br />\n\
This is the equivalent of using the <a href=\"#!/url=./si_cmds/ApplyOp.html\">ApplyOp</a> command\n\
with the CageDeform operator.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = ApplyDeformByCage( [ConnectionSet], [ConstructionMode] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
 ...
 \n\
		...
		<br /><br />\n\
		The first group of the ConnectionSet contains vertex based objects. \n\
		The second group of the ConnectionSet contains the deformer (cage) objects. \n\
		<br /><br />			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
