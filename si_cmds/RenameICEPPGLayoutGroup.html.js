...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>RenameICEPPGLayoutGroup</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>RenameICEPPGLayoutGroup</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">RenameICEPPGLayoutGroup</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v13.0 (2015)</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>Renames the layout group in <a href=\"#!/url=./si_om/ICECompoundNode.html\">ICECompoundNode</a>.</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>RenameICEPPGLayoutGroup( Compound, Name, [NewName] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
<a href=\"#!/url=./si_om/ICECompoundNode.html\">ICECompoundNode</a> which you want to edit.		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
 The name of the PPG layout group that you want to rename.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">NewName		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 New name for the PPG layout group. Note: When the name already exists, the new name will be appended an index\n\
...
# This example shows how to rename the layout group in ICE compound.\n\
#\n\
...
# Rename the \"Initial Values\" ppg layout group \n\
si.RenameICEPPGLayoutGroup( \"pointcloud.pointcloud.ICETree.Emit_from_Geometry\", \"Initial Values\", \"General Values\" )</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
