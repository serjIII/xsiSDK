...
\n\
<h2 class=\"pagehead\">EndEvaluate</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
<div><p><a name=\"Description\"> </a>	<p>\n\
				...
				undo the work performed in <a href=\"#!/url=./si_cmds/cb_ICENode_BeginEvaluate.html\">BeginEvaluate</a>. The EndEvaluate callback \n\
				uses the <a href=\"#!/url=./si_cpp/classXSI_1_1ICENodeContext.html\">ICENodeContext</a> object to clean up the user data stored \n\
...
<table cellpadding=\"5\" cellspacing=\"5\">\n\
	<tr>\n\
		...
		<td class=\"emph\">\n\
				The input and output ports cannot be accessed at all through the <a href=\"#!/url=./si_cpp/classXSI_1_1ICENodeContext.html\">ICENodeContext</a>\n\
				object in this callback. The <a href=\"#!/url=./si_cmds/cb_ICENode_Evaluate.html\">Evaluate</a> callback can access both input and \n\
...
<tr>\n\
<td class=\"example\"><pre class=\"cplusplus\">CStatus &lt;icenode_name&gt;_EndEvaluate( CRef&amp; in_context )\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
