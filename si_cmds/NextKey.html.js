...
\n\
<h2 class=\"pagehead\">NextKey</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Moves current frame to the next key frame for the given animation \n\
parameters. If InputObjs argument is left blank (skipped), current \n\
selected and marked parameters are used.<br /><br />\n\
This is the scripting equivalent of selecting Next Key from the animation\n\
pop-up menu (or pressing Ctrl+Right with the default keyboard layout). \n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oDouble = NextKey( [InputObjs], [Time], [Tolerance], [Layer] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>\n\
Returns the frame number of the next key frame as a <a href=\"#!/url=./files/Double.htm\">Double</a>. \n\
If there is no key then the following is returned: <br /><br />\n\
\"1.#INF\" for C++, \"1.#INF\" for VBScript <br /><br />\n\
...
Currently selected and marked parameters			</p>\n\
	...
	<tr>\n\
		...
		<td>Number		</td>\n\
		<td>\n\
Move to the next key after this frame. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current frame			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
