...
\n\
<h2 class=\"pagehead\">Move2DShape</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Moves the position of a shape and its pin. This is the scripting equivalent of\n\
selecting the Select Shapes tool in the ColorCorrect property page shape, \n\
and then clicking and dragging a shape around the Fx Viewer. <br /><br />\n\
Note: To move the center, or pin, of the shape, use the <a href=\"#!/url=./si_cmds/Move2DShapePin.html\">Move2DShapePin</a>\n\
command instead.\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>Move2DShape( [Shape], x, y );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./files/paramexpr.htm\">Parameter path name</a> for the shape you are moving.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current selection. <br /><br />Note: If the current selection is not a valid shape, an error occurs.			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
Specifies the new position of the point in X.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">y		</td>\n\
		<td><a href=\"#!/url=./files/Double.htm\">Double</a>		</td>\n\
		<td>\n\
Specifies the new position of the point in Y.		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
Move2DShape oRotospline, 56, 44</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/Add2DShape.html\">Add2DShape</a> <a href=\"#!/url=./si_cmds/Scale2DShape.html\">Scale2DShape</a> <a href=\"#!/url=./si_cmds/Move2DShapePin.html\">Move2DShapePin</a> <a href=\"#!/url=./si_cmds/Set2DShapeRotation.html\">Set2DShapeRotation</a></p></div>\n\
\n\
