...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>PlotFrameSetToActions</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>PlotFrameSetToActions</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">PlotFrameSetToActions</h2>\n\
\n\
<h3>Introduced</h3>\n\
...
<h3>Description</h3>\n\
<div><p>\n\
Creates and returns new actions by plotting values from a frame set\n\
consisting of frame numbers. Actions are created under models containing animated \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = PlotFrameSetToActions( [InputObj], [Name], [StartFrame], FrameSet, [FCurve Kind], [DefaultSegKind], [Fit FCurve], [Fit Tolerance], [ProcessContRots] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
