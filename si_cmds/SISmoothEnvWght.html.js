...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>SISmoothEnvWght</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">SISmoothEnvWght</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v2.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Smooths the weighting of envelope points. An envelope is an object\n\
or hierarchy that is assigned as a \"skin\" to a set of deformers\n\
such as IK chains. Envelopes move and deform in response to the\n\
movements of their deformers. In this way, for example, a character\n\
moves as you animate its skeleton. <br /><br />\n\
Every point in an envelope is assigned to one or more deformers. For\n\
each point, weights control the relative influence of its deformers.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = SISmoothEnvWght( PropObj, [SubComp] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
