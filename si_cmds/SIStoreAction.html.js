...
\n\
<h2 class=\"pagehead\">SIStoreAction</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = SIStoreAction( [Model], [InputObj], [Mode], [Name], [RemoveAnim], [Consider Time], [StartFrame], [EndFrame], [Ripple], [IncludeAnimLayers] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
False			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Frame to start copying/cutting from.  Only used if \"ConsiderTime\" is true. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">EndFrame		</td>\n\
		<td><a href=\"#!/url=./files/Double.htm\">Double</a>		</td>\n\
		<td>\n\
 Frame to end copying/cutting from.  Only used if \"ConsiderTime\" is true. 		</td>\n\
	</tr>\n\
	<tr>\n\
