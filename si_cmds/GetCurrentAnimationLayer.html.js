...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>GetCurrentAnimationLayer</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>GetCurrentAnimationLayer</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">GetCurrentAnimationLayer</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Returns the current animation layer for the specified objects.\n\
A return value of -1 indicates that the objects have different\n\
current animation layers which can happen when the selection contains objects\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oLong = GetCurrentAnimationLayer( [InputObjs] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
\'INFO : Current animation layer after  : 1</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
