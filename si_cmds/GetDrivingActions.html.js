...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>GetDrivingActions</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">GetDrivingActions</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.5</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = GetDrivingActions( [InputObjs], [Consider Time], [Time], [Keep Compound Actions], [Keep Inactive Actions] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns the actions that are driving the objects (a <a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a> object).</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Current selection			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Whether to only return actions active at supplied time 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
False			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
Current frame.			</p>\n\
	...
	<tr>\n\
		<td class=\"name\">Keep Compound Actions		</td>\n\
		<td><a href=\"#!/url=./files/Boolean.htm\">Boolean</a>		</td>\n\
		<td>\n\
 Whether to return compound actions 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
True			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Keep Inactive Actions		</td>\n\
		<td><a href=\"#!/url=./files/Boolean.htm\">Boolean</a>		</td>\n\
		<td>\n\
 Whether to return inactive actions 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
False			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/SelectActionsFromObjects.html\">SelectActionsFromObjects</a> <a href=\"#!/url=./si_cmds/SelectObjectsFromAction.html\">SelectObjectsFromAction</a> <a href=\"#!/url=./si_om/ShapeClip.html\">ShapeClip</a></p></div>\n\
\n\
