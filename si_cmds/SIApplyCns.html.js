...
\n\
<h2 class=\"pagehead\">SIApplyCns</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Constrains an object to one or more constraining objects. Constraints are placed under the kinematics\n\
property of the constrained object. SIApplyCns differs from <a href=\"#!/url=./si_cmds/ApplyCns.html\">ApplyCns</a> in that it does not display the\n\
constraint\'s property page.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = SIApplyCns( PresetObj, [ConstrainedObj], [ConstrainingObj], [Compensation] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns an <a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a> of <a href=\"#!/url=./si_om/Constraint.html\">Constraint</a> objects.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./files/listexpr.htm\">List</a> of objects to be constrained. \n\
		If you pass in a variable, the command returns a <a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a> of the \n\
		constrained <a href=\"#!/url=./si_om/X3DObject.html\">X3DObject</a>s. \n\
...
Selected objects			</p>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
<a href=\"#!/url=./files/listexpr.htm\">List</a> of constraining objects.  If \n\
		you pass in a variable, the command returns a <a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a> of the \n\
		constraining <a href=\"#!/url=./si_om/X3DObject.html\">X3DObject</a>s. \n\
				<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/SIApplyConstraint.html\">SIApplyConstraint</a> <a href=\"#!/url=./si_cmds/RemoveAllCns.html\">RemoveAllCns</a> <a href=\"#!/url=./si_cmds/RemoveCns.html\">RemoveCns</a></p></div>\n\
\n\
