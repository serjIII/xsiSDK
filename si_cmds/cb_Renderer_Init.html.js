...
\n\
<h2 class=\"pagehead\">Init (Renderer)</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
<div><p><a name=\"Description\"> </a>	<p>\n\
				This callback is called when the Render Manager needs the plug-in to describe what operations the renderer can \n\
				perform, which <a href=\"#!/url=./files/cus_render_RegisteringFileFormat.htm\">file formats it supports</a>, any \n\
				<a href=\"#!/url=./files/cus_render_RegisteringProperties.htm\">properties it provides</a>, and, in case it supports \n\
				exporting, which file extension to use for archives.\n\
			</p>\n\
	<p>\n\
				The plug-in must provide at least one process type, one file format and register a property to use to control the \n\
				renderer (with the <a href=\"#!/url=./si_om/siRenderPropertyType.html#siRenderPropertyOptions\">siRenderPropertyOptions</a> enumeration value). If any of \n\
				these are missing, the registration fails. \n\
			</p>\n\
</p></div>\n\
\n\
<hr width=\"100%\" />\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"cplusplus\">CStatus &lt;renderer_name&gt;_Init( CRef&amp; in_context )\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
