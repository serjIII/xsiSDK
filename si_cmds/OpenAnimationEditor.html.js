...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>OpenAnimationEditor</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>OpenAnimationEditor</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">OpenAnimationEditor</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v2.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Opens the animation editor with the animation view (right-hand side) set to the input view.  The animation tree \n\
(left-hand side) shows the input object(s) with the input parameters already selected.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>OpenAnimationEditor( [AnimationView], [InputObjs] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		<td class=\"name\">AnimationView		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Which animation view to show in the animation editor (for example \"FCurve Editor\").			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
None - the Animation Editor itself will determine which animation view to show			</p>\n\
			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				...
				<tr>\n\
					<td class=\"name\">Standalone DopeSheet					</td>\n\
...
OpenAnimationEditor( \"Standalone DopeSheet\", oAnimObj + \"/.kine.local.pos\" );</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
