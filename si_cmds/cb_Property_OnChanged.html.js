...
\n\
<h2 class=\"pagehead\">OnChanged</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
<div><p><a name=\"Description\"> </a>	<p>\n\
				This callback is fired when the user changes a parameter value in a property page control (for example, by \n\
				selecting an item from a drop-down list, changing the value in a field, or selecting a check box).\n\
			</p>\n\
	<p>\n\
				Note that changing the contents of a list box (setting <a href=\"#!/url=./si_om/PPGItem.UIItems.html\">PPGItem.UIItems</a> property) does not \n\
				trigger an OnChanged callback. \n\
			</p>\n\
	<p>\n\
				To access the property page from the callback code, use the <a href=\"#!/url=./si_om/PPG.html\">PPG</a> object. \n\
			</p>\n\
</p></div>\n\
\n\
<hr width=\"100%\" />\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">function &lt;property_name&gt;_&lt;parameter_name&gt;_OnChanged()\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\">def &lt;property_name&gt;_&lt;parameter_name&gt;_OnChanged():\n\
	...</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">Function &lt;property_name&gt;_&lt;parameter_name&gt;_OnChanged()\n\
	...\n\
End Function</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"perlscript\">sub &lt;property_name&gt;_&lt;parameter_name&gt;_OnChanged \n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">// Enable/disable a text box based on the state of a check box\n\
