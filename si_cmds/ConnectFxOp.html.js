...
\n\
<h2 class=\"pagehead\">ConnectFxOp</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Connects the output of the <a href=\"#!/url=./si_om/FxOperator.html\">FxOperator</a> to the specified input of a destination FxOperator.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ConnectFxOp( [Op1], [Op2], [Connection] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Current selection. <br /><br />Note: If the current selection is not a valid FxOperator, an error occurs.			</p>\n\
	...
	<tr>\n\
		<td class=\"name\">Op2		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a> or <a href=\"#!/url=./si_om/FxOperator.html\">FxOperator</a>		</td>\n\
		<td>\n\
Object pointer or <a href=\"#!/url=./files/objectexpr.htm\">Object name</a> for FxOperator to connect to.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current selection. <br /><br />Note: If the current selection is not a valid FxOperator, an error occurs.			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\' This example creates an FxTree, adds two operators\n\
\' to it and then connects them.\n\
set oTree = CreateFxTree()\n\
set oSrc = AddFxOp( oTree, \"File Input\" )\n\
set oDest = AddFxOp( oTree, \"BoxBlur\" )\n\
ConnectFxOp oSrc, oDest, \"1\"</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
