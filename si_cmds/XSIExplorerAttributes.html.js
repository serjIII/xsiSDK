...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>XSI Explorer Attributes</title>\n\
   \n\
</head>\n\
...
<div><table class=\"values\">\n\
	...
	<tr>\n\
		...
		<td>\n\
The element to display (for setting) or currently on display (for getting) in the scene explorer inside the left pane of the xsi explorer. Only available when using Selection or Custom scopes.			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				<tr>\n\
					<td>						<p class=\"cell\"><span class=\"hilite\">Possible Values: </span>						</p>\n\
					</td>					<td>						<p class=\"cell\"><span class=\"hilite\">Description: </span>						</p>\n\
					</td>				</tr>\n\
				<tr>\n\
					<td class=\"name\">&lt;any element&gt;</td>\n\
...
<a href=\"#!/url=./si_om/View.SetAttributeValue.html\">View.SetAttributeValue</a> only.</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
The viewer to display in the right pane when the XSI Explorer is displayed.			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				<tr>\n\
					<td>						<p class=\"cell\"><span class=\"hilite\">Possible Values: </span>						</p>\n\
					</td>					<td>						<p class=\"cell\"><span class=\"hilite\">Description: </span>						</p>\n\
					</td>				</tr>\n\
				<tr>\n\
					<td class=\"name\">&lt;any viewer name&gt;</td>\n\
					<td>The name of the viewer as it appears on the Viewer menu of an XSI Explorer, for example, \"Schematic\", \"Object View\", etc.					</td>\n\
				</tr>\n\
			</table>\n\
		</td>\n\
		<td class=\"sa\">\n\
