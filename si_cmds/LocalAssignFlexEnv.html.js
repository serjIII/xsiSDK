...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>LocalAssignFlexEnv</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>LocalAssignFlexEnv</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">LocalAssignFlexEnv</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = LocalAssignFlexEnv( [SubComp], [ConnectionSet], [NbDeformersPerPoint] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns a <a href=\"#!/url=./si_om/XSICollection.html\">XSICollection</a> that contains the envelope assignment operators.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Currently selected objects are used as the main group.<br /><br />Warning: An error occurs if the connection set is invalid. Please verify the connection set required for this operator to avoid breaking your scripts.			</p>\n\
	...
	<tr>\n\
		<td class=\"name\">NbDeformersPerPoint		</td>\n\
		<td><a href=\"#!/url=./files/Integer.htm\">Integer</a>		</td>\n\
		<td>\n\
 The maximum number of deformers that will affect each point during assignment. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
2			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
...
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/ApplyFlexEnv.html\">ApplyFlexEnv</a> <a href=\"#!/url=./si_cmds/SILocalAssignFlexEnv.html\">SILocalAssignFlexEnv</a> <a href=\"#!/url=./si_cmds/SIApplyFlexEnv.html\">SIApplyFlexEnv</a> <a href=\"#!/url=./si_om/Envelope.html\">Envelope</a></p></div>\n\
\n\
