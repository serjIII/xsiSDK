...
\n\
<h2 class=\"pagehead\">LastKey</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Moves to the last key frame for the given parameters.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oDouble = LastKey( [InputObjs], [Time], [Layer] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns the frame number of the last key frame as a <a href=\"#!/url=./files/Double.htm\">Double</a>.\n\
