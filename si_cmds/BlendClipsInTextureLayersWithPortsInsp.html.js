...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>BlendClipsInTextureLayersWithPortsInsp</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>BlendClipsInTextureLayersWithPortsInsp</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">BlendClipsInTextureLayersWithPortsInsp</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Creates and returns layers with the requested clips, and adds the provided ports to the layers.<br /><br />\n\
If a source is provided, a clip is automatically created and connected.<br /><br />\n\
Note: This command is the same as <a href=\"#!/url=./si_cmds/BlendClipsInTextureLayersWithPorts.html\">BlendClipsInTextureLayersWithPorts</a> except \n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = BlendClipsInTextureLayersWithPortsInsp( ClipList, [InputObjs] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<a href=\"#!/url=./files/listexpr.htm\">List</a> of clips to connect 		</td>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
<a href=\"#!/url=./files/listexpr.htm\">List</a> of shader connections to add the layers to.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current selection			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
