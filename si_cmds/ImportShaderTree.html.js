...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ImportShaderTree</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">ImportShaderTree</h2>\n\
\n\
<h3>Introduced</h3>\n\
...
<h3>Description</h3>\n\
<div><p>\n\
Imports a shader tree. A shader tree is a kind of a compound representation of a shader node, having \n\
the .xsishaders extension (similar to the .xsirtcompound file for Render Tree compounds). Shader trees\n\
are basically shader compound whithout any exposed ports. The shader tree format replaces shader and \n\
material presets. \n\
<br /><br />\n\
This is the scripting equivalent of dragging and dropping an .xsishaders file from the browser into \n\
the render tree.\n\
</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = ImportShaderTree( [Container], Path );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./si_om/ShaderContainer.html\">ShaderContainer</a> to hold imported shader compound.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current selection			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
