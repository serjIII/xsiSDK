...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>Init (ICE Nodes)</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">Init (ICE Nodes)</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
<div><p><a name=\"Description\"> </a>	<p>\n\
				Use this callback to instantiate the <a href=\"#!/url=./si_cpp/classXSI_1_1ICENode.html\">ICENode</a> and register your \n\
				custom ICENode. Although user data is stored in the ICENode context during the \n\
				<a href=\"#!/url=./si_cmds/cb_ICENodes_BeginEvaluate.html\">BeginEvaluate</a> callback, it can also be set during the Init \n\
				callback and then accessed later in the <a href=\"#!/url=./si_cmds/cb_ICENodes_Evaluate.html\">Evaluate</a> callback. \n\
			</p>\n\
<div class=\"tip\">\n\
<table cellpadding=\"5\" cellspacing=\"5\">\n\
	<tr>\n\
		...
		<td class=\"emph\">\n\
				The user data stored in <a href=\"#!/url=./si_cmds/cb_ICENodes_BeginEvaluate.html\">BeginEvaluate</a> or Init is always \n\
				accessible from the <a href=\"#!/url=./si_cmds/cb_ICENode_Evaluate.html\">Evaluate</a> callback. However, unless the custom node \n\
				threading mode is single-threading, the <a href=\"#!/url=./si_cpp/classXSI_1_1Context.html#PutUserData\">Context::PutUserData</a> \n\
...
<tr>\n\
<td class=\"example\"><pre class=\"cplusplus\">CStatus &lt;icenode_name&gt;_Init( CRef&amp; in_context )\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<div><p><a name=\"Parameters\"> </a>	<table>		<tr>			<th>Parameter</th>\n\
		...
		<tr>			<td class=\"name\">in_context</td>\n\
			...
			<td>A reference to the <a href=\"#!/url=./si_cpp/classXSI_1_1ICENodeContext.html\">ICENodeContext</a> object. \n\
					...
					returns the <a href=\"#!/url=./si_cpp/classXSI_1_1ICENode.html\">ICENode</a>.</td>\n\
</tr>\n\
</table>\n\
</p></div>\n\
\n\
