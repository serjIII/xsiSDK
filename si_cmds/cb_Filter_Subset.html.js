...
\n\
<h2 class=\"pagehead\">Subset</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
<div><p><a name=\"Description\"> </a>	<p>\n\
				Subset takes a collection of elements (objects or subcomponents) and determines the subset \n\
				of elements that match the filter requirements. Softimage uses the Subset callback to filter the \n\
				nodes displayed in an explorer view, and to filter subcomponents selected in a 3D view. If \n\
				you don\'t provide a Subset callback, Softimage calls Match on each object to be filtered.  \n\
			</p>\n\
</p></div>\n\
\n\
<hr width=\"100%\" />\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"cplusplus\">CStatus &lt;filter_name&gt;_Subset( CRef&amp; in_context )\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">function &lt;filter_name&gt;_Subset( in_context )\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\">def &lt;filter_name&gt;_Subset( in_context ):\n\
	...</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">Function &lt;filter_name&gt;_Subset( in_context )\n\
	...\n\
End Function</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"perlscript\">sub &lt;filter_name&gt;_Subset \n\
{ \n\
	my $in_context = shift; \n\
}</pre></td></tr>\n\
</table>\n\
...
<div><p><a name=\"ContextAttributes\"> </a>	<table>		<tr>			<th>Attribute</th>\n\
		...
		<tr>			<td>Input</td>\n\
			<td>A collection of objects to filter.</td>\n\
</tr>\n\
		<tr>			<td>Output</td>\n\
			<td>The subset of the input objects that match the filter requirements.</td>\n\
</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<div><p><a name=\"SeeAlso\"> </a><ul>\n\
	...
	<li><a href=\"#!/url=./si_cmds/cb_Filter_Match.html\">Match</a></li>\n\
