...
\n\
<h2 class=\"pagehead\">ApplyDelta</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v6.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Applies the specified model <a href=\"#!/url=./si_om/Delta.html\">Delta</a> object to a reference model. \n\
Use this command when you add modifications to a delta (for example, using the \n\
ActionDelta.AddFCurveItem method) and you want to apply those changes back to the \n\
reference model.\n\
<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ApplyDelta( Deltas );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
