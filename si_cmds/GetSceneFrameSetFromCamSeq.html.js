...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>GetSceneFrameSetFromCamSeq</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>GetSceneFrameSetFromCamSeq</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">GetSceneFrameSetFromCamSeq</h2>\n\
\n\
<h3>Introduced</h3>\n\
...
<h3>Description</h3>\n\
<div><p>\n\
Get the time remapped frame numbers in scene time from a frame range in Camera Sequencer.<br /><br /></p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oArray = GetSceneFrameSetFromCamSeq( [SequencerIn], [SequencerOut], [PlotWithoutGaps] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>\n\
A 1-dimensional <a href=\"#!/url=./files/Array.htm\">Array</a> of <a href=\"#!/url=./files/Double.htm\">Double</a> values containing the time remapped frame(in seconds) numbers in scene time.\n\
If no frame in scene time can be found, return an empty array.\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
