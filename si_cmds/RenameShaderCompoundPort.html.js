...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>RenameShaderCompoundPort</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>RenameShaderCompoundPort</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">RenameShaderCompoundPort</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Renames a shader compound port. You can pass either an internal or external input or \n\
output port on a compound. When the name already exists, the new port named is appended an index\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oString = RenameShaderCompoundPort( InputObj, Name, DisplayName );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns the new port name of the compound port as a <a href=\"#!/url=./files/String.htm\">String</a>.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
Shader Compound Port to Rename.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Name		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
New name for the shader compound port.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">DisplayName		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
New diplay name for the shader compound port.		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
