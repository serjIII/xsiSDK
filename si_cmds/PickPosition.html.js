...
\n\
<h2 class=\"pagehead\">PickPosition</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.0</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>PickPosition( LeftMessage, MiddleMessage, [PosX], [PosY], [PosZ], [ButtonPressed] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
 ...
 Status bar message for the middle mouse button.  		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Returns the X coordinate of the picked postion. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">PosY		</td>\n\
		<td><a href=\"#!/url=./files/Float.htm\">Float</a>		</td>\n\
		<td>\n\
 Returns the Y coordinate of the picked postion. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">PosZ		</td>\n\
		<td><a href=\"#!/url=./files/Float.htm\">Float</a>		</td>\n\
		<td>\n\
 Returns the Z coordinate of the picked postion. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">ButtonPressed		</td>\n\
		<td><a href=\"#!/url=./files/Integer.htm\">Integer</a>		</td>\n\
		<td>\n\
 Returns the mouse button pressed by the user. 			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				<tr>\n\
				...
				<tr>\n\
					<td class=\"name\">0					</td>\n\
					<td>Right button or ESC key pressed (picking was aborted)					</td>\n\
				</tr>\n\
				<tr>\n\
					<td class=\"name\">1					</td>\n\
					<td>Left button pressed					</td>\n\
				</tr>\n\
				<tr>\n\
					<td class=\"name\">2					</td>\n\
					<td>Middle button pressed					</td>\n\
				</tr>\n\
			</table>\n\
		</td>\n\
	</tr>\n\
