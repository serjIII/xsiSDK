...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>GetPrimLattice</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">GetPrimLattice</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = GetPrimLattice( PresetObj, [InputObjs], [Name], [Parent], [PrimObj] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns the lattice (an <a href=\"#!/url=./si_om/X3DObject.html\">X3DObject</a> object).</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
The attice preset (one of the <a href=\"#!/url=./si_cmds/MiscellaneousPrimitives.html#\">Miscellaneous Primitives</a>). 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
\"Lattice\"			</p>\n\
			<table cellpadding=\"5\" cellspacing=\"5\">\n\
				...
				<tr>\n\
					...
					<td>The lattice primitive preset					</td>\n\
				</tr>\n\
			</table>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
<a href=\"#!/url=./files/listexpr.htm\">List</a> of objects to which the lattice is applied. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Name		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Name of the lattice. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Parent		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Parent <a href=\"#!/url=./files/objectexpr.htm\">object</a> for the lattice. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">PrimObj		</td>\n\
		<td><a href=\"#!/url=./si_om/Primitive.html\">Primitive</a>		</td>\n\
		<td>\n\
 Returns the lattice primitive. 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
