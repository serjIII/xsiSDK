...
\n\
<h2 class=\"pagehead\">AddICENode</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>Inserts a node into the specified ICE tree.</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = AddICENode( PresetObj, [Container] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>The new node as an <a href=\"#!/url=./si_om/ICENode.html\">ICENode</a>.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
\n\
		One of the <a href=\"#!/url=./files/ICE Nodes Reference.htm\">ICENode presets</a> \n\
		(eg., \"ICENodes\\PopFromArrayNode.Preset\").\n\
			</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td>\n\
The node tree to which we\'re adding the node.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If not specified, the user is prompted to select a node tree.			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
