...
\n\
<h2 class=\"pagehead\">SetFxOpPos</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v3.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Sets the position of an <a href=\"#!/url=./si_om/FxOperator.html\">FxOperator</a> in the <a href=\"#!/url=./si_om/FxTree.html\">FxTree</a>.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>SetFxOpPos( [FxOp], [x], [y] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Current selection. <br /><br />Note: If the current selection is not a valid FxOperator, an error occurs.			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
Specifies the position of the FxOperator in X.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/Float.htm\">Float</a>		</td>\n\
		<td>\n\
Specifies the position of the FxOperator in Y.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\' This example creates an FxTree, adds the FileInput operator\n\
...
\'INFO : \"X and Y positions of the FileInput operator: 143, 88\"</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
