...
\n\
<h2 class=\"pagehead\">AddAudioClip</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Takes an audio source, creates a clip, assigns it the source, \n\
then adds the clip to the given compound and track.  <br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = AddAudioClip( Model, Source, [Compound], [Track], [Time], [Name] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns the new audio <a href=\"#!/url=./si_om/Clip.html\">Clip</a>. </p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
 The model to add the clip to. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Source		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 The source to create the clip from.  Typically, a \"source\" is an audio source imported using ImportAudio. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Compound		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 The compound container (track owner) to add this clip to. (Not currently used)		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Track		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 The track to add this clip to. <br /><br />\n\
	Note: If no track is specified, one will be created, and the clip will \n\
	be put on that new track.		</td>\n\
	</tr>\n\
	<tr>\n\
...
Current frame			</p>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Name to use for the new clip. 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
set oClip = AddAudioClip( oModel, oAudioSource, , oTrack, 5, \"GoClip\" )</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/ImportAudio.html\">ImportAudio</a> <a href=\"#!/url=./si_cmds/DeleteUnusedAudioSources.html\">DeleteUnusedAudioSources</a></p></div>\n\
\n\
