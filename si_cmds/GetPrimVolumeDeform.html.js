...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>GetPrimVolumeDeform</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>GetPrimVolumeDeform</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">GetPrimVolumeDeform</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = GetPrimVolumeDeform( PresetObj, [InputObjs], [Name], [Parent], [PrimObj] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns the volume deform <a href=\"#!/url=./si_om/X3DObject.html\">X3DObject</a></p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
The SphereVolume preset (one of the <a href=\"#!/url=./si_cmds/ControlObjectPrimitives.html#\">Control Object Primitives</a>)			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
\"SphereVolume\"			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
<a href=\"#!/url=./files/listexpr.htm\">List</a> of objects to which the deformer is applied. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Name		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Name of the deformer. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Parent		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Parent <a href=\"#!/url=./files/objectexpr.htm\">object</a> for the deformer. 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">PrimObj		</td>\n\
		<td><a href=\"#!/url=./si_om/Primitive.html\">Primitive</a>		</td>\n\
		<td>\n\
 Returns the volume deform primitive. 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">dim list, prim\n\
set list = GetValue( \"SelectionList\" )\n\
GetPrimVolumeDeform \"SphereVolume\", list, \"Name\", , prim</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/GetPrim.html\">GetPrim</a></p></div>\n\
\n\
