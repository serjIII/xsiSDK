...
\n\
<h2 class=\"pagehead\">ParseInfo</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
<div><p><a name=\"Description\"> </a>	<p>\n\
				Compiles registration information for each shader found in the file list returned by \n\
				<a href=\"#!/url=./si_cmds/cb_ShaderParser_QueryParserSettings.html\">QueryParserSettings</a> (available via the \n\
				<span style=\"font-family: courier, monospace;\">FileName</span> attribute). \n\
			</p>\n\
	<p>\n\
				This callback is fired each time a file is parsed. Once Softimage has gotten the list of files to parse from the \n\
				<a href=\"#!/url=./si_cmds/cb_ShaderParser_QueryParserSettings.html\">QueryParserSettings</a> callback, it begins parsing\n\
				files and for each file this callback registers the shader definitions it finds in the file.\n\
			</p>\n\
<div class=\"tip\">\n\
<table cellpadding=\"5\" cellspacing=\"5\">\n\
	<tr>\n\
		...
		<td class=\"emph\">\n\
				To get a shader definition to appear in the preset manager, you need to populate the <span style=\"font-family: courier, monospace;\">Category</span>\n\
				attribute with a category label where you want the shader definition to appear in the preset manager. You can also \n\
				set a more user-friendly name for your shader via the <span style=\"font-family: courier, monospace;\">DisplayName</span> attribute.\n\
			</td>\n\
	</tr>\n\
</table>\n\
</div>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"cplusplus\">CStatus &lt;plugin-item_name&gt;_ParseInfo( CRef&amp; in_context ) \n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">function &lt;plugin-item_name&gt;_ParseInfo( in_context ) \n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\">def &lt;plugin-item_name&gt;_ParseInfo( in_context ):\n\
	...</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">Function &lt;plugin-item_name&gt;_ParseInfo( in_context )\n\
	...\n\
End Function</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"perlscript\">sub &lt;plugin-item_name&gt;_ParseInfo \n\
{ \n\
	my $in_context = shift; \n\
}</pre></td></tr>\n\
</table>\n\
...
<div><p><a name=\"Parameters\"> </a>	<table>		<tr>			<th>Parameter</th>\n\
		...
		<tr>			<td class=\"name\">in_context</td>\n\
			...
			<td>\n\
						Use the <a href=\"#!/url=./si_om/Context.SetAttribute.html\">Context.SetAttribute</a> method to get basic information, such as Category, \n\
						DisplayName, etc.\n\
					</td>\n\
</tr>\n\
		<tr>			<td class=\"name\"></td>\n\
			...
			<td>\n\
						Use the <a href=\"#!/url=./si_cpp/classXSI_1_1Context.html#SetAttribute\">Context::SetAttribute</a> \n\
						method to get basic information, such as Category, DisplayName, etc.\n\
					</td>\n\
</tr>\n\
</table>\n\
</p></div>\n\
...
<div><p><a name=\"ContextAttributes\"> </a><a name=\"ContextAttributes_ShaderParseInfo\"></a>	<table>		<tr>			<th>Attribute</th>\n\
			<th>Get/Set</th>\n\
			<th>Description</th>\n\
</tr>\n\
		<tr>			<td class=\"example\">Filename</td>\n\
			<td>Gets a <a href=\"#!/url=./files/String.htm\">String</a> or <a href=\"#!/url=./si_cpp/classXSI_1_1CString.html\">CString</a></td>\n\
			<td>The full path of the file to parse.</td>\n\
</tr>\n\
		...
		<tr>			<td class=\"example\">MajorVersion</td>\n\
			<td>Sets a <a href=\"#!/url=./files/Long.htm\">Long</a> or ULONG</td>\n\
			<td>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"cplusplus\">SICALLBACK UtShaderLanguageParser_ParseInfo( CRef&amp; in_ctxt )\n\
{\n\
