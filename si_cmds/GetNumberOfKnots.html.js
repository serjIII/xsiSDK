...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>GetNumberOfKnots</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">GetNumberOfKnots</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Gets the number of distinct knots on a curve. The multiplicity of a knot is not taken into account.\n\
<br /><br />\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>GetNumberOfKnots( InputObj, [NbItems] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
<a href=\"#!/url=./files/objectexpr.htm\">Curve</a> to evaluate. 		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
 Returns the number of knots. 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\'This example shows how to get the number of distinct knots from a curve\n\
newscene\n\
dim nbKnots\n\
\'Create a standard spiral with 16 subdivisions.\n\
CreatePrim \"Spiral\", \"NurbsCurve\"	\n\
\' Get the number of knots. \n\
GetNumberOfKnots \"Spiral\", nbKnots \n\
logmessage \"Number of Knots: \" &amp; nbKnots</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/GetCurveLength.html\">GetCurveLength</a> <a href=\"#!/url=./si_cmds/GetCurvePercentageAtKnotIndex.html\">GetCurvePercentageAtKnotIndex</a> <a href=\"#!/url=./si_cmds/EvaluateCurveAt.html\">EvaluateCurveAt</a></p></div>\n\
\n\
