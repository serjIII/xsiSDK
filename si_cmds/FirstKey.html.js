...
\n\
<h2 class=\"pagehead\">FirstKey</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Moves to the first key frame for the given parameters.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oDouble = FirstKey( [InputObjs], [Time], [Layer] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns the frame number of the first key frame as a <a href=\"#!/url=./files/Double.htm\">Double</a>.\n\
If there is no key then the following is returned: 1.#INF for C++, \"1.#INF\" for VBScript and Number.POSITIVE_INFINITY for JScript.\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
Currently selected and marked parameters			</p>\n\
	...
	<tr>\n\
		...
		<td>Number		</td>\n\
		<td>\n\
 Not used. 			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
Current frame			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
