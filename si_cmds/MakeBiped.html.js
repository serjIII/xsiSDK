...
\n\
<h2 class=\"pagehead\">MakeBiped</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Creates a character with the same proportions as a biped guide. The guide must be a model \n\
named \"Biped_Guide\". This command is not compatible with guides from versions of Softimage earlier than 4.0.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oBiped = MakeBiped( [TorsoType], [TorsoStretch], [TorsoDivisions], [IconType], [MakeBelly], [BellySlide], [BellyCenterPercentage], [HeadType], [HeadStretch], [HeadDivisions], [Ears], [RotationOrder], [ArmSymmetry], [ArmAttachment], [FingerType], [ForeArmRoll], [ForeArmDivisions], [BicepRoll], [BicepDivisions], [ThighRoll], [ThighDivisions], [ArmPitSlide], [HipSlide], [ThighSlide], [ElbowsJoint], [KneeJoint], [ShadowType], [ShadowHands], [OneModel], [IndependentLower], [ThreeBoneToes], [CreateShadowCharacterKeySet], [SelectUsingUI] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns a <a href=\"#!/url=./files/CDKBiped.htm\">Biped</a> JScript object.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
...
0			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
\n\
		Connects two point slide controls between the belly and hip, blending motion between the hip and belly \n\
		for more realistic skin deformation. The slides are placed on either side of the belly control. \n\
...
0			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
\n\
		Controls where the center of the belly is placed. A value of 0 attaches the belly center at the hip and bottom \n\
		spine vertebra, giving a large radius for belly swing. A value of 1 puts the belly center near the belly \n\
		surface, giving a small radius for belly swing. Generally the larger the swing radius, the slower a belly will \n\
		bounce and jiggle.\n\
				<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
...
0			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
\n\
		Whether the neck spine should stretch automatically to follow the head, or try to maintain a constant length. This \n\
		parameter is ignored for the skeleton head type.\n\
				<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/Integer.htm\">Integer</a>		</td>\n\
		<td>\n\
The number of divisions on the neck if a spine head assembly is choosen. This parameter is ignored for skeleton head type.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
3			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
3			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
\n\
		Option to add thigh roll division to the thigh bone. Thigh roll division is the same as bicep roll division.( see \n\
		<a href=\"#!/url=./si_cmds/MakeBicepRoll.html\">MakeBicepRoll</a> for a description of bicep roll division ).\n\
				<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
...
3			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
\n\
		Option to create a two point slide between the bicep and the chest bone. Guide cubes for the slides are are on \n\
		either side of the chest bone and in the bicep bones. See <a href=\"#!/url=./si_cmds/Make2PointSlide.html\">Make2PointSlide</a> for a description \n\
		of two point slides.\n\
				<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	...
	<tr>\n\
		...
		<td>\n\
\n\
		Option to create a two-point slide between the thigh and the hip bone. Guide cubes for positioning the slides \n\
		are on either side of the hip. See <a href=\"#!/url=./si_cmds/Make2PointSlide.html\">Make2PointSlide</a> for a description of two point slides.\n\
				<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		...
		<td>\n\
\n\
		Option to create a thigh slide between the thigh and the hip bone. Guide cubes for positioning the slides are \n\
		found behind the legs of the guide. See <a href=\"#!/url=./si_cmds/MakeThighSlide.html\">MakeThighSlide</a> for a description of thigh slides.\n\
				<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
...
0			</p>\n\
	...
	<tr>\n\
		<td class=\"name\">KneeJoint		</td>\n\
		<td><a href=\"#!/url=./files/Boolean.htm\">Boolean</a>		</td>\n\
		<td>\n\
\n\
		Option to create joint compression between the femur and tibia. See <a href=\"#!/url=./si_cmds/MakeJointCompression.html\">MakeJointCompression</a> \n\
		for a description of joint compression. \n\
				<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
...
0			</p>\n\
	...
	<tr>\n\
		<td class=\"name\">ThreeBoneToes		</td>\n\
		<td><a href=\"#!/url=./files/Boolean.htm\">Boolean</a>		</td>\n\
		<td>\n\
If true, then a three-boned toe is created; if false, a two-boned toe is created.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
1			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">CreateShadowCharacterKeySet		</td>\n\
		<td><a href=\"#!/url=./files/Boolean.htm\">Boolean</a>		</td>\n\
		<td>\n\
\n\
		If true, then the shadow rig has a character key set created with it.  \n\
		<br /><br />\n\
		Note: This parameter is only used in scripting.			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
0			</p>\n\
		</td>\n\
	</tr>\n\
	<tr>\n\
...
Translate(\"Biped1.GlobalSRT\", 10, 0, 0, siRelative, siView, siObj, siXYZ, null, null, siXYZ, null, null, null, null, null, null, 0);</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/MakeQuadruped.html\">MakeQuadruped</a> <a href=\"#!/url=./si_cmds/MakeBipedDogLeg.html\">MakeBipedDogLeg</a></p></div>\n\
\n\
