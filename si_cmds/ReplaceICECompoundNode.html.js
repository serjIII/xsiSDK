...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>ReplaceICECompoundNode</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>ReplaceICECompoundNode</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">ReplaceICECompoundNode</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v7.0</p></div>\n\
\n\
<h3>Description</h3>\n\
<div><p>\n\
Replaces the specified <a href=\"#!/url=./si_om/ICECompoundNode.html\">ICECompoundNode</a> using another version of the file.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ReplaceICECompoundNode( [InputObjs], [Version] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
Compound you want to replace			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If no argument is specified, the current selection is used.			</p>\n\
	...
	<tr>\n\
		...
		<td>\n\
Target version you want to apply instead of the current one			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
If no argument is specified, the latest version of compound is used.			</p>\n\
		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
