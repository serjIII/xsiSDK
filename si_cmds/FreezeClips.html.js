...
\n\
<h2 class=\"pagehead\">FreezeClips</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v1.5</p></div>\n\
\n\
...
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oString = FreezeClips( [InputObj], [Name], [IgnoreInactiveChannels], [StepFrame], [FCurve Kind], [DefaultSegKind], [Fit FCurve], [Fit Tolerance], [ProcessContRots] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
LogMessage \"Froze source: \" &amp; oFrozen</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
<h3>See Also</h3>\n\
<div><p><a href=\"#!/url=./si_cmds/FreezeAndReplaceClips.html\">FreezeAndReplaceClips</a> <a href=\"#!/url=./si_cmds/StoreAction.html\">StoreAction</a> <a href=\"#!/url=./si_cmds/PlotToActions.html\">PlotToActions</a></p></div>\n\
\n\
