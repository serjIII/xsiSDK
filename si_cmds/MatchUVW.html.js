...
\n\
<h2 class=\"pagehead\">MatchUVW</h2>\n\
\n\
<h3>Description</h3>\n\
<div><p>Matches the UVWs that are within the specified tolerance.</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = MatchUVW( TextureProjection, SubComp, [Tolerance] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
<div><p>Returns the new MatchUVW operator.</p></div>\n\
\n\
<h3>Parameters</h3>\n\
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
 The texture projection which sample points we want to match.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">SubComp		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
 Cluster of sample points or tagged sample points to match 		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Tolerance		</td>\n\
		<td><a href=\"#!/url=./files/Double.htm\">Double</a>		</td>\n\
		<td>\n\
 The maximum distance between to sample points we match 		</td>\n\
	</tr>\n\
</table>\n\
</p></div>\n\
\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">\' This example demonstrate how to match the UVs of two\n\
...
SetValue \"cube.polymsh.cls.Texture_Coordinates_AUTO.Texture_Projection.Matchuvw.SelectedPoints\", True</pre></td></tr>\n\
</table>\n\
</div></p></div>\n\
\n\
