...
\n\
<h2 class=\"pagehead\">ClearUserTab</h2>\n\
\n\
<h3>Introduced</h3>\n\
...
<h3>Description</h3>\n\
<div><p>\n\
Clears the Material Manager user tab (if any) from each object in the specified list.  \n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>ClearUserTab( [InputObjs] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Parameters</h3>\n\
