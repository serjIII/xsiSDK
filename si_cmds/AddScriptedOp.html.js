...
\n\
<h2 class=\"pagehead\">AddScriptedOp</h2>\n\
\n\
<h3>Introduced</h3>\n\
<div><p>v4.0</p></div>\n\
\n\
...
<a href=\"#!/url=./si_cmds/AddScriptedOpFromFile.html\">AddScriptedOpFromFile</a> or <a href=\"#!/url=./si_cmds/AddCustomOp.html\">AddCustomOp</a> instead.\n\
</p></div>\n\
\n\
<h3>Scripting Syntax</h3>\n\
<div><p><table>\n\
	<tr>\n\
		<td class=\"example\"><pre>oReturn = AddScriptedOp( OutputObjs, [Code], InputObjs, [Name], [Language], [ConstructionMode] );</pre>		</td>	</tr>\n\
</table>\n\
</p></div>\n\
\n\
<h3>Return Value</h3>\n\
...
<div><p><table cellpadding=\"5\" cellspacing=\"5\">\n\
	...
	<tr>\n\
		...
		<td>\n\
List of objects or parameters to connect the output ports to.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">Code		</td>\n\
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
The script containing the implementation of the scripted operator.		</td>\n\
	</tr>\n\
	<tr>\n\
		<td class=\"name\">InputObjs		</td>\n\
		<td><a href=\"#!/url=./files/listexpr.htm\">List</a>		</td>\n\
		<td>\n\
List of objects or parameters to connect the input ports to.		</td>\n\
	</tr>\n\
	<tr>\n\
...
ScriptedOp			</p>\n\
	...
	<tr>\n\
		...
		<td><a href=\"#!/url=./files/String.htm\">String</a>		</td>\n\
		<td>\n\
The script language of the operator fo			<p class=\"cell\"><span class=\"hilite\">Default Value: </span>\n\
