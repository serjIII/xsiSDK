...
<script type=\"text/javascript\" src=\"../scripts/prettify.js\"></script><script src=\"../scripts/lib/jquery-1.9.1.min.js\" type=\"text/javascript\"></script><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" /><script type=\"text/javascript\" src=\"../scripts/utils/adsk.redirect.js\"></script>\n\
      <title>OnEndValueChange (GridData)</title>\n\
   \n\
</head>\n\
...
pre pre {\n\
	...
	border-style:none;\n\
      ...
      <div>\n\
         <div class=\"head\">\n\
            <h1>OnEndValueChange (GridData)</h1>\n\
         </div>\n\
\n\
<h2 class=\"pagehead\">OnEndValueChange (GridData)</h2>\n\
\n\
<hr width=\"100%\" />\n\
<h3>Description</h3>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"jscript\">function &lt;property_name&gt;_&lt;parameter_name&gt;_OnEndValueChange()\n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
<tr>\n\
<td class=\"example\"><pre class=\"python\">def &lt;property_name&gt;_&lt;parameter_name&gt;_OnEndValueChange():\n\
				...</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"vbscript\">Function &lt;property_name&gt;_&lt;parameter_name&gt;_OnEndValueChange()\n\
				...\n\
End Function</pre></td></tr>\n\
</table>\n\
</div><div class=\"example\"><table>\n\
<tr>\n\
<td class=\"example\"><pre class=\"perlscript\">sub &lt;property_name&gt;_&lt;parameter_name&gt;_OnEndValueChange \n\
{ \n\
	... \n\
}</pre></td></tr>\n\
</table>\n\
...
def MyProperty_OnClosed( ):\n\
	pass\n\
\n\
def MyProperty_MyGrid_OnEndValueChange( in_ExtraParams ):\n\
	param = PPG.MyGrid\n\
	gridData = param.Value\n\
	\n\
	# Retrieve the set of cells that were modified and \n\
	# create a string for later logging\n\
	columnRowPairs = []\n\
	columnRowPairs.extend( in_ExtraParams[0] )\n\
	\n\
	logString = \"Modified cells: \"\n\
